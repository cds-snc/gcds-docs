module.exports = {
  en : {
    ...
    step2: {
      ...
      angular: {
        paragraph: "Use these instructions to install GCDS components if you're using Angular.",
        heading: "Install with npm",
        "install": "Navigate to the root folder of your project and run:",
        "placeApp": "Place the following code in the app.module.ts file of your app:",
        "placeStyles": "Place the following code in the styles.scss file of your app:"
      },
      cdn: {
        paragraph: "Use these instructions to install GCDS components with no framework.",
        heading: "Add the code",
        "place": "Place the following code in the <head> element of your project:",
        "note": "Note: <script type=\"module\"> requires a server to load properly. If developing locally, please use <script nomodule>."
      },
      choose: {
        paragraph: "Select an option in step 1 to get your installation instructions.",
      },
      figma: {
      ...
      node: {
        paragraph: "Use these instructions to install GCDS components if you're using npm (node package manager) with no framework.",
        heading: "Install with npm",
        "install": "Navigate to the root folder of your project and run:",
        "place": "Place the following code in the <head> element of your site:"
      },
      other: {
        paragraph: "Not seeing an environment that matches? Reach out to us and we'll help you get started.",
        buttonText: "Contact us",
        link: "/en/contact/#contact-us"
      },
      react: {
        paragraph: "Use these instructions to install GCDS components if you're using React.",
        heading: "Install with npm",
        "install": "Navigate to the root folder of your project and run:",
        "place": "Place the following code in the index.js file of your app:"
      },
      vue: {
        paragraph: "Use these instructions to install GCDS components if you're using Vue.",
        heading: "Install with npm",
        "install": "Navigate to the root folder of your project and run:",
  ...
  fr: {
    ...
    step2: {
      ...
      angular: {
        paragraph: "Si vous utilisez Angular, suivez ces instructions pour installer les composants SDGC.",
        heading: "Installation à l'aide de npm",
        "install": "Naviguez jusqu'au dossier racine de votre projet et exécutez :",
        "placeApp": "Insérez le code suivant dans le fichier app.module.ts de votre application :",
        "placeStyles": "Insérez le code suivant dans le fichier styles.scss de votre application :"
      },
      cdn: {
        paragraph: "Pour installer les composants SDGC sans infrastructure, suivez ces instructions.",
        heading: "Ajoutez le code",
        "place": "Insérez le code suivant dans l'élément <head> de votre projet :",
      ...
      other: {
        paragraph: "Vous ne trouvez pas votre infrastructure dans la liste? Écrivez-nous pour obtenir des conseils.",
        buttonText: "Contactez nous",
        link: "/fr/contactez/#contacteznous"
      },
      react: {
        paragraph: "Si vous utilisez React, suivez ces instructions pour installer les composants SDGC.",
        heading: "Installation à l'aide de npm",
        "install": "Naviguez jusqu'au dossier racine de votre projet et exécutez :",
        "place": "Insérez le code suivant dans le fichier index.js de votre application :"
      },
      vue: {
        paragraph: "Si vous utilisez Vue, suivez ces instructions pour installer les composants SDGC.",
        heading: "Installation à l'aide de npm",
        "install": "Naviguez jusqu'au dossier racine de votre projet et exécutez :",
        "place": "Insérez le code suivant dans le fichier main.js de votre application :"
      }
    },
    step3: {
