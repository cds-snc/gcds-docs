...
Pour toute demande concernant <a href="https://github.com/cds-snc/gcds-tokens" target="_blank">les unités de style <gcds-icon name="external-link" label="S'ouvre dans un nouvel onglet." margin-left="100" /></a>, <a href="https://github.com/cds-snc/gcds-components" target="_blank"> les composants <gcds-icon name="external-link" label="S'ouvre dans un nouvel onglet." margin-left="100" /></a>, et <a href="https://github.com/cds-snc/gcds-docs" target="_blank"> la documentation <gcds-icon name="external-link" label="S'ouvre dans un nouvel onglet." margin-left="100" /></a>, remplissez ce formulaire ou envoyez une demande à l’aide de fonction « Issues » dans GitHub.
