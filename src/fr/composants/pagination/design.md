...
<ol class="anatomy-list">
  ...
  <li>Le <strong>chevron suivant</strong> est une aide visuelle qui indique qu’on navigue en avantdans la séquence de pages.</li>
...
<img class="b-sm b-default p-300" src="/images/fr/components/anatomy/gcds-pagination-simple-anatomy.svg" alt="Le composant de pagination, avec des numéros pointant vers les différentes parties de la structure de la pagination simple." />
