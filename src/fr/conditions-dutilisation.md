...
- Vous êtes responsable de vous assurer que la version de Système de design GC que vous utilisez est à jour. Composants SGDC v1.0.0 (@gcds-core/components) a été conçu pour assurer la stabilité des API au sein de la série de versions 1.x, de sorte que les équipes peuvent adopter les composants de Système de design GC en sachant que les versions mineures et les correctifs chercheront à éviter les changements non rétrocompatibles. Les changements non rétrocompatibles ne devraient avoir lieu que dans le cadre de versions majeures, et non dans les mises à jour ou correctifs mineurs. Si vous utilisez actuellement @cdssnc/gcds-components, vous devrez migrer vos projets vers la nouvelle version pour continuer à recevoir des mises à jour et des améliorations. Suivez le guide de migration : <gcds-link href="https://github.com/cds-snc/gcds-components/blob/main/.docs/migration/stable-v1.md#migration-de-la-version-alpha-%C3%A0-la-v1-stable" external>Migration de @cdssnc/gcds-components vers @gcds-core/components</gcds-link>.
