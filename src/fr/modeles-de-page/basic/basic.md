...
<gcds-button class="mb-300" button-role="secondary" type="link" href="{{ links.pageTemplatesBasicPreview }}" target="_blank">Ouvrir l’aperçu</gcds-button>
<gcds-button  button-role="secondary" type="link" href="{{ links.pageTemplatesBasicCode }}" target="_blank">Consulter le code</gcds-button>

<img class="max-width-content b-sm b-default mb-300 p-300" src="/images/fr/templates/basic-page-preview.png" alt="Le modèle de page de base comprend l’en-tête et le pied de page du Gouvernement du Canada, ainsi que des sections de titre H1, H2 et H3, chacune accompagnée de texte."/>
...
<gcds-button class="mb-300" button-role="secondary" type="link" href="{{ links.pageTemplatesBasicExtOTPPreview }}" target="_blank">Ouvrir l’aperçu</gcds-button>
<gcds-button  button-role="secondary" type="link" href="{{ links.pageTemplatesBasicExtOTPCode }}" target="_blank">Consulter le code</gcds-button>

<img class="max-width-content b-sm b-default mb-300 p-300" src="/images/fr/templates/basic-page-on-this-page-preview.png" alt="Un modèle de page de base avec une section « Sur cette page » comprend l’en-tête et le pied de page du gouvernement du Canada, une section « Sur cette page » et trois sections listées en-dessous."/>
...
- Une hiérarchie de titres claire qui vous permet, grâce aux directives sur les <gcds-link href="{{ links.heading }}">titres</gcds-link>, de structurer votre contenu de façon logique et accessible, y compris pour les personnes utilisant des technologies d’assistance.
