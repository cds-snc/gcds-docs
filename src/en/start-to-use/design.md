...
You can always check if you have the latest version by visiting our <span class="text-truncate"><gcds-link href="{{ links.githubFigmaReleases }}" external>changelog</gcds-link>.</span> If you <gcds-link href="{{ links.contactMailingList }}">sign up to our mailing list</gcds-link>, we’ll email you when we make updates to the design system.
