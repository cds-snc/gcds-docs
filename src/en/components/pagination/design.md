...
<img class="b-sm b-default p-300" src="/images/en/components/anatomy/gcds-pagination-simple-anatomy.svg" alt="The pagination component with numbers pointing to individual parts of the simple pagination's anatomy." />
