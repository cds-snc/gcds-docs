...
# Code de conduite pour les projets de `l'Équipe de produit du système de conception`

([English](#contributor-covenant-code-of-conduct-for-the-gc-design-system-product-team-projects))

Les contributeurs aux dépôts hébergés dans [`CDS-SCN`](https://github.com/cds-snc/) sont tenus de respecter le Code de conduite du Pacte des contributeurs, et ceux qui travaillent au sein du gouvernement sont également tenus de respecter le Code de valeurs et d'éthique du secteur public.
...
Pour obtenir des réponses aux questions courantes sur ce code de conduite, consultez https://www.contributor-covenant.org/faq (en anglais seulement).
