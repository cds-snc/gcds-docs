...
test.describe('gcds-card', () => {
    ...
    test('badge', async ({ page }) => {
        await expect(page.locator('[data-variant="badge"] .preview-component')).toHaveScreenshot('badge.png');
    });
    test('image', async ({ page }) => {
        await expect(page.locator('[data-variant="image"] .preview-component')).toHaveScreenshot('image.png');
    });
});
