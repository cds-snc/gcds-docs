...
export default {
    ...
    argTypes: Object.assign(Object.assign(Object.assign({
        ...
        // Events
        gcdsInput: Object.assign({ action: 'input' }, eventProp), gcdsChange: Object.assign({ action: 'change' }, eventProp), gcdsFocus: Object.assign({ action: 'focus' }, eventProp), gcdsBlur: Object.assign({ action: 'blur' }, eventProp), gcdsError: Object.assign({ action: 'invalid' }, eventProp), gcdsValid: Object.assign({ action: 'valid' }, eventProp)
    }),
};
const Template = args => `
