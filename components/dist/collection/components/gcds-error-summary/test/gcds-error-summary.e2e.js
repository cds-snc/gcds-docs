...
describe('gcds-error-summary', () => {
    ...
    `);
        ...
        expect(await page.evaluate(() => document
            ...
            .classList.contains('gcds-show'))).toBe(true);
        expect(await page.evaluate(() => document
            .querySelector('gcds-error-summary')
            .shadowRoot.querySelector('.summary__errorlist').childNodes.length)).toEqual(5);
    });
});
...
//# sourceMappingURL=gcds-error-summary.e2e.js.map
