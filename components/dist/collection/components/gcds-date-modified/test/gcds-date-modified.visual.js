 ...
 *
 * Baselines live in __screenshots__/gcds-date-modified.visual.ts/.
...
test.describe('gcds-date-modified', () => {
    ...
    test('version', async ({ page }) => {
        await expect(page.locator('[data-variant="version"] .preview-component')).toHaveScreenshot('version.png');
    });
});
