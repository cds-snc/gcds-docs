...
export class GcdsTopicMenu {
    ...
    render() {
        ...
        return (h(Host, { key: 'ea92a830119382cdd950f7346cb750b954fb77e5' }, h("nav", { key: '36bad924be21e3b404b2b65bcc7de63ad3b07a79', class: "gcds-topic-menu", "aria-labelledby": "gcds-topic-menu__heading" }, h("gcds-sr-only", { key: '1c5c7fff833cb328a828c6a3abd336f8c82062fc', id: "gcds-topic-menu__heading", tag: "h2" }, I18N[lang].menuLabelFull), h("button", { key: '2c5be1c6a65708bf3f9a1e71692e12654c28c028', "aria-haspopup": "true", "aria-expanded": this.open.toString(), "aria-label": I18N[lang].buttonLabel, onClick: async () => await this.toggleNav(), ref: element => (this.menuButton = element), class: home && 'gcds-topic-menu--home' }, this.lang == 'en' ? (h(Fragment, null, h("gcds-sr-only", { tag: "span" }, I18N[lang].menuLabelHidden), I18N[lang].menuToggle)) : (h(Fragment, null, I18N[lang].menuToggle, h("gcds-sr-only", { tag: "span" }, I18N[lang].menuLabelHidden))), h("gcds-icon", { key: 'd778a38a9a3967ff4e52a76033b15d4863b39aa1', name: "chevron-down", "margin-left": "100", size: "text-small" })), h("ul", { key: 'e9bcb8fbb357f8d05c09849ceff2fde3f5fd1806', role: "menu", "aria-orientation": "vertical", "data-top-menu": true, innerHTML: this.listItems, ref: element => (this.themeList = element) }))));
    }
