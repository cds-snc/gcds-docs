...
export class GcdsTopicMenu {
    ...
    render() {
        ...
        return (h(Host, { key: '77e9f945df4058bd3c547231d6cdb6ec9052fc84' }, h("nav", { key: '5ca25a73101119a0ceffd543c7ff55b7d891e994', class: "gcds-topic-menu", "aria-labelledby": "gcds-topic-menu__heading" }, h("gcds-sr-only", { key: 'dd8d544d5de7d0445e1e163481fae5b25497d811', id: "gcds-topic-menu__heading", tag: "h2" }, I18N[lang].menuLabelFull), h("button", { key: '5b7d43ea46077bc46f364c4eaaa4ebfbd1fd3ec7', "aria-haspopup": "true", "aria-expanded": this.open.toString(), "aria-label": I18N[lang].buttonLabel, onClick: async () => await this.toggleNav(), ref: element => (this.menuButton = element), class: home && 'gcds-topic-menu--home' }, this.lang == 'en' ? (h(Fragment, null, h("gcds-sr-only", { tag: "span" }, I18N[lang].menuLabelHidden), I18N[lang].menuToggle)) : (h(Fragment, null, I18N[lang].menuToggle, h("gcds-sr-only", { tag: "span" }, I18N[lang].menuLabelHidden))), h("gcds-icon", { key: '72b28e6124b97e3781e693b0811c012d9a18dcd9', name: "chevron-down", "margin-left": "100", size: "text-small" })), h("ul", { key: '0dc47fdd32219dec0313e04da9e5e6df57dc906e', role: "menu", "aria-orientation": "vertical", "data-top-menu": true, innerHTML: this.listItems, ref: element => (this.themeList = element) }))));
    }
