 ...
 *
 * Baselines live in __screenshots__/gcds-nav-link.visual.ts/.
...
test.describe('gcds-nav-link', () => {
    ...
    test('current', async ({ page }) => {
        await expect(page.locator('[data-variant="current"] .preview-component')).toHaveScreenshot('current.png');
    });
});
