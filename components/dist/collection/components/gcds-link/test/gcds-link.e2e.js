...
describe('gcds-link a11y tests', () => {
  ...
  it('Link name and color contrast', async () => {
    const page = await newE2EPage();
    await page.setContent('<gcds-link type="link" href="#">Link Text</gcds-link>');
  ...
  it('Keyboard focus: link', async () => {
    const page = await newE2EPage();
    await page.setContent('<gcds-link type="link" href="#">Link Label</gcds-link>');
...
//# sourceMappingURL=gcds-link.e2e.js.map
