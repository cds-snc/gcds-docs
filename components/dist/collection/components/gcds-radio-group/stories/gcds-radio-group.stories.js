...
Disabled.args = {
    name: 'radio',
    options: '[{ "label": "Label", "id": "radio", "value": "radio1", "hint": "Description or example to make the option clearer.", "disabled": true}]',
    lang: 'en',
};
export const Checked = Template.bind({});
Checked.args = {
    name: 'radio',
    options: '[{ "label": "Label", "id": "radio", "value": "radio1", "hint": "Description or example to make the option clearer.", "checked": true}]',
    lang: 'en',
};
...
//# sourceMappingURL=gcds-radio-group.stories.js.map
