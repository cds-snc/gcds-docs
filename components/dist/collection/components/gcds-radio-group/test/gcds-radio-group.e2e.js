...
describe('gcds-radio-group', () => {
    it('renders', async () => {
        ...
        await page.setContent(`<gcds-radio-group
          name="radio"
...
describe('gcds-radio-group a11y tests', () => {
    ...
    `);
        const inputField = await (await page.find('gcds-radio-group >>> input')).innerText;
        await page.keyboard.press('Tab');
    ...
    `);
        ...
        await page.keyboard.press('Tab');
        expect(await page.evaluate(() => window.document.activeElement.shadowRoot.activeElement.textContent)).toEqual(inputField[0].textContent);
        await page.keyboard.press('ArrowDown');
        expect(await page.evaluate(() => window.document.activeElement.shadowRoot.activeElement.textContent)).toEqual(inputField[1].textContent);
    });
    /**
     * Input label test
     */
...
//# sourceMappingURL=gcds-radio-group.e2e.js.map
