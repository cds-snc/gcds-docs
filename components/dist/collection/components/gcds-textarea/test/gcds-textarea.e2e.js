...
describe('gcds-textarea a11y tests', () => {
    ...
    `);
        ...
        expect(await page.evaluate(() => window.document.activeElement.shadowRoot.activeElement.textContent)).toEqual(textareaField);
    });
    /**
     * Textarea label test
     */
...
//# sourceMappingURL=gcds-textarea.e2e.js.map
