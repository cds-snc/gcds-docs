...
test.describe('gcds-signature', () => {
    ...
    test('type-wordmark', async ({ page }) => {
        await expect(page.locator('[data-variant="type-wordmark"] .preview-component')).toHaveScreenshot('type-wordmark.png');
    });
    test('variant-white', async ({ page }) => {
        await expect(page.locator('[data-variant="variant-white"] .preview-component')).toHaveScreenshot('variant-white.png');
    });
});
