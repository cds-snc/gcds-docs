...
export class GcdsDateInput {
    ...
    render() {
        ...
        const day = (h("gcds-input", Object.assign({ key: '3957eb8d33c856038a21ef2af45293e6124b48ce', name: "day", label: i18n[lang].day, inputId: "day", type: "number", size: 2, disabled: disabled, value: this.dayValue, onInput: e => this.handleInput(e, 'day'), onChange: e => {
