...
<gcds-grid>
  <gcds-grid-col tablet="3" desktop="6">${args.default ? args.default : null}</gcds-grid-col>
  <gcds-grid-col tablet="3" desktop="6">${args.default ? args.default : null} </gcds-grid-col>
</gcds-grid>

<!-- React code -->
<GcdsGrid>
  <GcdsGridCol tablet="3" desktop="6">${args.default ? args.default : null}</GcdsGridCol>
  <GcdsGridCol tablet="3" desktop="6">${args.default ? args.default : null}</GcdsGridCol>
</GcdsGrid>
`.replace(/ null/g, '');
