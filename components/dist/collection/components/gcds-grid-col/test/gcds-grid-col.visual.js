...
test.describe('gcds-grid-col', () => {
    ...
    test('desktop', async ({ page }) => {
        await expect(page.locator('[data-variant="desktop"] .preview-component')).toHaveScreenshot('desktop.png');
    });
    test('tablet', async ({ page }) => {
        await expect(page.locator('[data-variant="tablet"] .preview-component')).toHaveScreenshot('tablet.png');
    });
});
