  ...
  configurePaginationStep(page, end, mobile) {
    ...
    if (end) {
      return (index.h("li", null, end === "next" ?
        index.h("a", Object.assign({}, linkAttrs, { class: !mobile ? "gcds-pagination-end-button" : "gcds-pagination-end-button-mobile" }), I18N$7[this.lang].next, index.h("gcds-icon", { "margin-left": "200", name: "arrow-right" }))
        :
          index.h("a", Object.assign({}, linkAttrs, { class: !mobile ? "gcds-pagination-end-button" : "gcds-pagination-end-button-mobile" }), index.h("gcds-icon", { "margin-right": "200", name: "arrow-left" }), I18N$7[this.lang].previous)));
    }
    else {
    ...
    return (index.h(index.Host, { role: "navigation", "aria-label": label }, display === "list" ?
      ...
      :
        index.h("ul", { class: "gcds-pagination-simple" }, previousHref &&
          index.h("li", { class: "gcds-pagination-simple-previous" }, index.h("a", { href: previousHref, "aria-label": `${I18N$7[lang].previousPage}${previousLabel ? `: ${previousLabel}` : ""}`, onClick: (e) => this.onPageChange(e) }, index.h("gcds-icon", { "margin-right": "200", name: "arrow-left" }), index.h("div", { class: "gcds-pagination-simple-text" }, I18N$7[lang].previous), index.h("span", null, previousLabel))), nextHref &&
          index.h("li", { class: "gcds-pagination-simple-next" }, index.h("a", { href: nextHref, "aria-label": `${I18N$7[lang].nextPage}${nextLabel ? `: ${nextLabel}` : ""}`, onClick: (e) => this.onPageChange(e) }, index.h("div", { class: "gcds-pagination-simple-text" }, I18N$7[lang].next), index.h("span", null, nextLabel), index.h("gcds-icon", { "margin-left": "200", name: "arrow-right" }))))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const GcdsSearch = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: "gcds-search" }, index.h("h2", { class: "gcds-search__header" }, I18N$5[lang].search), index.h("form", { action: formAction, method: method, role: "search", onSubmit: () => this.gcdsSubmit.emit(), class: "gcds-search__form" }, index.h("gcds-label", { label: labelText, "label-for": searchId, "hide-label": true }), index.h("input", Object.assign({ type: "search", id: searchId, list: "search-list", size: 34, maxLength: 170, onChange: () => this.gcdsChange.emit(), onFocus: () => this.gcdsFocus.emit(), onBlur: () => this.gcdsBlur.emit() }, attrsInput, { class: "gcds-search__input" })), suggested &&
      index.h("datalist", { id: "search-list" }, suggested.map((k, v) => index.h("option", { value: k, key: v }))), index.h("gcds-button", { type: "submit", class: "gcds-search__button", exportparts: "button" }, index.h("gcds-icon", { name: "search", label: I18N$5[lang].search, "fixed-width": true }))))));
  }
  get el() { return index.getElement(this); }
};
