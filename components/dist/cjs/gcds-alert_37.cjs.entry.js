...
const index = require('./index-b713593a.js');
...
const GcdsAlert = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, isOpen ? (index.h("div", { class: `gcds-alert alert--role-${alertRole} ${isFixed ? 'alert--is-fixed' : ''}`, role: "alert", "aria-label": alertRole === 'danger'
        ? I18N$k[lang].label.danger
        : alertRole === 'info'
          ? I18N$k[lang].label.info
          : alertRole === 'success'
            ? I18N$k[lang].label.success
            : alertRole === 'warning'
              ? I18N$k[lang].label.warning
        ...
        : alertRole === 'info'
          ...
          : alertRole === 'success'
            ...
            : alertRole === 'warning'
              ...
              : null })), index.h("div", { class: "alert__content" }, index.h("p", { class: "alert__heading" }, index.h("strong", null, heading)), index.h("slot", null)), !hideCloseBtn && (index.h("button", { class: "alert__close-btn", onClick: e => this.onDismiss(e), "aria-label": I18N$k[lang].closeBtn }, index.h("gcds-icon", { "aria-hidden": "true", name: "times", size: "text" }))))))) : null));
  }
...
const GcdsButton = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h(Tag, Object.assign({}, attrs, { id: buttonId, onBlur: e => this.onBlur(e), onFocus: e => this.onFocus(e), onClick: e => this.handleClick(e), class: `button--role-${buttonRole} button--${buttonStyle} button--${size}`, ref: element => (this.shadowElement = element) }, inheritedAttributes, { part: "button" }), index.h("slot", { name: "left" }), index.h("slot", null), type === 'link' && target === '_blank' ? (index.h("gcds-icon", { name: "external-link", label: I18N$i[lang].label, "margin-left": "200" })) : (index.h("slot", { name: "right" })))));
  }
  get el() { return index.getElement(this); }
...
const GcdsDateModified = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("dl", { class: "gcds-date-modified" }, index.h("dt", null, type === 'version' ? 'Version ' : I18N$h[lang].term), index.h("dd", null, type === 'version' ? (index.h("slot", null)) : (index.h("time", null, index.h("slot", null)))))));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsErrorSummary = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { role: "alert", tabindex: "-1", ref: element => (this.shadowElement = element), class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0
        ? 'gcds-show'
        : ''}` }, index.h("h2", { class: "summary__heading" }, heading !== null && heading !== void 0 ? heading : I18N$g[lang].heading), index.h("ol", { class: "summary__errorlist" }, (hasSubmitted || errorLinks) &&
...
const GcdsFieldset = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("fieldset", Object.assign({ class: `gcds-fieldset ${hasError ? 'gcds-fieldset--error' : ''}`, id: fieldsetId }, fieldsetAttrs, { "aria-labelledby": hint
        ...
        : `legend-${fieldsetId}`, tabindex: "-1", ref: element => (this.shadowElement = element) }), index.h("legend", { id: `legend-${fieldsetId}` }, legend, required ? (index.h("strong", { class: "legend__required" }, "(", I18N$f[lang].required, ")")) : null), hint ? index.h("gcds-hint", { hint: hint, "hint-id": fieldsetId }) : null, errorMessage ? (index.h("gcds-error-message", { messageId: fieldsetId, message: errorMessage })) : null, index.h("slot", null))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
    "errorMessage": ["validateErrorMessage"],
...
const GcdsFileUploader = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: `gcds-file-uploader-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, index.h("gcds-label", Object.assign({}, attrsLabel, { "label-for": uploaderId, lang: lang })), hint ? index.h("gcds-hint", { hint: hint, "hint-id": uploaderId }) : null, errorMessage ? (index.h("gcds-error-message", { messageId: uploaderId, message: errorMessage })) : null, index.h("div", { class: `file-uploader__input ${value.length > 0 ? 'uploaded-files' : ''}` }, index.h("button", { type: "button", tabindex: "-1", onClick: () => this.shadowElement.click() }, I18N$e[lang].button.upload), index.h("input", Object.assign({ type: "file", id: uploaderId, name: uploaderId }, attrsInput, { onBlur: e => this.onBlur(e), onFocus: e => this.onFocus(e), onChange: e => this.handleChange(e), "aria-invalid": hasError ? 'true' : 'false', ref: element => (this.shadowElement = element) })), value.length > 0 ? (index.h("p", { id: "file-uploader__summary" }, index.h("span", null, I18N$e[lang].summary.selected, " "), value.map(file => (index.h("span", null, file, " "))))) : (index.h("p", { id: "file-uploader__summary" }, I18N$e[lang].summary.unselected))), value.length > 0
      ? value.map(file => (index.h("div", { class: "file-uploader__uploaded-file", "aria-label": `${I18N$e[lang].removeFile} ${file}.` }, index.h("span", null, file), index.h("button", { onClick: e => this.removeFile(e) }, index.h("span", null, I18N$e[lang].button.remove), index.h("gcds-icon", { name: "times", size: "text", "margin-left": "200" })))))
      : null)));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const GcdsFooter = class {
  ...
  render() {
    ...
    const govNav = I18N$d[lang].gov.menu;
    const themeNav = I18N$d[lang].themes.menu;
    const siteNav = I18N$d[lang].site.menu;
    let contextualLinkCount = 0;
    let subLinkCount = 0;
    return (index.h(index.Host, { role: "contentinfo" }, index.h("h2", { class: "gcds-footer__header" }, I18N$d[lang].about), contextualLinksObject && contextualHeading && (index.h("div", { class: "gcds-footer__contextual" }, index.h("div", { class: "contextual__container" }, index.h("nav", { "aria-label": contextualHeading }, index.h("h3", { class: "contextual__header" }, contextualHeading), index.h("ul", { class: "contextual__list" }, Object.keys(contextualLinksObject).map(key => {
      if (contextualLinkCount < 3) {
        contextualLinkCount++;
        return (index.h("li", null, index.h("a", { href: contextualLinksObject[key] }, key)));
      }
    })))))), display === 'full' ? (index.h("div", { class: "gcds-footer__main" }, index.h("div", { class: "main__container" }, index.h("nav", { class: "main__govnav", "aria-label": I18N$d[lang].gov.heading }, index.h("h3", null, I18N$d[lang].gov.heading), index.h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (index.h("li", null, index.h("a", { href: govNav[value].link }, govNav[value].text)))))), index.h("nav", { class: "main__themenav", "aria-label": I18N$d[lang].themes.heading }, index.h("h4", { class: "themenav__header" }, I18N$d[lang].themes.heading), index.h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (index.h("li", null, index.h("a", { href: themeNav[value].link }, themeNav[value].text))))))))) : null, index.h("div", { class: "gcds-footer__sub" }, index.h("div", { class: "sub__container" }, index.h("nav", { "aria-label": I18N$d[lang].site.heading }, index.h("h3", { class: "sub__header" }, I18N$d[lang].site.heading), index.h("ul", null, subLinks
...
const GcdsHeader = class {
  ...
  get renderSkipToNav() {
    if (this.el.querySelector('[slot="skip-to-nav"]')) {
      ...
      return (index.h("nav", { class: "gcds-header__skip-to-nav" }, index.h("gcds-button", { type: "link", "button-role": "skip-to-content", href: this.skipToHref }, I18N$c[this.lang].skip)));
    }
    else {
      return;
    }
...
const GcdsLabel = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { id: `label-for-${labelFor}`, onClick: this.onClick }, index.h("label", { htmlFor: labelFor, class: `gcds-label ${hideLabel ? 'label--hidden' : ''}`, ref: focusEl => (this.focusEl = focusEl) }, index.h("span", null, label), required ? (index.h("span", { "aria-hidden": "true", class: "label--required" }, "(", I18N$b[lang].required, ")")) : null)));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsLangToggle = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", null, index.h("h2", null, I18N$a[lang].heading), index.h("a", { href: href, lang: I18N$a[lang].abbreviation }, index.h("span", null, I18N$a[lang].language), index.h("abbr", { title: I18N$a[lang].language }, I18N$a[lang].abbreviation)))));
  }
  get el() { return index.getElement(this); }
};
...
//# sourceMappingURL=gcds-alert_37.cjs.entry.js.map