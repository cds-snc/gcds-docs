...
let GcdsButton = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { onClick: this.handleClick }, index.h(Tag, Object.assign({}, attrs, { onBlur: this.onBlur, onFocus: this.onFocus, class: `${task} ${variant} ${stateClass}` }), index.h("slot", { name: "left" }), index.h("slot", null), index.h("slot", { name: "right" }))));
  }
