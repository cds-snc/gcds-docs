...
let GcdsInput = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("gcds-label", Object.assign({}, attrsLabel, { "hide-label": hideLabel, "label-for": inputId })), hint ? index.h("gcds-hint", { hint: hint, "hint-id": inputId }) : null, errorMessage ?
