  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, isOpen ?
      index.h("div", { class: `gcds-alert alert--role-${alertRole} ${isFixed ? 'alert--is-fixed' : ''}`, role: "alert", "aria-label": alertRole === 'danger' ? I18N$h[lang].label.danger
          : alertRole === 'info' ? I18N$h[lang].label.info
            : alertRole === 'success' ? I18N$h[lang].label.success
              : alertRole === 'warning' ? I18N$h[lang].label.warning
        ...
        index.h("button", { class: "alert__close-btn", onClick: (e) => this.onDismiss(e), "aria-label": I18N$h[lang].closeBtn }, index.h("gcds-icon", { "aria-hidden": "true", name: "times", size: "text" }))))))
      : null));
  }
...
const GcdsBreadcrumbs = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("nav", { "aria-label": I18N$g[lang].label, class: "gcds-breadcrumbs" }, index.h("ol", { class: hideCanadaLink ? '' : 'has-canada-link' }, !hideCanadaLink ?
...
const GcdsButton = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h(Tag, Object.assign({}, attrs, { id: buttonId, onBlur: (e) => this.onBlur(e), onFocus: (e) => this.onFocus(e), onClick: (e) => this.handleClick(e), class: `button--role-${buttonRole} button--${buttonStyle} button--${size}`, ref: element => this.shadowElement = element }, inheritedAttributes), index.h("slot", { name: "left" }), index.h("slot", null), type === 'link' && target === '_blank' ?
      index.h("gcds-icon", { name: "external-link", label: I18N$f[lang].label, "margin-left": "200" })
...
const GcdsDateModified = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("dl", { class: "gcds-date-modified" }, index.h("dt", null, type === 'version' ? 'Version ' : I18N$e[lang].term), index.h("dd", null, type === 'version' ?
      index.h("slot", null)
      :
...
const GcdsDetails = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("details", { class: "gcds-details", open: open ? true : false }, index.h("summary", null, index.h("p", null, detailsTitle)), index.h("div", { class: "details__panel" }, index.h("slot", null)))));
  }
  get el() { return index.getElement(this); }
};
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("fieldset", Object.assign({ class: `gcds-fieldset ${hasError ? "gcds-fieldset--error" : ''}`, id: fieldsetId }, fieldsetAttrs, { "aria-labelledby": hint ? `legend-${fieldsetId} hint-${fieldsetId}` : `legend-${fieldsetId}`, tabindex: "-1", ref: element => this.shadowElement = element }), index.h("legend", { id: `legend-${fieldsetId}` }, legend, required ?
      index.h("strong", { class: "legend__required" }, "(", I18N$c[lang].required, ")")
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: `gcds-file-uploader-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, index.h("gcds-label", Object.assign({}, attrsLabel, { "label-for": uploaderId, lang: lang })), hint ? index.h("gcds-hint", { hint: hint, "hint-id": uploaderId }) : null, errorMessage ?
      ...
      : null, index.h("div", { class: `file-uploader__input ${value.length > 0 ? "uploaded-files" : ''}` }, index.h("button", { type: "button", tabindex: "-1", onClick: () => this.shadowElement.click() }, I18N$b[lang].button.upload, index.h("gcds-icon", { name: "upload", "margin-left": "200" })), index.h("input", Object.assign({ type: "file", id: uploaderId, name: uploaderId }, attrsInput, { onBlur: (e) => this.onBlur(e), onFocus: (e) => this.onFocus(e), onChange: (e) => this.handleChange(e), "aria-invalid": hasError ? 'true' : 'false', ref: element => this.shadowElement = element })), value.length > 0 ?
      index.h("p", { id: "file-uploader__summary" }, index.h("span", null, I18N$b[lang].summary.selected, " "), value.map(file => (index.h("span", null, file, " "))))
      :
        index.h("p", { id: "file-uploader__summary" }, I18N$b[lang].summary.unselected)), value.length > 0 ? value.map(file => (index.h("div", { class: "file-uploader__uploaded-file", "aria-label": `${I18N$b[lang].removeFile} ${file}.` }, index.h("span", null, file), index.h("button", { onClick: (e) => this.removeFile(e) }, index.h("span", null, I18N$b[lang].button.remove), index.h("gcds-icon", { name: "times", size: "text", "margin-left": "200" }))))) : null)));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const GcdsFooter = class {
  ...
  */
  ...
  render() {
    ...
    const govNav = I18N$a[lang].gov.menu;
    const themeNav = I18N$a[lang].themes.menu;
    const siteNav = I18N$a[lang].site.menu;
    let contextualLinkCount = 0;
    let subLinkCount = 0;
    return (index.h(index.Host, { role: "contentinfo" }, index.h("h2", { class: "gcds-footer__header" }, I18N$a[lang].about), (contextualLinksObject && contextualHeading) &&
      ...
      (index.h("div", { class: "gcds-footer__main" }, index.h("div", { class: "main__container" }, index.h("nav", { class: "main__govnav", "aria-label": I18N$a[lang].gov.heading }, index.h("h3", null, I18N$a[lang].gov.heading), index.h("ul", { class: "govnav__list" }, Object.keys(govNav).map((value) => index.h("li", null, index.h("a", { href: govNav[value].link }, govNav[value].text))))), index.h("nav", { class: "main__themenav", "aria-label": I18N$a[lang].themes.heading }, index.h("h4", { class: "themenav__header" }, I18N$a[lang].themes.heading), index.h("ul", { class: "themenav__list" }, Object.keys(themeNav).map((value) => index.h("li", null, index.h("a", { href: themeNav[value].link }, themeNav[value].text))))))))
      : null, index.h("div", { class: "gcds-footer__sub" }, index.h("div", { class: "sub__container" }, index.h("nav", { "aria-label": I18N$a[lang].site.heading }, index.h("h3", { class: "sub__header" }, I18N$a[lang].site.heading), index.h("ul", null, subLinks ?
  ...
  */
  ...
  get renderTopNav() {
    if (!!this.el.querySelector('[slot="topnav"]')) {
      return index.h("slot", { name: "topnav" });
    }
    else if (this.skipToHref) {
      return (index.h("nav", { "aria-label": i18n[this.lang].skip, class: "gcds-header__topnav" }, index.h("gcds-button", { type: "link", "button-role": "skip-to-content", href: this.skipToHref }, i18n[this.lang].skip)));
    }
    else {
      return;
    }
  ...
  get renderSearch() {
    if (!!this.el.querySelector('[slot="search"]')) {
      return index.h("slot", { name: "search" });
    }
    else {
      return;
    }
  ...
  render() {
    ...
    return (index.h(index.Host, { role: "banner" }, renderTopNav, hasBanner ?
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, { id: `label-for-${labelFor}`, onClick: this.onClick }, index.h("label", { htmlFor: labelFor, class: `gcds-label ${hideLabel ? 'label--hidden' : ''}`, ref: (focusEl) => (this.focusEl = focusEl) }, index.h("span", null, label), required ?
      index.h("span", { "aria-hidden": "true", class: "label--required" }, "(", I18N$9[lang].required, ")")
      : null)));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsLangToggle = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", null, index.h("h2", null, I18N$8[lang].heading), index.h("a", { href: href, lang: I18N$8[lang].abbreviation }, index.h("span", null, I18N$8[lang].language), index.h("abbr", { title: I18N$8[lang].language }, I18N$8[lang].abbreviation)))));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsNavGroup = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, { role: "presentation", open: open, class: open && "gcds-nav-group-expanded" }, index.h("button", { "aria-haspopup": "true", "aria-expanded": open.toString(), role: "menuitem", "aria-describedby": "trigger-controls", ref: element => this.triggerElement = element, class: `gcds-nav-group__trigger gcds-trigger--${this.navStyle}`, onClick: () => {
        this.toggleNav();
        this.gcdsClick.emit();
      } }, index.h("gcds-icon", { name: open ? 'angle-up' : 'angle-down' }), closeTrigger && open ? closeTrigger : openTrigger), index.h("ul", { role: "menu", "aria-label": menuLabel, class: `gcds-nav-group__list gcds-nav--${this.navStyle}` }, index.h("slot", null)), index.h("span", { "aria-hidden": "true", id: `trigger-controls`, class: "gcds-nav-group__trigger-desc" }, I18N$7[lang].submenu.replace('{$t}', menuLabel))));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsPagination = class {
  ...
  configurePaginationStep(page, end, mobile) {
    let linkAttrs = {
      ...
      "aria-label": !end ?
        I18N$6[this.lang].pageNumberOf.replace('{#}', page).replace('{total}', this.totalPages).replace('{label}', this.label)
        :
          end == "next" ?
            `${I18N$6[this.lang].nextPage}: ${I18N$6[this.lang].pageNumberOf.replace('{#}', ++page).replace('{total}', this.totalPages).replace('{label}', this.label)}`
            :
              `${I18N$6[this.lang].previousPage}: ${I18N$6[this.lang].pageNumberOf.replace('{#}', --page).replace('{total}', this.totalPages).replace('{label}', this.label)}`,
    };
    ...
    if (end) {
      return (index.h("li", null, end === "next" ?
        index.h("a", Object.assign({}, linkAttrs, { class: !mobile ? "gcds-pagination-end-button" : "gcds-pagination-end-button-mobile" }), I18N$6[this.lang].next, index.h("gcds-icon", { "margin-left": "200", name: "arrow-right" }))
        :
          index.h("a", Object.assign({}, linkAttrs, { class: !mobile ? "gcds-pagination-end-button" : "gcds-pagination-end-button-mobile" }), index.h("gcds-icon", { "margin-right": "200", name: "arrow-left" }), I18N$6[this.lang].previous)));
    }
    else {
    ...
    return (index.h(index.Host, { role: "navigation", "aria-label": label }, display === "list" ?
      ...
      :
        index.h("ul", { class: "gcds-pagination-simple" }, previousHref &&
          index.h("li", { class: "gcds-pagination-simple-previous" }, index.h("a", { href: previousHref, "aria-label": `${I18N$6[lang].previousPage}${previousLabel ? `: ${previousLabel}` : ""}`, onClick: (e) => this.onPageChange(e) }, index.h("gcds-icon", { "margin-right": "200", name: "arrow-left" }), index.h("div", { class: "gcds-pagination-simple-text" }, I18N$6[lang].previous), index.h("span", null, previousLabel))), nextHref &&
          index.h("li", { class: "gcds-pagination-simple-next" }, index.h("a", { href: nextHref, "aria-label": `${I18N$6[lang].nextPage}${nextLabel ? `: ${nextLabel}` : ""}`, onClick: (e) => this.onPageChange(e) }, index.h("div", { class: "gcds-pagination-simple-text" }, I18N$6[lang].next), index.h("span", null, nextLabel), index.h("gcds-icon", { "margin-left": "200", name: "arrow-right" }))))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const gcdsSignatureCss = "gcds-signature{display:block;margin:var(--gcds-signature-margin);width:-webkit-fit-content;width:-moz-fit-content;width:fit-content}gcds-signature .gcds-signature{display:-ms-flexbox;display:flex}gcds-signature svg{max-width:100%}gcds-signature:not([type=wordmark]) svg{height:var(--gcds-signature-signature-height);margin:var(--gcds-signature-signature-margin)}@media screen and (min-width:64em){gcds-signature:not([type=wordmark]) svg{height:2.125rem}}gcds-signature[type=wordmark] svg{height:var(--gcds-signature-wordmark-height);margin:var(--gcds-signature-wordmark-margin);width:auto}gcds-signature:not([variant=white]) svg .fip_text{fill:var( --gcds-signature-color-text)}gcds-signature:not([variant=white]) svg .fip_flag{fill:var(--gcds-signature-color-flag)}gcds-signature[variant=white] svg .fip_flag,gcds-signature[variant=white] svg .fip_text{fill:var(--gcds-signature-white-default)}";
...
const GcdsStepper = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("h6", { class: "gcds-stepper" }, `${I18N$3[lang].step} ${currentStep} ${I18N$3[lang].of} ${totalSteps}`)));
  }
  get el() { return index.getElement(this); }
};
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: `gcds-textarea-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, index.h("gcds-label", Object.assign({}, attrsLabel, { "hide-label": hideLabel, "label-for": textareaId, lang: lang })), hint ? index.h("gcds-hint", { hint: hint, "hint-id": textareaId }) : null, errorMessage ?
      ...
      index.h("p", { id: `textarea__count-${textareaId}`, "aria-live": "polite" }, value == undefined ? `${characterCount} ${I18N$2[lang].characters.allowed}`
        :
