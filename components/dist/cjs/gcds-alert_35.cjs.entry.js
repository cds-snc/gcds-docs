...
const index = require('./index-d95f7463.js');
...
const GcdsAlert = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, isOpen ?
      index.h("div", { class: `gcds-alert alert--role-${alertRole} ${isFixed ? 'alert--is-fixed' : ''}`, role: "alert", "aria-label": alertRole === 'danger' ? I18N$i[lang].label.danger
          : alertRole === 'info' ? I18N$i[lang].label.info
            : alertRole === 'success' ? I18N$i[lang].label.success
              : alertRole === 'warning' ? I18N$i[lang].label.warning
                : null }, index.h("gcds-container", { size: isFixed ? container : 'full', centered: true }, index.h("div", { class: "alert__container" }, (!hideRoleIcon &&
        index.h("gcds-icon", { "aria-hidden": "true", class: "alert__icon", size: "h5", name: alertRole === 'danger' ? 'exclamation-circle'
            : alertRole === 'info' ? 'info-circle'
              : alertRole === 'success' ? 'check-circle'
                : alertRole === 'warning' ? 'exclamation-triangle'
                  : null })), index.h("div", { class: "alert__content" }, index.h("p", { class: "alert__heading" }, index.h("strong", null, heading)), index.h("slot", null)), (!hideCloseBtn &&
        index.h("button", { class: "alert__close-btn", onClick: (e) => this.onDismiss(e), "aria-label": I18N$i[lang].closeBtn }, index.h("gcds-icon", { "aria-hidden": "true", name: "times", size: "text" }))))))
      : null));
  }
...
const GcdsBreadcrumbs = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("nav", { "aria-label": I18N$h[lang].label, class: "gcds-breadcrumbs" }, index.h("ol", { class: hideCanadaLink ? '' : 'has-canada-link' }, !hideCanadaLink ?
      index.h("gcds-breadcrumbs-item", { href: `https://www.canada.ca/${lang == 'fr' ? 'fr' : 'en'}.html` }, "Canada.ca")
...
const GcdsButton = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h(Tag, Object.assign({}, attrs, { id: buttonId, onBlur: (e) => this.onBlur(e), onFocus: (e) => this.onFocus(e), onClick: (e) => this.handleClick(e), class: `button--role-${buttonRole} button--${buttonStyle} button--${size}`, ref: element => this.shadowElement = element }, inheritedAttributes, { part: "button" }), index.h("slot", { name: "left" }), index.h("slot", null), type === 'link' && target === '_blank' ?
      index.h("gcds-icon", { name: "external-link", label: I18N$g[lang].label, "margin-left": "200" })
...
const GcdsCard = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: `gcds-card gcds-card--${type}` }, imgSrc &&
      index.h("img", { src: imgSrc, alt: imgAlt ? imgAlt : "", class: "gcds-card__image" }), tag &&
      index.h("span", { class: "gcds-card__tag" }, tag), Element != 'a' ?
      index.h(Element, { class: "gcds-card__title" }, index.h("a", { href: href }, cardTitle))
      :
        index.h("a", { href: href, class: "gcds-card__title" }, cardTitle), description &&
      index.h("p", { class: "gcds-card__description" }, description), hasCardFooter &&
      index.h(index.Fragment, null, index.h("div", { class: "gcds-card__spacer" }), index.h("slot", { name: "footer" })))));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsDateModified = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("dl", { class: "gcds-date-modified" }, index.h("dt", null, type === 'version' ? 'Version ' : I18N$f[lang].term), index.h("dd", null, type === 'version' ?
      index.h("slot", null)
      :
        index.h("time", null, index.h("slot", null))))));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsErrorSummary = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { role: "alert", tabindex: "-1", ref: element => this.shadowElement = element, class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0 ? 'gcds-show' : ''}` }, index.h("h2", { class: "summary__heading" }, heading !== null && heading !== void 0 ? heading : I18N$e[lang].heading), index.h("ol", { class: "summary__errorlist" }, ((hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0) && Object.keys(errorQueue).map((key) => {
...
const GcdsFieldset = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("fieldset", Object.assign({ class: `gcds-fieldset ${hasError ? "gcds-fieldset--error" : ''}`, id: fieldsetId }, fieldsetAttrs, { "aria-labelledby": hint ? `legend-${fieldsetId} hint-${fieldsetId}` : `legend-${fieldsetId}`, tabindex: "-1", ref: element => this.shadowElement = element }), index.h("legend", { id: `legend-${fieldsetId}` }, legend, required ?
      index.h("strong", { class: "legend__required" }, "(", I18N$d[lang].required, ")")
      : null), hint ? index.h("gcds-hint", { hint: hint, "hint-id": fieldsetId }) : null, errorMessage ? index.h("gcds-error-message", { messageId: fieldsetId, message: errorMessage }) : null, index.h("slot", null))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
    "errorMessage": ["validateErrorMessage"],
...
const GcdsFileUploader = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: `gcds-file-uploader-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, index.h("gcds-label", Object.assign({}, attrsLabel, { "label-for": uploaderId, lang: lang })), hint ? index.h("gcds-hint", { hint: hint, "hint-id": uploaderId }) : null, errorMessage ?
      index.h("gcds-error-message", { messageId: uploaderId, message: errorMessage })
      : null, index.h("div", { class: `file-uploader__input ${value.length > 0 ? "uploaded-files" : ''}` }, index.h("button", { type: "button", tabindex: "-1", onClick: () => this.shadowElement.click() }, I18N$c[lang].button.upload), index.h("input", Object.assign({ type: "file", id: uploaderId, name: uploaderId }, attrsInput, { onBlur: (e) => this.onBlur(e), onFocus: (e) => this.onFocus(e), onChange: (e) => this.handleChange(e), "aria-invalid": hasError ? 'true' : 'false', ref: element => this.shadowElement = element })), value.length > 0 ?
      index.h("p", { id: "file-uploader__summary" }, index.h("span", null, I18N$c[lang].summary.selected, " "), value.map(file => (index.h("span", null, file, " "))))
      :
        index.h("p", { id: "file-uploader__summary" }, I18N$c[lang].summary.unselected)), value.length > 0 ? value.map(file => (index.h("div", { class: "file-uploader__uploaded-file", "aria-label": `${I18N$c[lang].removeFile} ${file}.` }, index.h("span", null, file), index.h("button", { onClick: (e) => this.removeFile(e) }, index.h("span", null, I18N$c[lang].button.remove), index.h("gcds-icon", { name: "times", size: "text", "margin-left": "200" }))))) : null)));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const GcdsFooter = class {
  ...
  */
  ...
  render() {
    ...
    let subLinkCount = 0;
    return (index.h(index.Host, { role: "contentinfo" }, index.h("h2", { class: "gcds-footer__header" }, I18N$b[lang].about), (contextualLinksObject && contextualHeading) &&
      index.h("div", { class: "gcds-footer__contextual" }, index.h("div", { class: "contextual__container" }, index.h("nav", { "aria-label": contextualHeading }, index.h("h3", { class: "contextual__header" }, contextualHeading), index.h("ul", { class: "contextual__list" }, Object.keys(contextualLinksObject).map((key) => {
        if (contextualLinkCount < 3) {
          contextualLinkCount++;
          return (index.h("li", null, index.h("a", { href: contextualLinksObject[key] }, key)));
        }
      }))))), display === "full" ?
      (index.h("div", { class: "gcds-footer__main" }, index.h("div", { class: "main__container" }, index.h("nav", { class: "main__govnav", "aria-label": I18N$b[lang].gov.heading }, index.h("h3", null, I18N$b[lang].gov.heading), index.h("ul", { class: "govnav__list" }, Object.keys(govNav).map((value) => index.h("li", null, index.h("a", { href: govNav[value].link }, govNav[value].text))))), index.h("nav", { class: "main__themenav", "aria-label": I18N$b[lang].themes.heading }, index.h("h4", { class: "themenav__header" }, I18N$b[lang].themes.heading), index.h("ul", { class: "themenav__list" }, Object.keys(themeNav).map((value) => index.h("li", null, index.h("a", { href: themeNav[value].link }, themeNav[value].text))))))))
      : null, index.h("div", { class: "gcds-footer__sub" }, index.h("div", { class: "sub__container" }, index.h("nav", { "aria-label": I18N$b[lang].site.heading }, index.h("h3", { class: "sub__header" }, I18N$b[lang].site.heading), index.h("ul", null, subLinks ?
...
const GcdsGrid = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, container ?
      index.h("gcds-container", { size: container, centered: centered }, index.h(Tag, { class: classNames, style: handleColumns() }, index.h("slot", null)))
      :
        index.h(Tag, { class: classNames, style: handleColumns() }, index.h("slot", null))));
  }
  get el() { return index.getElement(this); }
};
  ...
  */
  ...
  get renderSkipToNav() {
    if (!!this.el.querySelector('[slot="skip-to-nav"]')) {
      ...
      return (index.h("nav", { "aria-label": i18n[this.lang].skip, class: "gcds-header__skip-to-nav" }, index.h("gcds-button", { type: "link", "button-role": "skip-to-content", href: this.skipToHref }, i18n[this.lang].skip)));
    }
    else {
      return;
    }
  ...
  render() {
    ...
    return (index.h(index.Host, { role: "banner" }, renderSkipToNav, hasBanner ?
      index.h("slot", { name: "banner" })
      :
        null, index.h("div", { class: "gcds-header__brand" }, index.h("div", { class: `brand__container ${!hasSearch ? 'container--simple' : ''}` }, renderToggle, renderSignature, renderSearch)), index.h("slot", { name: "menu" }), hasBreadcrumb ?
      index.h("div", { class: "gcds-header__container" }, index.h("slot", { name: "breadcrumb" }))
      :
        null));
  }
  get el() { return index.getElement(this); }
...
const GcdsInput = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: `gcds-input-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, index.h("gcds-label", Object.assign({}, attrsLabel, { "hide-label": hideLabel, "label-for": inputId, lang: lang })), hint ? index.h("gcds-hint", { hint: hint, "hint-id": inputId }) : null, errorMessage ?
      index.h("gcds-error-message", { messageId: inputId, message: errorMessage })
...
const GcdsLabel = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, { id: `label-for-${labelFor}`, onClick: this.onClick }, index.h("label", { htmlFor: labelFor, class: `gcds-label ${hideLabel ? 'label--hidden' : ''}`, ref: (focusEl) => (this.focusEl = focusEl) }, index.h("span", null, label), required ?
      index.h("span", { "aria-hidden": "true", class: "label--required" }, "(", I18N$a[lang].required, ")")
      : null)));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsLangToggle = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", null, index.h("h2", null, I18N$9[lang].heading), index.h("a", { href: href, lang: I18N$9[lang].abbreviation }, index.h("span", null, I18N$9[lang].language), index.h("abbr", { title: I18N$9[lang].language }, I18N$9[lang].abbreviation)))));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsPagination = class {
  ...
  configurePaginationStep(page, end, mobile) {
    let linkAttrs = {
      ...
      "aria-label": !end ?
        I18N$8[this.lang].pageNumberOf.replace('{#}', page).replace('{total}', this.totalPages).replace('{label}', this.label)
        :
          end == "next" ?
            `${I18N$8[this.lang].nextPage}: ${I18N$8[this.lang].pageNumberOf.replace('{#}', ++page).replace('{total}', this.totalPages).replace('{label}', this.label)}`
            :
              `${I18N$8[this.lang].previousPage}: ${I18N$8[this.lang].pageNumberOf.replace('{#}', --page).replace('{total}', this.totalPages).replace('{label}', this.label)}`,
    };
    if (page == this.currentPage && !end) {
      linkAttrs['aria-current'] = "page";
    }
    if (end) {
      return (index.h("li", null, end === "next" ?
        index.h("a", Object.assign({}, linkAttrs, { class: !mobile ? "gcds-pagination-end-button" : "gcds-pagination-end-button-mobile" }), I18N$8[this.lang].next, index.h("gcds-icon", { "margin-left": "200", name: "arrow-right" }))
        :
          index.h("a", Object.assign({}, linkAttrs, { class: !mobile ? "gcds-pagination-end-button" : "gcds-pagination-end-button-mobile" }), index.h("gcds-icon", { "margin-right": "200", name: "arrow-left" }), mobile ? I18N$8[this.lang].previousMobile : I18N$8[this.lang].previous)));
    }
    else {
      return (index.h("li", { class: page != 1 && page != this.totalPages ? constructClasses(page, this.currentPage, this.totalPages) : "" }, index.h("a", Object.assign({}, linkAttrs), page)));
    }
  }
  /**
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, { role: "navigation", "aria-label": label }, display === "list" ?
      index.h("div", null, index.h("ul", { class: "gcds-pagination-list" }, this.listitems), index.h("ul", { class: "gcds-pagination-list-mobile-prevnext" }, this.mobilePrevNext))
      :
        index.h("ul", { class: "gcds-pagination-simple" }, previousHref &&
          index.h("li", { class: "gcds-pagination-simple-previous" }, index.h("a", { href: previousHref, "aria-label": `${I18N$8[lang].previousPage}${previousLabel ? `: ${previousLabel}` : ""}`, onClick: (e) => this.onPageChange(e) }, index.h("gcds-icon", { "margin-right": "200", name: "arrow-left" }), index.h("div", { class: "gcds-pagination-simple-text" }, I18N$8[lang].previous), index.h("span", null, previousLabel))), nextHref &&
          index.h("li", { class: "gcds-pagination-simple-next" }, index.h("a", { href: nextHref, "aria-label": `${I18N$8[lang].nextPage}${nextLabel ? `: ${nextLabel}` : ""}`, onClick: (e) => this.onPageChange(e) }, index.h("div", { class: "gcds-pagination-simple-text" }, I18N$8[lang].next), index.h("span", null, nextLabel), index.h("gcds-icon", { "margin-left": "200", name: "arrow-right" }))))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const GcdsRadio = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: `gcds-radio ${disabled ? 'gcds-radio--disabled' : ''} ${hasError ? 'gcds-radio--error' : ''}` }, index.h("input", Object.assign({ id: radioId, type: "radio" }, attrsInput, { onChange: () => this.onChange(name), onBlur: (e) => this.onBlur(e), onFocus: (e) => this.onFocus(e), onClick: (e) => { this.clickHandler && this.clickHandler(e); }, ref: element => this.shadowElement = element })), index.h("gcds-label", { label: label, "label-for": radioId, lang: lang }), hint ? index.h("gcds-hint", { hint: hint, "hint-id": radioId }) : null, parentError && index.h("span", { id: `parent-error-${radioId}`, hidden: true }, parentError))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
    "hasError": ["validateHasError"]
...
const GcdsSearch = class {
  ...
  */
  ...
  render() {
    ...
    let labelText = `${I18N$6[lang].searchLabel.replace("{$}", placeholder)}`;
    const attrsInput = {
      name,
      placeholder: labelText
    };
    let formAction = action === '/sr/srb.html' ? `https://www.canada.ca/${lang}/sr/srb.html` : action;
    return (index.h(index.Host, null, index.h("div", { class: "gcds-search" }, index.h("h2", { class: "gcds-search__header" }, I18N$6[lang].search), index.h("form", { action: formAction, method: method, role: "search", onSubmit: () => this.gcdsSubmit.emit(), class: "gcds-search__form" }, index.h("gcds-label", { label: labelText, "label-for": searchId, "hide-label": true }), index.h("input", Object.assign({ type: "search", id: searchId, list: "search-list", size: 34, maxLength: 170, onChange: () => this.gcdsChange.emit(), onFocus: () => this.gcdsFocus.emit(), onBlur: () => this.gcdsBlur.emit() }, attrsInput, { class: "gcds-search__input" })), suggested &&
      index.h("datalist", { id: "search-list" }, suggested.map((k, v) => index.h("option", { value: k, key: v }))), index.h("gcds-button", { type: "submit", class: "gcds-search__button", exportparts: "button" }, index.h("gcds-icon", { name: "search", label: I18N$6[lang].search, "fixed-width": true }))))));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsSelect = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: `gcds-select-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, index.h("gcds-label", Object.assign({}, attrsLabel, { "label-for": selectId, lang: lang })), hint ? index.h("gcds-hint", { hint: hint, "hint-id": selectId }) : null, errorMessage ?
      index.h("gcds-error-message", { messageId: selectId, message: errorMessage })
      : null, index.h("select", Object.assign({}, attrsSelect, { id: selectId, name: selectId, onBlur: (e) => this.onBlur(e), onFocus: (e) => this.onFocus(e), onChange: (e) => this.handleChange(e), "aria-invalid": hasError ? 'true' : 'false', ref: element => this.shadowElement = element }), defaultValue ?
      index.h("option", { value: "", disabled: true, selected: true }, defaultValue)
      : null, index.h("slot", null)))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const GcdsSignature = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, hasLink && type === 'signature' ? (index.h("a", { href: linkText, innerHTML: selectSVG })) : (index.h("div", { class: "gcds-signature", innerHTML: selectSVG }))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
    "type": ["validateType"],
...
const GcdsTextarea = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: `gcds-textarea-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, index.h("gcds-label", Object.assign({}, attrsLabel, { "hide-label": hideLabel, "label-for": textareaId, lang: lang })), hint ? index.h("gcds-hint", { hint: hint, "hint-id": textareaId }) : null, errorMessage ?
      index.h("gcds-error-message", { messageId: textareaId, message: errorMessage })
      ...
      index.h("p", { id: `textarea__count-${textareaId}`, "aria-live": "polite" }, value == undefined ? `${characterCount} ${I18N$3[lang].characters.allowed}`
        :
          `${characterCount - value.length} ${I18N$3[lang].characters.left}`)
      : null)));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const GcdsTopicMenu = class {
  ...
  */
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("nav", { class: "gcds-topic-menu" }, index.h("h2", { class: "gcds-topic-menu__heading" }, "Menu"), index.h("button", { "aria-haspopup": "true", "aria-expanded": this.open.toString(), "aria-label": I18N$1[lang].buttonLabel, onClick: async () => await this.toggleNav(), ref: element => this.menuButton = element, class: home && 'gcds-topic-menu--home' }, this.lang == 'en' ?
      index.h(index.Fragment, null, index.h("span", { class: "gcds-topic-menu__main" }, "Main "), "Menu")
      :
        index.h(index.Fragment, null, "Menu", index.h("span", { class: "gcds-topic-menu__main" }, " principal")), index.h("gcds-icon", { name: "chevron-down", "margin-left": "150", size: "caption" })), index.h("ul", { role: "menu", "aria-orientation": "vertical", "data-top-menu": true, innerHTML: this.listItems, ref: element => this.themeList = element }))));
  }
  get el() { return index.getElement(this); }
};
