...
const GcdsAlert = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7781cbb15b6de138ccd08cad1ab5f3a2de21e02e' }, isOpen ? (index.h("div", { class: `gcds-alert alert--role-${alertRole} ${isFixed ? 'alert--is-fixed' : ''}`, role: "alert", "aria-label": alertRole === 'danger'
...
const GcdsBreadcrumbs = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3cebead5d49755452f7dbf0a8292b38e86d481c9' }, index.h("nav", { key: '17a5ccde070a513bf3f37aae1cda845ed4e547fd', "aria-label": I18N$p[lang].label, class: "gcds-breadcrumbs" }, index.h("ol", { key: '74eaf642af3397da9f222499713148f50ae4ee99', class: hideCanadaLink ? '' : 'has-canada-link' }, !hideCanadaLink ? (index.h("gcds-breadcrumbs-item", { href: I18N$p[lang].link }, "Canada.ca")) : null, index.h("slot", { key: '8c90086d5e3bd78cda3594f7ac8d57feb7a58020' })))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsBreadcrumbsItem = class {
    ...
    render() {
        const { href } = this;
        return (index.h(index.Host, { key: '8b605a4957ab5346d22dced80f73e1a5f4ac555b', role: "listitem", class: "gcds-breadcrumbs-item" }, index.h("gcds-link", { key: 'd3c3af1d26322cb3ef0fbf6f8778bc0f4c3bf9c4', size: "regular", href: href }, index.h("slot", { key: 'f20dcd2b71127031fc0334fe3673821e08aefb56' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cb4009ea02793c43139bd32ce967ed14a34edc92' }, index.h(Tag, Object.assign({ key: 'f43a15193850a532bf2c48f19cfa089426e7fbb2' }, attrs, { id: buttonId, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => !disabled ? this.handleClick(e) : e.stopImmediatePropagation(), class: `gcds-button button--role-${buttonRole} button--${size}`, ref: element => (this.shadowElement = element) }, inheritedAttributes, { part: "button" }), index.h("slot", { key: 'ba77323179c20e81431e4463a4b435572e56b83e' }), type === 'link' && target === '_blank' ? (index.h("gcds-icon", { name: "external", label: I18N$o[lang].label, "margin-left": "150" })) : null)));
    }
...
const GcdsCard = class {
    ...
    render() {
        ...
        if (this.validateRequiredProps()) {
            return (index.h(index.Host, { key: '0402753bd0ae1f2248dbc0170d6ffa1470933734' }, index.h("div", { key: '4808bc995375f3c536578f0dc1b1307d955c8f33', class: "gcds-card" }, badge && !errors.includes('badge') && (index.h("gcds-text", { key: '6cf5c35378fad224ae666bdf6901ee482a40be6c', id: "gcds-badge", class: "gcds-badge", "text-role": "light", "margin-bottom": "0", size: "small" }, index.h("strong", { key: '4be70916982695192bf67e03e0659c8bb64a53f8' }, index.h("gcds-sr-only", { key: '6262dad21f6d5aec05093e12a1044a187acf58b7', tag: "span" }, I18N$n[lang].tagged), badge))), imgSrc && (index.h("img", { key: '8240ca4df2ed097f185667da8135e8e28a4b6040', src: imgSrc, alt: imgAlt ? imgAlt : '', class: "gcds-card__image" })), Element != 'a' ? (index.h(Element, Object.assign({ class: "gcds-card__title" }, taggedAttr), index.h("gcds-link", { href: href }, cardTitle))) : (index.h("gcds-link", Object.assign({ href: href, class: "gcds-card__title" }, taggedAttr), cardTitle)), renderDescription)));
        }
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const renderCheckbox = (checkbox, element, emitEvent, handleInput) => {
    ...
    return (index.h("div", { class: `gcds-checkbox ${disabled ? 'gcds-checkbox--disabled' : ''} ${hasError ? 'gcds-checkbox--error' : ''}` },
        index.h("input", Object.assign({ type: "checkbox" }, attrsInput, { onBlur: isGroup ? () => gcdsBlur.emit() : onBlurValidate, onFocus: () => gcdsFocus.emit(), onChange: () => gcdsChange.emit(), onInput: e => handleInput(e, gcdsInput), onClick: e => !disabled ? emitEvent(e, gcdsClick) : e.stopImmediatePropagation() })),
...
const GcdsContainer = class {
    ...
    render() {
        ...
        const Tag = tag;
        return (index.h(index.Host, { key: 'c773aa318c0dd603cfe509cd4d023b988bdecece' }, index.h(Tag, { key: '4cda1734f0e3c01a01f6e717d1ae7165c53ae39a', class: `
            gcds-container
            ...
            ${padding ? `p-${padding}` : ''}
            ${size ? `size-${size}` : ''}
          ` }, index.h("slot", { key: 'e8056d57376fc6322f29ec99b5349808b70fd1a8' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsDateInput = class {
    ...
    setValue() {
        ...
        if (yearValue && monthValue && dayValue && format == 'full') {
            ...
            if (utils.isValidDate(`${yearValue}-${monthValue}-${dayValue}`, format)) {
            ...
            // Is the combined value a valid date
            if (utils.isValidDate(`${yearValue}-${monthValue}`, format)) {
     ...
     */
    splitFormValue() {
        if (this.value && utils.isValidDate(this.value, this.format)) {
    ...
    render() {
        ...
        const day = (index.h("gcds-input", Object.assign({ key: 'f4f4816d1ee86f09f9d7cbd6164c0113508b5c2e', name: "day", label: I18N$m[lang].day, inputId: "day", type: "number", size: 2, disabled: disabled, value: this.dayValue, onInput: e => this.handleInput(e, 'day'), onChange: e => this.handleInput(e, 'day'), class: `gcds-date-input__day ${hasError['day'] ? 'gcds-date-input--error' : ''}` }, requiredAttr, { "aria-invalid": hasError['day'].toString(), "aria-description": hasError['day'] && errorMessage })));
        return (index.h(index.Host, { key: 'ac85e91eb06ebb903e19f38b1db0dffebda935b3', name: name, onBlur: () => this.onBlur() }, this.validateRequiredProps() && (index.h("fieldset", Object.assign({ key: 'cb19aa45342dba4333989a041440907566151174', class: "gcds-date-input__fieldset" }, fieldsetAttrs), index.h("legend", { key: '353bc7db0587959403cba784ca196b2d9fccfd92', id: "date-input-legend" }, legend, required ? (index.h("span", { class: "legend__required" }, I18N$m[lang].required)) : null), hint ? (index.h("gcds-hint", { id: "date-input-hint", "hint-id": "date-input" }, hint)) : null, errorMessage ? (index.h("div", null, index.h("gcds-error-message", { id: "date-input-error", messageId: "date-input" }, errorMessage))) : null, format == 'compact'
            ? [month, year]
            : lang == 'en'
                ? [month, day, year]
                : [day, month, year]))));
...
const GcdsDateModified = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ae1d5ceeefb2826a675edeca1f2fa0c81828b425' }, this.validateRequiredProps() && (index.h("dl", { key: '989b2ca91b4887f0a47c956c022550b475221a7d', class: "gcds-date-modified" }, index.h("dt", { key: '1d05ceb07362ad9b010769489ad3b0a057d9d754' }, index.h("gcds-text", { key: '61bb8fbe85f6614eeec0ebb9fabacc7b710dfc8d', display: "inline", "margin-bottom": "0" }, type === 'version' ? I18N$l[lang].version : I18N$l[lang].date)), index.h("dd", { key: '45cdfd7944ba0ca7ea4251d673eaf2f59f2346a0' }, index.h("gcds-text", { key: 'f2c0744b1a28ff5cd98ff8e3da8ce44384656b4d', display: "inline", "margin-bottom": "0" }, type === 'version' ? (index.h("slot", null)) : (index.h("time", null, index.h("slot", null)))))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsDetails = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '97560262fb89f07b8636dacd7fd2f7a062871870' }, index.h("div", { key: 'c6a66d4df786e0670510a0104b7724e13f30ec61', class: "gcds-details" }, index.h("button", { key: '835be4466b36b70bb222799c5a9083124702be71', "aria-expanded": open.toString(), "aria-controls": "details__panel", onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => {
                const event = utils.emitEvent(e, this.gcdsClick);
                if (event) {
                    this.toggle();
                }
            }, class: "details__summary", id: "details__summary" }, detailsTitle), index.h("details", { key: 'ac3464270d4cd77d74cd9f816c8245df7242e8ca', open: open, id: "details__panel", class: "details__panel", "aria-labelledby": "details__summary", onToggle: ev => this.handleToggle(ev), ref: element => (this.detailsElement = element) }, index.h("summary", { key: 'e083e978875266315f6e495b9c49d0e0a2568bda' }, detailsTitle), index.h("slot", { key: '0d3bb51e8bf1dcf62026235acc4d69add5998ee0' })))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsErrorMessage = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '16d5186a26d2c58f5ad8c7a7e8daffeb101aa620', id: `error-message-${messageId}`, class: "gcds-error-message-wrapper" }, index.h("gcds-text", { key: '7ea4ca8c831ea7a505d566cebb9bddf803742258', class: "error-message", role: "alert", "margin-bottom": "75" }, index.h("gcds-icon", { key: '6c748ff14a06525536d11bd0213f9b645e75f6bc', name: "warning-triangle", "margin-right": "50" }), index.h("strong", { key: '9f8f058bc6c9379c29c41c011a4ce9d23a2d499e' }, index.h("slot", { key: '3ccc99fbadee6d0edeffabf6865e2c4914057511' })))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsErrorSummary = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'abcef9b3fa9efcf3e25d1ff1c0ef8c824b24a990' }, index.h("div", { key: '806ec0e7cc4747178c93d0b0e9b9e1a637a32022', role: "alert", tabindex: "-1", ref: element => (this.shadowElement = element), class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0
                ? 'gcds-show'
                : ''}` }, index.h("gcds-heading", { key: '660f2f1819260b8f6455523cc732dddc4afcf691', tag: "h2", "margin-top": "0", "margin-bottom": "225" }, heading !== null && heading !== void 0 ? heading : I18N$k[lang].heading), index.h("ol", { key: '5cf05e7dfd9d6ee6c2e0544c6be2f0eb7eca96ea', class: "summary__errorlist" }, (hasSubmitted || errorLinks) &&
...
const GcdsFooter = class {
    ...
    render() {
        ...
        let subLinkCount = 0;
        return (index.h(index.Host, { key: '321e99b2faa82fcf0a88f62dec9e5449ab2b67bb', role: "contentinfo", "aria-label": "Footer" }, index.h("gcds-sr-only", { key: 'ae00217f2f2d7e548d5d184573fb1a6264409f19', tag: "h2" }, I18N$i[lang].about), contextualLinksObject && contextualHeading && (index.h("div", { key: '630f772b1771f9a7051a0adc36e4143dec5149f6', class: "gcds-footer__contextual" }, index.h("div", { key: 'acaf3de4ec14f9cf5874b67c2f15fdc970fa6411', class: "contextual__container" }, index.h("nav", { key: 'cddae229d1beb9ade4aae46950e35a2ea2203ae8', "aria-labelledby": "contextual__heading" }, index.h("h3", { key: 'f73bd15b238d93e418c6a813a7048b34b0510d72', id: "contextual__heading", class: "contextual__heading" }, contextualHeading), index.h("ul", { key: '614c50407f7555ce4249b90832934cb0ce829889', class: "contextual__list" }, Object.keys(contextualLinksObject).map(key => {
            if (contextualLinkCount < 3) {
                contextualLinkCount++;
                return (index.h("li", null, index.h("gcds-link", { size: "small", href: contextualLinksObject[key] }, key)));
            }
        })))))), display === 'full' ? (index.h("div", { class: "gcds-footer__main" }, index.h("div", { class: "main__container" }, index.h("nav", { class: "main__govnav", "aria-labelledby": "govnav__heading" }, index.h("h3", { id: "govnav__heading" }, I18N$i[lang].gov.heading), index.h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (index.h("li", null, index.h("gcds-link", { size: "small", href: govNav[value].link }, govNav[value].text)))))), index.h("nav", { class: "main__themenav", "aria-labelledby": "themenav__heading" }, index.h("gcds-sr-only", { tag: "h4", id: "themenav__heading" }, I18N$i[lang].themes.heading), index.h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (index.h("li", null, index.h("gcds-link", { size: "small", href: themeNav[value].link }, themeNav[value].text))))))))) : null, index.h("div", { key: 'c753c6c0324fb8fd4ae8655388c8eeca73365cf2', class: "gcds-footer__sub" }, index.h("div", { key: 'a4b5d0dd745603deebbdbc3332d41e59368a26f3', class: "sub__container" }, index.h("nav", { key: 'c69dbfb52e56e601442edac9507fd95b667e7477', "aria-labelledby": "sub__heading" }, index.h("gcds-sr-only", { key: '8ccf5212c6088334b6481451461f81f7d4acdc7c', tag: "h3", id: "sub__heading" }, I18N$i[lang].site.heading), index.h("ul", { key: '0e007ae6b61536d63f31ddbd6da0216555b85004' }, subLinks
...
const GcdsHeader = class {
    ...
    get renderSkipToNav() {
        if (this.el.querySelector('[slot="skip-to-nav"]')) {
            ...
            return (index.h("nav", { class: "gcds-header__skip-to-nav", "aria-label": I18N$g[this.lang].skipLabel }, index.h("gcds-link", { href: this.skipToHref }, I18N$g[this.lang].skip)));
        }
        else {
            return;
        }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '27151b450288fb64b07ac770807bf982c77449c0', role: "banner" }, renderSkipToNav, hasBanner ? index.h("slot", { name: "banner" }) : null, index.h("div", { key: 'ea68f9c773d6c6e069b15be668a52bfed5c06b62', class: "gcds-header__brand" }, index.h("div", { key: 'a6c7c30fd1f230bd57be5bf0d332c0fcff4af565', class: `brand__container ${!hasSearch ? 'container--simple' : ''}` }, renderToggle, renderSignature, renderSearch)), index.h("slot", { key: '61f6e27f606dbb62d5e75ed92eb95abf2f036fea', name: "menu" }), hasBreadcrumb ? (index.h("div", { class: "gcds-header__container" }, index.h("slot", { name: "breadcrumb" }))) : null));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsHeading = class {
    ...
    render() {
        ...
        const Tag = tag;
        return (index.h(index.Host, { key: '4e0476bfcf5d77051f092e2094c24cae68b25abf' }, index.h(Tag, { key: '4fe4a926858163b617fdebd62ea7f97211755121', class: `
            gcds-heading
            ${characterLimit ? 'limit' : ''}
            ${marginTop ? `mt-${marginTop}` : ''}
            ${marginBottom ? `mb-${marginBottom}` : ''}
          ` }, index.h("slot", { key: 'ca17660b8b88a915b9f18bf3cbcde376e07a5d13' }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "tag": ["validateTag"],
...
const GcdsHint = class {
    ...
    render() {
        const { hintId } = this;
        return (index.h(index.Host, { key: '46515bc832daceccea2be387fa1bf1a9fe32991f', id: `hint-${hintId}` }, index.h("gcds-text", { key: 'c75ff787e0ffcf19921e48ffea09366fa53daa05', class: "gcds-hint", "margin-bottom": "0", part: "hint" }, index.h("slot", { key: '0661d2891436fd5e255bea2afe9114e779b42a47' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsIcon = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f81bf5b49ba6a5b3b2f7d0ac36c947065051fd11' }, index.h("span", { key: 'd25f57eea33938f5b8be0deb5844d6cb880cca10', class: `
...
const GcdsInput = class {
    ...
    formatHTMLErrorMessage() {
        switch (this.htmlValidationErrors[0]) {
            case 'valueMissing':
                return I18N$e[this.lang][this.htmlValidationErrors[0]];
            case 'typeMismatch':
                if (this.type === 'url' || this.type === 'email') {
                    return I18N$e[this.lang][this.htmlValidationErrors[0]][this.type];
                }
                else {
                    return I18N$e[this.lang][this.htmlValidationErrors[0]];
                }
            ...
            case 'tooShort':
                return I18N$e[this.lang][this.htmlValidationErrors[0]]
                    ...
                    .replace('{current}', this.value.length);
            case 'rangeUnderflow':
                return I18N$e[this.lang][this.htmlValidationErrors[0]].replace('{min}', this.min);
            case 'rangeOverflow':
                return I18N$e[this.lang][this.htmlValidationErrors[0]].replace('{max}', this.max);
            case 'stepMismatch':
                return I18N$e[this.lang][this.htmlValidationErrors[0]]
...
const GcdsLabel = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b9a825fe7b1bc1531f33cb2b2fa0ba4cb22fd40d', id: `label-for-${labelFor}` }, index.h("label", { key: '987c3347f09e6d3a9e56b95ae7fc22e091e6b237', htmlFor: labelFor, class: `gcds-label ${hideLabel ? 'label--hidden' : ''}` }, index.h("span", { key: 'c1f227df2be6ee2f53a290d89eb14a0bfd80e45f' }, label), required ? (index.h("span", { "aria-hidden": "true", class: "label--required" }, "(", I18N$d[lang].required, ")")) : null)));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsLangToggle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '90f8fa237ca8093b35ae49b783e23d48cc75d30d' }, index.h("div", { key: 'cf38cfd545beb3bb1291336348930ff27dfcbeab', class: "gcds-lang-toggle" }, index.h("gcds-sr-only", { key: '82943994e5442fd5ad133c5f2d2cfdfa3f93817e', id: "lang-toggle__heading", tag: "h2" }, I18N$c[lang].heading), index.h("gcds-link", { key: '9f4a16f9f8bfe97a11790f5ad3665cfaff77837f', size: "regular", href: href, lang: I18N$c[lang].abbreviation }, index.h("span", { key: 'de2f6c64c38024281c1e9b6778daabe77bbfbb33' }, I18N$c[lang].language), index.h("abbr", { key: '0af8c87a23d7ff5b0c8031edff0a0f83b4cc8f67', title: I18N$c[lang].language }, I18N$c[lang].abbreviation)))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsNavGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '952c4f16984d92ec816f75e17e8610238a40a83b', role: "listitem", open: open }, index.h("button", { key: '68293dfb96996dc2305744e16d1b3c9e448dfb95', "aria-haspopup": "true", tabIndex: 0, "aria-expanded": open.toString(), ref: element => (this.triggerElement = element), class: `gcds-nav-group__trigger gcds-trigger--${this.navStyle}`, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => {
                const event = utils.emitEvent(e, this.gcdsClick);
                if (event) {
                    this.toggleNav();
                }
            } }, index.h("gcds-icon", { key: '2cb55aeb934079a7e74d536c01bf5b0c218887ec', name: open ? 'chevron-up' : 'chevron-down' }), closeTrigger && open ? closeTrigger : openTrigger), index.h("ul", { key: '7b1b84bd13d62ef1f7f7f4393f821b4ab9d06827', "aria-label": menuLabel, class: `gcds-nav-group__list gcds-nav--${this.navStyle}` }, index.h("slot", { key: 'ce79cefeab19e5dfc98042125b14c146eb956021' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsNavLink = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5a76c200c2d515b82addfbcee6fd932491889505', role: "listitem" }, index.h("a", Object.assign({ key: 'e07cc786a25123e192d0bec025c0ab7a77078d8b', class: `gcds-nav-link gcds-nav-link--${this.navStyle}`, href: href }, linkAttrs, { tabIndex: 0, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => utils.emitEvent(e, this.gcdsClick, href), ref: element => (this.linkElement = element) }), index.h("slot", { key: '32e5be57f63a00cb58b79ed2ac9650327e1c9c17' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsNotice = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd05e01b3d51707d840c395fe2197831394438ed9' }, this.validateRequiredProps() && (index.h("section", { key: 'e6d7fdc879b8592431b100b59b77bb511d32e95e', class: `gcds-notice notice--type-${type}` }, index.h("gcds-icon", { key: '85ad98787913a52dc462367ae453b95743623066', class: "notice__icon", size: "h4", name: iconTypes[type] }), index.h("div", { key: 'a44107281bb95d4a6943dbeb6b38a6603a427a0b' }, index.h("gcds-heading", { key: 'ec0805c7006d48dcefaf4b91dcf6d5bed1a7ea68', tag: noticeTitleTag, "margin-top": "0", "margin-bottom": "100", class: "notice__heading" }, index.h("gcds-sr-only", { key: '35352ad8a3a0ce3f9ace2314c269fc71f6657ffa', tag: "span" }, I18N$a[this.lang][type]), noticeTitle), index.h("slot", { key: '8c59481347d56e817be55b566a0c8a1121753c41' }))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsPhaseBanner = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3ef9d402ed5d00edcca05e2a45ed8e0e14675dd1' }, index.h("div", { key: '1173d307a0e98624faba72445afad7534d115ffa', class: `gcds-phase-banner banner--role-${bannerRole} ${isFixed ? 'banner--is-fixed' : ''}`, role: "status", "aria-label": I18N$8[lang].label }, index.h("gcds-container", { key: 'b538a1a6155d73d5353389a393cf0fc00dd86201', size: container, centered: true }, index.h("div", { key: 'eb803333e6e5ef41b52510fc23ad3ac831bb45a5', class: "banner__content" }, index.h("figure", { key: '1831215c9c766c79abebfeee59a96f4bff0058b2', class: "banner__icon icon--left" }, index.h("slot", { key: '617504c5372c05f86e8300b1ad4ec65088f28fa4', name: "banner-icon-left" })), index.h("div", { key: '79212595540aaf4ecec3daa82ec9a76279b614c1', class: "banner__details" }, index.h("slot", { key: '6ecf5dd32ae92e2a5f829790300d56b23208cda0', name: "banner-text" }), index.h("slot", { key: '97750bdbf20710cd924d51325d8d322833194bbc', name: "banner-cta" })), index.h("figure", { key: '4f041c68abc255bd0633a0c28f63bb38b30ea2a6', class: "banner__icon icon--right" }, index.h("slot", { key: '199acb4e29bc22e2b32b4e8d3e6f3caf6e4c21f6', name: "banner-icon-right" })))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsRadios = class {
    ...
    render() {
        ...
        if (this.validateRequiredProps()) {
            return (index.h(index.Host, { key: 'ec77376f853d89aafeee2f52c45514eb0b5abb1b', onBlur: () => this.onBlurValidate() }, index.h("fieldset", Object.assign({ key: '631e4d0139c528aa431eec9b57059c21a65c88bf', class: "gcds-radios__fieldset" }, fieldsetAttrs), index.h("legend", { key: '5177e3e3373edf06883dbfc0a6b2dfaa0712ad0a', id: "radios-legend", class: "gcds-radios__legend" }, legend, required ? (index.h("span", { class: "legend__required" }, I18N$7[lang].required)) : null), hint ? (index.h("gcds-hint", { id: "radios-hint", "hint-id": "radios" }, hint)) : null, errorMessage ? (index.h("div", null, index.h("gcds-error-message", { id: "radios-error", messageId: "radios" }, errorMessage))) : null, this.optionsArr &&
                this.optionsArr.map(radio => {
...
const GcdsSearch = class {
    ...
    render() {
        ...
        const formAction = action === '/sr/srb.html'
            ...
            : action;
        return (index.h(index.Host, { key: '6003a4328016e3ab9eddaeaa7eee74ddc7883781' }, index.h("section", { key: '5e722fa35d2b75334bb8f94e1cec56ff08f7f924', class: "gcds-search" }, index.h("gcds-sr-only", { key: '4faad88756c1deefa1805192dafc2372ba11e9c8', tag: "h2" }, I18N$6[lang].search), index.h("form", { key: '9e9cff3feda729f515513745b8e6200d0295f14d', action: formAction, method: method, role: "search", onSubmit: e => utils.emitEvent(e, this.gcdsSubmit, this.value), class: "gcds-search__form" }, index.h("gcds-label", { key: '92789bd493f9d1cdddf87b234a29159df035c67f', label: labelText, "label-for": searchId, "hide-label": true }), index.h("input", Object.assign({ key: 'dba6da70f0898867e73506f399d4f5e6e1359c8c', type: "search", id: searchId }, (suggested ? { list: 'search-list' } : {}), { size: 34, maxLength: 170, onInput: e => this.handleInput(e, this.gcdsInput), onChange: e => this.handleInput(e, this.gcdsChange), onFocus: () => this.gcdsFocus.emit(), onBlur: () => this.gcdsBlur.emit() }, attrsInput, { class: "gcds-search__input", value: value })), suggested && (index.h("datalist", { key: 'fe818f0ecbc29e356fcd022261df068e071ca90b', id: "search-list" }, suggested.map((k, v) => (index.h("option", { value: k, key: v }))))), index.h("gcds-button", { key: '0533f32d7cefa496a764e7c515d8feb41cf406ff', type: "submit", class: "gcds-search__button", exportparts: "button" }, index.h("gcds-icon", { key: '9abebcaa3eca5f4ea50b6a13a6745e0e25c6f619', name: "search", label: I18N$6[lang].search, size: "h3" }))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsSideNav = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7f08728b24595dc62fbbd520b70c424e5a810598' }, index.h("nav", { key: 'f0fe974afa35e59c5b84ba762cd29f8dea289fde', "aria-label": `${label}${I18N$5[lang].navLabel}`, class: "gcds-side-nav" }, index.h("h2", { key: '213dadb607c6678294a1d793dd7466016b2492be', class: "gcds-side-nav__heading" }, label), index.h("ul", { key: '7d4ac87ff26816e1443aaa5348bf2998b56ad208' }, index.h("gcds-nav-group", { key: '12897708312d4db5140413a3478bad4fe950232c', menuLabel: I18N$5[lang].menuLabel, closeTrigger: I18N$5[lang].closeTrigger, openTrigger: I18N$5[lang].menuLabel, class: "gcds-mobile-nav", ref: element => (this.mobile = element), lang: lang }, index.h("slot", { key: '2285099fe2b2e4d1faa617492f145c3378738118' }))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsSignature = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '552169b3620094d1ad20ba907f6275c377786dfc' }, type === 'signature' ? (index.h(Tag, Object.assign({}, sigAttrs), index.h("div", { innerHTML: selectSVG }))) : (index.h("div", { class: "gcds-signature", innerHTML: selectSVG }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "type": ["validateType"],
...
const GcdsSrOnly = class {
    ...
    render() {
        const Tag = this.tag;
        return (index.h(index.Host, { key: 'f81d19a3fe0a38bc554949c1112fd7cf9f5f4efc' }, index.h(Tag, { key: '7c6167569363292c04e4269f5f30456fbf2a9838' }, index.h("slot", { key: 'acc0f901a6085a0d29269f083059d6df791f6f45' }))));
    }
    static get watchers() { return {
        "tag": ["validateTag"]
    }; }
...
const GcdsStepper = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4fb90ac7b5e8ca0586cb013d3d7e9cc4519eadea' }, this.validateRequiredProps() && (index.h("gcds-heading", { key: '85d2541fad2e064f0c4e1ab842d820614ba91498', tag: tag, class: "gcds-stepper", "margin-top": "0", "margin-bottom": "225" }, index.h("span", { key: '1a08b2e37ab6f9fd1f18a944defdf3a6fca64f74', class: "gcds-stepper__steps" }, `${I18N$3[lang].step} ${currentStep} ${I18N$3[lang].of} ${totalSteps}`, index.h("gcds-sr-only", { key: '54a67d11327d261859ba20d4516583e4f69cf201' }, " : ")), index.h("slot", { key: '919da35776fd294f87c9027709a1decaafadcd2f' })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const GcdsText = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '748369613e967a25a6b2b20e6123b2b67e0143da', class: `${display != 'block' ? `d-${display}` : ''}` }, index.h("p", { key: 'b611810500ccf49c736d689d1e94a4f4d048fa03', class: `
            gcds-text
...
const GcdsTopNav = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '861722cb282f9ad4ba594e2b7a019bbd56cfa6e0' }, index.h("div", { key: '75ea313bb2604d105451dd766796ae0fea818f70', class: "gcds-top-nav" }, index.h("nav", { key: 'c9ceaec863f1d122c3b1a84dc560700054b873f0', "aria-label": `${label}${I18N$1[lang].navLabel}` }, index.h("ul", { key: 'b3ba6c96c25047116bb5e7a7e43aeeb3d88cc216', class: "gcds-top-nav__container" }, index.h("gcds-nav-group", { key: 'c15b494a7af7a63264a7fc45c1af54afcee534a7', menuLabel: I18N$1[lang].menuLabel, closeTrigger: I18N$1[lang].closeTrigger, openTrigger: I18N$1[lang].menuLabel, class: "gcds-mobile-nav gcds-mobile-nav-topnav", ref: element => (this.mobile = element), lang: lang }, index.h("slot", { key: '053d51a0b46c1ea922422904a87a0ba510ed8e0a', name: "home" }), index.h("li", { key: '53bd1516660b1bd6b0fd5e301c8c42872a3bc1b9', class: `nav-container__list nav-list--${alignment}` }, index.h("ul", { key: 'b67c77da3b122d690ec479839036c155f0050451', class: `nav-container__list nav-list--${alignment}` }, index.h("slot", { key: '34f0a620558fdb227f41be0c5cb1142c180b2a81' })))))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsVerifyBanner = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a1fa4411e430e6270a71312a39c7da3a1796d4aa' }, index.h("details", { key: '9f97424d74107c83c28ee4d98cc53ff4e26ec825', class: `gcds-verify-banner ${isFixed ? 'verify-banner--is-fixed' : ''}` }, index.h("summary", { key: 'f118fbf0db3564f65e95a1769749793b7bd87b1c', class: container ? `container-${container}` : '', "aria-expanded": "false", role: "button" }, index.h("span", { key: '6bbcd4a7db902d2c35555b3cf1547c8226a49f6c', class: "svg-container", innerHTML: CanadaFlag }), index.h("p", { key: 'b2fda9a60af81005e8107802a50dec1544bb2bc1' }, index.h("small", { key: '668150e500c11383741a7781a659629c2356726b' }, I18N[lang].summary.text), index.h("button", { key: 'c8ab76181aae1bd0066eac3d3a8294d91c14f4ea', class: "verify-banner__toggle" }, index.h("small", { key: 'e54914223c79d92900fca9362b37c578e4a19167' }, I18N[lang].summary.link), index.h("span", { key: '1b9e90e0594e202b2fd5aa0155c331a4232e309b', class: "svg-container", innerHTML: ContentToggleArrow })))), index.h("div", { key: '9268da2d8b1059a2c5cfbbb3b827850a6b250407', class: `verify-banner__content ${container ? `container-${container}` : ''}` }, index.h("p", { key: 'c1d4d84a58fe5c97decd2ea1f108297dcef1b37a' }, index.h("small", { key: '9bb09c3f25ad8f5047c7061a73460b12d5085e24' }, I18N[lang].content.description)), index.h("br", { key: '6acd0a0c911cf4c456562734b6d06de389b3d62e' }), index.h("gcds-grid", { key: '539b2271bfdb85e66ad3477103deaba798fe850b', tag: "ul", container: "lg", columns: "1fr", "columns-tablet": container === 'xs' || container === 'sm' ? '1fr' : '1fr 1fr' }, index.h("li", { key: 'dde8404c54ed2798afd7b6225d94f5e079063043' }, index.h("h4", { key: '91f46d91fb3f0e4ecf81b3c7267fb994e2a33551' }, I18N[lang].content.url.heading), index.h("p", { key: 'ab8a2320d0edfa8c0e086bf10d224838b5bf2624' }, index.h("small", { key: '05b61b363777a9d96a562a76e39b886e85b5f80e' }, I18N[lang].content.url.text))), index.h("li", { key: 'd580a759c50805c449fedaf81b0281bc5a989b25' }, index.h("h4", { key: '32c261e0c5e42645f3fd896c1ee7f9d411518362' }, I18N[lang].content.languages.heading), index.h("p", { key: '7a7f21f9e0671bbd143105a0574188644dbf2274' }, index.h("small", { key: '7cdf32c6502cfe83a0e918002349eb0cc1b79a38' }, I18N[lang].content.languages.text))), index.h("li", { key: '160e19553b5cdacc8773c61a9c57a8cc00cf7fbd' }, index.h("h4", { key: '0721bd211cbe6709caff113eff7a3c28dd0202bb' }, I18N[lang].content.https.heading), index.h("p", { key: '8ebc8920a3d01ee425d07c28754849ce178303c2' }, index.h("small", { key: '9d300b938d0ae4b3be25aafcc40d8e1938ce9797' }, I18N[lang].content.https.text, " ", index.h("strong", { key: 'a8ecbbe76c5283347e2cc786c096e2e8d29a0f33' }, "https://"), "."))), index.h("li", { key: '1e2ca8ec9302fe090d09e9783886078a1b5a8720' }, index.h("h4", { key: '9ceeeac4ef3a6a44fd41a54202e4148cb07a567c' }, I18N[lang].content.contact.heading), index.h("p", { key: '4ecf998fdac036b9b7e4383b840ec643bfc6c393' }, index.h("small", { key: '27255f82990a0cabfe15358448fa9690572473b8' }, I18N[lang].content.contact.text))))))));
    }
    get el() { return index.getElement(this); }
};
