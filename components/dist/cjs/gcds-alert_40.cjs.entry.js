...
const gcdsAlertCss = () => `@layer reset, default, fixed, role, wide, compact, hover, focus;@layer reset{:host{display:block}:host .gcds-alert{box-sizing:border-box;text-align:left}:host .gcds-alert .alert__close-btn{box-sizing:border-box;cursor:pointer;padding:0}:host .gcds-alert slot{display:initial}}@layer default{:host .gcds-alert{border-radius:var(--gcds-alert-border-radius);color:var(--gcds-alert-text);container:component alert/inline-size;font:var(--gcds-alert-font-desktop);padding:var(--gcds-alert-padding-desktop)}@media only screen and (width < 48em){:host .gcds-alert{font:var(--gcds-alert-font-mobile);padding:var(--gcds-alert-padding-mobile)}}:host .gcds-alert gcds-icon{margin:var(--gcds-alert-icon-margin-desktop)}@media only screen and (width < 48em){:host .gcds-alert gcds-icon{margin:var(--gcds-alert-icon-margin-mobile)}}:host .gcds-alert .alert__content{margin:var(--gcds-alert-content-margin-desktop)}@media only screen and (width < 48em){:host .gcds-alert .alert__content{margin:var(--gcds-alert-content-margin-mobile)}}:host .gcds-alert .alert__content .alert__heading{font:var(--gcds-alert-content-heading-font-desktop);margin:var(--gcds-alert-content-heading-margin-desktop)}@media only screen and (width < 48em){:host .gcds-alert .alert__content .alert__heading{font:var(--gcds-alert-content-heading-font-mobile);margin:var(--gcds-alert-content-heading-margin-mobile)}}:host .gcds-alert .alert__content ::slotted(*){margin-block-start:0}:host .gcds-alert .alert__content ::slotted(:last-child){margin-block-end:0!important}:host .gcds-alert .alert__content ::slotted(:not(:last-child)){margin-block-end:var(--gcds-alert-content-slotted-margin)}:host .gcds-alert .alert__content ::slotted(ol),:host .gcds-alert .alert__content ::slotted(ul){margin-inline-start:var(--gcds-alert-content-slotted-list-margin);padding:0}:host .gcds-alert gcds-button::part(button){width:var(--gcds-button-width)}}@layer fixed{:host .gcds-alert.alert--is-fixed{border:0;position:sticky;top:0;width:100%;z-index:9999}}@layer role{:host .gcds-alert.alert--role-danger{background-color:var(--gcds-alert-danger-background);color:var(--gcds-alert-danger-text)}:host .gcds-alert.alert--role-danger .alert__icon{color:var(--gcds-alert-danger-icon)}:host .gcds-alert.alert--role-info{background-color:var(--gcds-alert-info-background);color:var(--gcds-alert-info-text)}:host .gcds-alert.alert--role-info .alert__icon{color:var(--gcds-alert-info-icon)}:host .gcds-alert.alert--role-success{background-color:var(--gcds-alert-success-background);color:var(--gcds-alert-success-text)}:host .gcds-alert.alert--role-success .alert__icon{color:var(--gcds-alert-success-icon)}:host .gcds-alert.alert--role-warning{background-color:var(--gcds-alert-warning-background);color:var(--gcds-alert-warning-text)}:host .gcds-alert.alert--role-warning .alert__icon{color:var(--gcds-alert-warning-icon)}}`;
...
const GcdsAlert = class {
     ...
     */
    getLiveRegion() {
        let liveRegion = document.querySelector('.gcds-alert-announcement');
        if (!liveRegion) {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '28c68640cfa9a7c35800d3f755b1202afc3d78b0' }, isOpen ? (index.h("div", { class: `gcds-alert alert--role-${alertRole} ${isFixed ? 'alert--is-fixed' : ''}`, role: alertRole === 'info' || alertRole === 'success'
                ? 'status'
                : 'alert', "aria-atomic": "true", "aria-label": alertRole === 'danger'
                ...
                : alertRole === 'info'
                    ...
                    : alertRole === 'success'
                        ...
                        : alertRole === 'warning'
                            ...
                            : null }, index.h("gcds-container", { size: isFixed ? container : 'full', alignment: "center" }, index.h("div", { class: "alert__container" }, !hideRoleIcon && (index.h("gcds-icon", { "aria-hidden": "true", class: "alert__icon", size: "h6", name: (alertRole === 'danger'
                ? 'exclamation-circle'
                : alertRole === 'info'
                    ? 'info-circle'
                    : alertRole === 'success'
                        ...
                        : alertRole === 'warning'
                            ? 'warning-triangle'
                            : undefined) })), index.h("div", { class: "alert__content" }, index.h("p", { class: "alert__heading" }, index.h("strong", null, heading)), index.h("slot", null)), !hideCloseBtn && (index.h("gcds-button", { "button-role": "secondary", size: "small", onClick: e => {
                const event = utils.emitEvent(e, this.gcdsDismiss);
                if (event) {
                    this.isOpen = false;
                }
            } }, I18N$q[lang].closeBtn)))))) : null));
    }
...
const GcdsCard = class {
    ...
    get renderDescription() {
        if (this.hasSlottedDescription) {
            ...
            return (index.h("div", { class: "gcds-card__description" }, index.h("gcds-text", { "margin-bottom": "0" }, index.h("slot", null, this.description))));
        }
        else {
            return null;
        }
    ...
    render() {
        ...
        if (this.validateRequiredProps()) {
            return (index.h(index.Host, { key: 'f3c393ab31a6e837066e86752a550b421d1a832f' }, index.h("div", { key: 'af6b6bcf27020ca76234d0952ab590c3cb757aa6', class: "gcds-card" }, badge && !errors.includes('badge') && (index.h("gcds-text", { key: '0579c1b43388a52db59023fe0185283917d4a42e', id: "gcds-badge", class: "gcds-badge", "text-role": "light", "margin-bottom": "0", size: "small" }, index.h("strong", { key: '50e83131805a091372d307eb09025978c4d18ac8' }, index.h("gcds-sr-only", { key: 'f768a327fece65782141499d981ec587710a3346', tag: "span" }, I18N$n[lang].tagged), badge))), imgSrc && (index.h("img", { key: '03937e6671769a5a25cb7181dd2acbafa6d1e2ff', src: imgSrc, alt: imgAlt ? imgAlt : '', class: "gcds-card__image" })), Element ? (index.h(Element, Object.assign({ class: "gcds-card__title" }, taggedAttr), index.h("gcds-link", { href: href }, index.h("slot", { name: "title" }, cardTitle)))) : (index.h("gcds-link", Object.assign({ href: href, class: "gcds-card__title", rel: rel, target: target }, taggedAttr), index.h("slot", { name: "title" }, cardTitle))), renderDescription)));
        }
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const GcdsFileUploader = class {
    constructor(hostRef) {
        ...
        this.removeFile = e => {
            ...
            this.uploadedFiles = [];
            this.value = [...filesContainer];
            this.removedFileMessage = `${I18N$i[this.lang].fileRemoved} ${fileName}`;
    ...
    render() {
        const { accept, disabled, errorMessage, hasError, hint, label, hideLabel, lang, multiple, name, required, uploaderId, value, inputTitle, autofocus, form, inheritedAttributes, removedFileMessage, } = this;
        ...
        return (index.h(index.Host, { key: 'cbfcb18f04afd2723b3e06b9f4d2a892a2e5b511' }, index.h("div", { key: 'b181c9753ac2e088d034aa6e0bc6f16bcd47ab6a', class: `gcds-file-uploader-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, index.h("gcds-label", Object.assign({ key: '8bc181208c5ec0b5b3ac365f4c1642509d46f382' }, attrsLabel, { "hide-label": hideLabel, "label-for": uploaderId, lang: lang })), hint ? index.h("gcds-hint", { "hint-id": uploaderId }, hint) : null, errorMessage ? (index.h("gcds-error-message", { messageId: uploaderId }, errorMessage)) : null, index.h("div", { key: 'c25ac05901231e8d186457289c449b6ac17a3a24', class: `file-uploader__input ${value.length > 0 ? 'uploaded-files' : ''}`, onDrop: e => this.handleDrop(e), onDragOver: e => e.preventDefault() }, index.h("button", { key: '7a72325415f11928d9a71d206c997c4259751896', type: "button", tabindex: "-1", onClick: () => this.shadowElement.click() }, I18N$i[lang].button.upload), index.h("input", Object.assign({ key: '5a566254bde25d9276fa04063ee0ebf5e80f1d2e', type: "file", id: uploaderId }, attrsInput, { onBlur: () => this.onBlur(), onFocus: () => this.gcdsFocus.emit(), onInput: e => this.handleInput(e, this.gcdsInput), onChange: e => this.handleInput(e, this.gcdsChange), "aria-invalid": hasError ? 'true' : 'false', ref: element => (this.shadowElement = element) })), value.length > 0 ? (index.h("gcds-sr-only", { id: "file-uploader__summary" }, index.h("span", null, I18N$i[lang].summary.selected, " "), value.map(file => (index.h("span", null, file, " "))))) : (index.h("gcds-sr-only", { id: "file-uploader__summary" }, I18N$i[lang].summary.unselected)), index.h("gcds-sr-only", { key: '7361b43685e1b9012bb14ba33fa51fa24b638d6e', role: "status", "aria-live": "polite" }, removedFileMessage)), value.length > 0
            ? value.map(file => (index.h("div", { class: "file-uploader__uploaded-file", "aria-label": `${I18N$i[lang].removeFile} ${file}.` }, index.h("gcds-text", { "margin-bottom": "0" }, file), index.h("button", { onClick: e => this.removeFile(e), ref: element => {
                    if (element && !this.uploadedFiles.includes(element)) {
                        this.uploadedFiles = [...this.uploadedFiles, element];
                    }
                } }, index.h("span", null, I18N$i[lang].button.remove), index.h("gcds-icon", { name: "close", size: "text", "margin-left": "150" })))))
            : null)));
    }
    static get delegatesFocus() { return true; }
    static get formAssociated() { return true; }
...
const GcdsFooter = class {
    ...
    render() {
        ...
        let subLinkCount = 0;
        return (index.h(index.Host, { key: 'b131f28d3831950f2bc599433105f3302d80a2a5', role: "contentinfo", "aria-label": "Footer" }, index.h("gcds-sr-only", { key: '9c2f6e61a77d296cbaf8dd8a544c5c87f595f132', tag: "h2" }, I18N$h[lang].about), contextualLinksObject && contextualHeading && (index.h("div", { key: '584fa9606735292f383c0635adae0eced4b0aebc', class: "gcds-footer__contextual" }, index.h("div", { key: 'd3842bcd6bfbdd6d33bfaa08740b83539b78e7f4', class: "contextual__container" }, index.h("nav", { key: 'd52ab70ee2bf93cb066e017cc40c03c54b62f5b5', "aria-labelledby": "contextual__heading" }, index.h("h3", { key: '8872fa024aed2955472e180265d8e22e424a047b', id: "contextual__heading", class: "contextual__heading" }, contextualHeading), index.h("ul", { key: '7a63fd2f7b96b6e8bef05e2a6cc7c3c24cdf92c2', class: "contextual__list" }, Object.keys(contextualLinksObject).map(key => {
            if (contextualLinkCount < 3) {
                contextualLinkCount++;
                return (index.h("li", null, index.h("gcds-link", { size: "small", href: contextualLinksObject[key] }, key)));
            }
        })))))), display === 'full' ? (index.h("div", { class: "gcds-footer__main" }, index.h("div", { class: "main__container" }, index.h("nav", { class: "main__govnav", "aria-labelledby": "govnav__heading" }, index.h("h3", { id: "govnav__heading" }, I18N$h[lang].gov.heading), index.h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (index.h("li", null, index.h("gcds-link", { size: "small", href: govNav[value].link }, govNav[value].text)))))), index.h("nav", { class: "main__themenav", "aria-labelledby": "themenav__heading" }, index.h("gcds-sr-only", { tag: "h4", id: "themenav__heading" }, I18N$h[lang].themes.heading), index.h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (index.h("li", null, index.h("gcds-link", { size: "small", href: themeNav[value].link }, themeNav[value].text))))))))) : null, index.h("div", { key: 'de5feadad5a38d3a61fd77105c82dfbfcf8dd652', class: "gcds-footer__sub" }, index.h("div", { key: '9141390e53f03f5fa588a196fccc20d6a2d00d15', class: "sub__container" }, index.h("nav", { key: 'fdedf47273cd546dc4c62494a241e51c69103b6b', "aria-labelledby": "sub__heading" }, index.h("gcds-sr-only", { key: '3fbe94458ff550137e5c8a3c301c66e40d01c30a', tag: "h3", id: "sub__heading" }, I18N$h[lang].site.heading), index.h("ul", { key: 'fa18c415569448b28498715f94ce16b8310ffa4a' }, subLinks
...
const GcdsHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'dda03cca98057c4b68e1c14787c1e9a50a2c7383', role: "banner" }, renderSkipToNav, hasBanner ? index.h("slot", { name: "banner" }) : null, index.h("div", { key: '44346897dc183526bcb5c0142d8369b640918794', class: "gcds-header__brand" }, index.h("div", { key: '279e022059667ba6f776f9adf3aec3469383bbbd', class: `brand__container ${!hasSearch ? 'container--simple' : ''}` }, renderToggle, renderSignature, renderSearch)), hasThemeTopicMenu ? (index.h("div", { class: "gcds-header__container--menu" }, index.h("slot", { name: "menu" }), hasAccount ? index.h("slot", { name: "account" }) : null)) : index.h("slot", { name: "menu" }), hasBreadcrumb || (!hasBreadcrumb && !hasThemeTopicMenu && hasAccount) ? (index.h("div", { class: "gcds-header__container--breadcrumbs" }, this.navSize === 'mobile' ? (index.h(index.Fragment, null, hasAccount && !hasThemeTopicMenu ? index.h("slot", { name: "account" }) : null, hasBreadcrumb ? index.h("slot", { name: "breadcrumb" }) : null)) : (index.h(index.Fragment, null, hasBreadcrumb ? index.h("slot", { name: "breadcrumb" }) : null, hasAccount && !hasThemeTopicMenu ? index.h("slot", { name: "account" }) : null)))) : null));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsHeading = class {
    ...
    render() {
        ...
        const Tag = tag;
        return (index.h(index.Host, { key: 'c4cb5e3a667ea1b7f0297966e472b6e19ac65357' }, index.h(Tag, { key: 'afe7e86f7896f7b9761fa47279726373cf98a109', class: `
            gcds-heading
            ${headingRole ? `role-${headingRole}` : ''}
            ${characterLimit ? 'limit' : ''}
            ${marginTop ? `mt-${marginTop}` : ''}
            ${marginBottom ? `mb-${marginBottom}` : ''}
          ` }, index.h("slot", { key: '6df48e86fb118f48e2c92324fc238aefc078f2ec' }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "tag": [{
...
const GcdsHint = class {
    ...
    render() {
        const { hintId } = this;
        return (index.h(index.Host, { key: '25a3d5821435af859e29c04642bfce0909de92ff', id: `hint-${hintId}` }, index.h("gcds-text", { key: 'a285c7fbad21a028d9ad043d3f30189b57da7595', class: "gcds-hint", "margin-bottom": "0", part: "hint" }, index.h("slot", { key: '99d6f85ae16ce1522a41bf1ca671e454384200ec' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsLangToggle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '62aa9c22bff1a0f8778c5835f7e63646cbfe1a46' }, index.h("div", { key: '88d41598195886ac785f5892a98b21b4ec6305a1', class: "gcds-lang-toggle" }, index.h("gcds-sr-only", { key: '6237c11ac97300f34d12b1514353715ff08cc3c7', id: "lang-toggle__heading", tag: "h2" }, I18N$c[lang].heading), index.h("gcds-link", { key: 'd71e4738bf386fce9bd917c7ebad9996e668c109', size: "regular", href: href, lang: I18N$c[lang].abbreviation }, index.h("span", { key: 'ad354cf5d68967abc49af62bd13dcb403f1247b0' }, I18N$c[lang].language), index.h("abbr", { key: '5d4d1a9b12e51c2fdb1740aea1d0a237b926ba85', title: I18N$c[lang].language }, I18N$c[lang].abbreviation)))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsNavGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8efaebea0ab6428172adfc217a9776627c387c66', role: "listitem", open: open }, index.h("div", { key: 'eceeb19cdbd3a2a8dd911e4c41291e638f31f557', class: "gcds-nav-group__container" }, index.h("button", { key: 'b2a1b3752a706917730b1710ba98ee311bc985f1', "aria-haspopup": "true", tabIndex: 0, "aria-expanded": open.toString(), ref: element => (this.triggerElement = element), class: `gcds-nav-group__trigger gcds-trigger--${this.navStyle}`, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => {
                const event = utils.emitEvent(e, this.gcdsClick);
                if (event) {
                    this.toggleNav();
                }
            } }, index.h("gcds-icon", { key: '0e2ec9a5e0abcfe0867a17fb80cd664388836156', name: (this.navStyle === 'expandable'
                ? open
                    ? 'chevron-down'
                    : 'chevron-right'
                : open
                    ? 'chevron-up'
                    : 'chevron-down') }), closeTrigger && open ? closeTrigger : openTrigger), index.h("ul", { key: '98536eaa85d01be41c0de3648ef8a30564087265', "aria-label": menuLabel, class: `gcds-nav-group__list gcds-nav--${this.navStyle}` }, index.h("slot", { key: 'c8c093f448d0451e032cb3d7dafbcd0b35435baf' })))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsNotice = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '03e09c9feca750421af5461d3530a3b459f8c0a1' }, this.validateRequiredProps() && (index.h("section", { key: 'a662553fe15c9b04690a5fa3b5904d7c8f04ebcf', class: `gcds-notice notice--role-${noticeRole}` }, index.h("gcds-icon", { key: '710bf5e2c0eddf52f765d1247b79147139a57f44', class: "notice__icon", size: "h4", name: iconRoles[noticeRole] }), index.h("div", { key: '148dc06af3014b33b0180865839cf920b18aabdd' }, index.h("gcds-heading", { key: '7f9c4947154fc5ecf7cf7023968da3d5e7c48c46', tag: noticeTitleTag, "margin-top": "0", "margin-bottom": "100", class: "notice__heading" }, index.h("gcds-sr-only", { key: 'f954a5fd1b3846dfe82e69be40eac77cc10a363a', tag: "span" }, I18N$a[this.lang][noticeRole]), noticeTitle), index.h("slot", { key: 'ac208cbe2c085f09358cd043b5a925b881d21300' }))))));
    }
    get el() { return index.getElement(this); }
};
...
const gcdsSignatureCss = () => `@layer reset, default, type.signature, type.wordmark, variant.colour, variant.white, desktop, highcontrast;@layer reset{:host{display:block;width:fit-content}}@layer default{:host .gcds-signature{display:flex}:host svg{display:block;max-width:100%}:host svg .fip_flag{fill:var(--gcds-signature-color-flag)}}@layer type.signature{:host(:not([type=wordmark])) svg{height:var(--gcds-signature-signature-height);width:var(--gcds-signature-signature-width)}}@layer type.wordmark{:host([type=wordmark]) svg{height:var(--gcds-signature-wordmark-height);width:var(--gcds-signature-wordmark-width)}}@layer variant.colour{:host(:not([variant=white])) svg .fip_text{fill:var(--gcds-signature-color-text)}}@layer variant.white{:host([variant=white]) svg :is(.fip_text){fill:var(--gcds-signature-white-default)}}@layer desktop{@media screen and (width >= 64em){:host(:not([type=wordmark])) svg{height:var(--gcds-signature-signature-height-desktop);width:var(--gcds-signature-signature-width-desktop)}}@media screen and (width >= 64em){:host([type=wordmark]) svg{height:var(--gcds-signature-wordmark-height-desktop);width:var(--gcds-signature-wordmark-width-desktop)}}}@layer highcontrast{@media (forced-colors:active){:host svg .fip_text{fill:CanvasText}}}`;
...
const I18N$3 = {
  en: {
    ...
    filterInputLabel: 'Filter by keyword',
  ...
  fr: {
    ...
    filter: 'Filtrer',
    filterInputLabel: 'Filtrer par mot-clé',
...
const renderFilterSortModal = element => {
    ...
    return (index.h("div", { class: "gcds-table__filters" }, index.h("gcds-button", { size: "small", "button-role": "primary", onClick: () => {
            justOpened = true;
            element.filterSortModal.showModal();
        } }, index.h("div", null, element.filter && element.sortEnabled() ? (index.h("gcds-icon", { name: "tune", size: "h5", "margin-right": "50" })) : element.filter ? (index.h("gcds-icon", { name: "filter", size: "h5", "margin-right": "50" })) : (index.h("gcds-icon", { name: "sort", size: "h5", "margin-right": "50" })), element.filter && element.sortEnabled()
        ...
        } }, I18N$3[lang].modalClose)), index.h("form", { class: "gcds-table__modal-body", onKeyUp: ev => {
            var _a, _b, _c, _d, _e;
            if (ev.key === 'Enter') {
                if (justOpened) {
                    justOpened = false;
...
const GcdsTopicMenu = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f57f3ad6fed21288c1dee157293a55838ed3f621' }, index.h("nav", { key: 'dca2b15071085e65059b7d885ca95187207c314a', class: "gcds-topic-menu", "aria-labelledby": "gcds-topic-menu__heading" }, index.h("gcds-sr-only", { key: 'aeec862fe3f79f7b6c6d6b6fc666081af9d13073', id: "gcds-topic-menu__heading", tag: "h2" }, I18N[lang].menuLabelFull), index.h("p", { key: '2e22bbe8d65a2ee5a4a61f31eaef95baea0ccee3', id: "gcds-topic-menu-desc", hidden: true }, I18N[lang].buttonLabel), index.h("button", { key: '293680fd663e42f65ae2844acebc1b68290b1c56', "aria-haspopup": "true", "aria-expanded": this.open.toString(), "aria-describedby": 'gcds-topic-menu-desc', onClick: async () => await this.toggleNav(), ref: element => (this.menuButton = element), class: home && 'gcds-topic-menu--home' }, this.lang == 'en' ? (index.h(index.Fragment, null, index.h("gcds-sr-only", { tag: "span" }, I18N[lang].menuLabelHidden), I18N[lang].menuToggle)) : (index.h(index.Fragment, null, I18N[lang].menuToggle, index.h("gcds-sr-only", { tag: "span" }, I18N[lang].menuLabelHidden))), index.h("gcds-icon", { key: '107b59d320ba4123c51474c45440a825bd433847', name: "chevron-down", "margin-left": "100", size: "text-small" })), index.h("ul", { key: '2fc64b82ca3ad4a57f10467d5532471d6000f858', role: "menu", "aria-orientation": "vertical", "data-top-menu": true, innerHTML: this.listItems, ref: element => (this.themeList = element) }))));
    }
    get el() { return index.getElement(this); }
};
