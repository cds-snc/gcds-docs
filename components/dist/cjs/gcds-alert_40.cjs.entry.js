...
const GcdsContainer = class {
    ...
    render() {
        ...
        const Tag = tag;
        return (index.h(index.Host, { key: '158cd288fe99ffdcc6d6d98ed0679521989516ab' }, index.h(Tag, { key: '64af2b520df43454dce4e7154533192484bcf502', class: `
            gcds-container
            ...
            ${padding ? `p-${padding}` : ''}
            ${size ? `size-${size}` : ''}
          ` }, index.h("slot", { key: 'd396a7a600b82d553fd23674400677cbdd2e9a06' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsDateInput = class {
    ...
    render() {
        ...
        const month = (index.h("gcds-select", Object.assign({ key: 'abc4d3370422e57659e6a6558d7fb7bf067e6b9b', label: I18N$l[lang].month, selectId: "month", name: "month", defaultValue: I18N$l[lang].selectmonth, disabled: disabled, onInput: e => this.handleInput(e, 'month'), onChange: e => this.handleInput(e, 'month'), value: this.monthValue, class: `gcds-date-input__month ${hasError['month'] ? 'gcds-date-input--error' : ''}` }, requiredAttr, { "aria-invalid": hasError['month'].toString(), "aria-description": hasError['month'] && errorMessage }), options.map(option => (index.h("option", { key: option, value: option }, I18N$l[lang]['months'][option])))));
        const year = (index.h("gcds-input", Object.assign({ key: '092c62acae1ec98b7febaff0ad007d9bd3c6f68b', name: "year", label: I18N$l[lang].year, inputId: "year", type: "number", size: 4, disabled: disabled, value: this.yearValue, onInput: e => this.handleInput(e, 'year'), onChange: e => this.handleInput(e, 'year'), class: `gcds-date-input__year ${hasError['year'] ? 'gcds-date-input--error' : ''}` }, requiredAttr, { "aria-invalid": hasError['year'].toString(), "aria-description": hasError['year'] && errorMessage })));
        const day = (index.h("gcds-input", Object.assign({ key: '6628caf1b8373531227bc5f9f61a386b8e16b578', name: "day", label: I18N$l[lang].day, inputId: "day", type: "number", size: 2, disabled: disabled, value: this.dayValue, onInput: e => this.handleInput(e, 'day'), onChange: e => this.handleInput(e, 'day'), class: `gcds-date-input__day ${hasError['day'] ? 'gcds-date-input--error' : ''}` }, requiredAttr, { "aria-invalid": hasError['day'].toString(), "aria-description": hasError['day'] && errorMessage })));
        return (index.h(index.Host, { key: '6a745c12f4724ed7e8c2bb5557f11aa3db6f79cc', name: name, onBlur: () => this.onBlur() }, this.validateRequiredProps() && (index.h("fieldset", Object.assign({ key: 'a6292573f7b565a71be618eaf8df565cc8490f91', class: "gcds-date-input__fieldset" }, fieldsetAttrs), index.h("legend", { key: 'f712f4436c7c6e57a2c71c31ec688b8c4977cc42', id: "date-input-legend" }, legend, required ? (index.h("span", { class: "legend__required" }, I18N$l[lang].required)) : null), hint ? (index.h("gcds-hint", { id: "date-input-hint", "hint-id": "date-input" }, hint)) : null, errorMessage ? (index.h("div", null, index.h("gcds-error-message", { id: "date-input-error", messageId: "date-input" }, errorMessage))) : null, format == 'compact'
            ? [month, year]
            : lang == 'en'
                ? [month, day, year]
                : [day, month, year]))));
...
const GcdsDateModified = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cda63407c2b6dc57f860d505f61a9f78c15c96b3' }, this.validateRequiredProps() && (index.h("dl", { key: '3324ca2c0c64c5f89c4a398344f3892fb1637073', class: "gcds-date-modified" }, index.h("dt", { key: '46bb18c35af4cfccd2e8cc71943fb3bee51de503' }, index.h("gcds-text", { key: 'd9b12fc046a396ba12817b210eb100980c59d720', display: "inline", "margin-bottom": "0" }, type === 'version' ? I18N$k[lang].version : I18N$k[lang].date)), index.h("dd", { key: 'cc81cb879d8fc1a06832aa6f80d29c179892afc7' }, index.h("gcds-text", { key: 'cebba414553c7357b8bf9033d4d84e2a2ec03521', display: "inline", "margin-bottom": "0" }, type === 'version' ? (index.h("slot", null)) : (index.h("time", null, index.h("slot", null)))))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsDetails = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '165e069eb5507fe81e7f2e3f23d70cf3e5979aa7' }, index.h("div", { key: 'a9bbede603871396dcdbfe6d8a4a25952b611f58', class: "gcds-details" }, index.h("button", { key: 'fa1db12503e14a3e99781759a3fc5f1544a24235', "aria-expanded": open.toString(), "aria-controls": "details__panel", onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => {
                const event = utils.emitEvent(e, this.gcdsClick);
                if (event) {
                    this.toggle();
                }
            }, class: "details__summary", id: "details__summary" }, detailsTitle), index.h("details", { key: 'b63ec18b239b98bbb308989a4b71d4bda95372be', open: open, id: "details__panel", class: "details__panel", "aria-labelledby": "details__summary", onToggle: ev => this.handleToggle(ev), ref: element => (this.detailsElement = element) }, index.h("summary", { key: 'f64cf84f9a239e19e8978e8511b94bc7b2e7dfc0' }, detailsTitle), index.h("slot", { key: 'd438628d3f47d1a15f4e03a603a86f08bf25a658' })))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsErrorMessage = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '045fc9bca1001d5ad8a083333b64293c8152c4e5', id: `error-message-${messageId}`, class: "gcds-error-message-wrapper" }, index.h("gcds-text", { key: 'de9f869bdbe90f798821bffbe8aa9e930d703544', class: "error-message", role: "alert", "margin-bottom": "75" }, index.h("gcds-icon", { key: '0f579edfda3b98171166c90ee6b87d4e025762da', name: "warning-triangle", "margin-right": "50" }), index.h("strong", { key: '92704a625f29719fc7f31426fb6d20756213de30' }, index.h("slot", { key: '657508619840d11cfdd81fb207de294bc1256de7' })))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsErrorSummary = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a42f126a2bbbe41621a5c56d04c87b31e87d0363' }, index.h("div", { key: 'eeee2e16453b3c7911042cabb079ab072d3bcd09', role: "alert", tabindex: "-1", ref: element => (this.shadowElement = element), class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0
                ? 'gcds-show'
                : ''}` }, index.h("gcds-heading", { key: '5c0aa122bc9f7a1dc250d856734d99befb88502e', tag: "h2", "margin-top": "0", "margin-bottom": "225" }, heading !== null && heading !== void 0 ? heading : I18N$j[lang].heading), index.h("ol", { key: '2fd12eca1a9ffe4f11aedfdd3b93d3a0becf7420', class: "summary__errorlist" }, (hasSubmitted || errorLinks) &&
...
const GcdsFooter = class {
    ...
    render() {
        ...
        let subLinkCount = 0;
        return (index.h(index.Host, { key: 'b3085c45d846bacbff55a8eb9b1c00a89430886b', role: "contentinfo", "aria-label": "Footer" }, index.h("gcds-sr-only", { key: '606efe8477781956571e6f5f491a33a3a62f04b4', tag: "h2" }, I18N$h[lang].about), contextualLinksObject && contextualHeading && (index.h("div", { key: 'f4dc0c8107d91eed92c48a29bea4d11cc27ca1aa', class: "gcds-footer__contextual" }, index.h("div", { key: '2be8f275989cfc74bf6b2df084ca4728672df764', class: "contextual__container" }, index.h("nav", { key: '0e95de45f38aa31290b69802459dd8b613bce6fe', "aria-labelledby": "contextual__heading" }, index.h("h3", { key: 'cfcf705300e7697459313ac429a1cfdc18dd3bd2', id: "contextual__heading", class: "contextual__heading" }, contextualHeading), index.h("ul", { key: 'e40575b0fb05baf1755e4f6112aa653b971d05c5', class: "contextual__list" }, Object.keys(contextualLinksObject).map(key => {
            if (contextualLinkCount < 3) {
                contextualLinkCount++;
                return (index.h("li", null, index.h("gcds-link", { size: "small", href: contextualLinksObject[key] }, key)));
            }
        })))))), display === 'full' ? (index.h("div", { class: "gcds-footer__main" }, index.h("div", { class: "main__container" }, index.h("nav", { class: "main__govnav", "aria-labelledby": "govnav__heading" }, index.h("h3", { id: "govnav__heading" }, I18N$h[lang].gov.heading), index.h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (index.h("li", null, index.h("gcds-link", { size: "small", href: govNav[value].link }, govNav[value].text)))))), index.h("nav", { class: "main__themenav", "aria-labelledby": "themenav__heading" }, index.h("gcds-sr-only", { tag: "h4", id: "themenav__heading" }, I18N$h[lang].themes.heading), index.h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (index.h("li", null, index.h("gcds-link", { size: "small", href: themeNav[value].link }, themeNav[value].text))))))))) : null, index.h("div", { key: 'f22c6b3df1149c3c5f8be387f8e8f6409474703f', class: "gcds-footer__sub" }, index.h("div", { key: '81e35cd5397e1a9f0c373e14d1f16568c70eb690', class: "sub__container" }, index.h("nav", { key: 'ee7c37a240a121893142c51f887d49ad98add671', "aria-labelledby": "sub__heading" }, index.h("gcds-sr-only", { key: '75fef71daa19b43442a973ac70053a7ce90c7a6e', tag: "h3", id: "sub__heading" }, I18N$h[lang].site.heading), index.h("ul", { key: '4d3f7e2cb406dd420def9b0580892bb54d985269' }, subLinks
...
const GcdsHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a7aec791ab78ca2491fd9dfc043e3b42453de2a4', role: "banner" }, renderSkipToNav, hasBanner ? index.h("slot", { name: "banner" }) : null, index.h("div", { key: '1ffdfb16dbd583dc45d65edde526f10ca5445d3d', class: "gcds-header__brand" }, index.h("div", { key: 'fd921bdd08e088d99849ee37e67ff70502630cfb', class: `brand__container ${!hasSearch ? 'container--simple' : ''}` }, renderToggle, renderSignature, renderSearch)), index.h("slot", { key: '6ace8183cce4cf7de0c04c99763194f002ea4e3f', name: "menu" }), hasBreadcrumb ? (index.h("div", { class: "gcds-header__container" }, index.h("slot", { name: "breadcrumb" }))) : null));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsHeading = class {
    ...
    render() {
        ...
        const Tag = tag;
        return (index.h(index.Host, { key: '507c9c3fc2b151e9e529b3f155bc07394aa8fbb4' }, index.h(Tag, { key: '6a24d145608e7f8bec9bb7282c02b7a2d3c030d4', class: `
            gcds-heading
            ${characterLimit ? 'limit' : ''}
            ${marginTop ? `mt-${marginTop}` : ''}
            ${marginBottom ? `mb-${marginBottom}` : ''}
          ` }, index.h("slot", { key: 'fc7c907330d467d951a008b36379c34b8bdfcf5f' }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "tag": ["validateTag"],
...
const GcdsIcon = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9767ef8285004f25317ad156ac39d21a0267c6d3' }, index.h("span", { key: 'c7a3dfe9ed1b093e5a6d9a37bdc5c11e7154b462', class: `
...
const GcdsLabel = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '74bd8cdab28f3e11ad1af0e5d90ffbcdfeca4f3b', id: `label-for-${labelFor}` }, index.h("label", { key: 'a99ff6d66462b03f1b40759ada8dfe53eaa985ce', htmlFor: labelFor, class: `gcds-label ${hideLabel ? 'label--hidden' : ''}` }, index.h("span", { key: '1740af0193beae308a1227d729493c257e6ee813' }, label), required ? (index.h("span", { "aria-hidden": "true", class: "label--required" }, "(", I18N$d[lang].required, ")")) : null)));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsLangToggle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'abb80842d149c0505fdfaeb1bea1d693f8ab7acd' }, index.h("div", { key: '544f51158c13552ca6d918a976851ae114d8b15b', class: "gcds-lang-toggle" }, index.h("gcds-sr-only", { key: 'ad847ef3d7b32528ac5a02d86907e7646a6133b6', id: "lang-toggle__heading", tag: "h2" }, I18N$c[lang].heading), index.h("gcds-link", { key: '7ed33cd0eee4468e60294eb449627a546128f9b8', size: "regular", href: href, lang: I18N$c[lang].abbreviation }, index.h("span", { key: 'd1586f4d7c5b2b0b16f5e123e0dbc1715e9a7616' }, I18N$c[lang].language), index.h("abbr", { key: '38bfded01448eeccd475feca0275d34cbb8745b3', title: I18N$c[lang].language }, I18N$c[lang].abbreviation)))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsNavGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e83cd752015541c3d3c66df11acea95bb47d328f', role: "listitem", open: open }, index.h("button", { key: 'c454fdad83340bfda53c6be88fad4d04832b616d', "aria-haspopup": "true", tabIndex: 0, "aria-expanded": open.toString(), ref: element => (this.triggerElement = element), class: `gcds-nav-group__trigger gcds-trigger--${this.navStyle}`, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => {
                const event = utils.emitEvent(e, this.gcdsClick);
                if (event) {
                    this.toggleNav();
                }
            } }, index.h("gcds-icon", { key: '6a2a04d5728d1b23860522b3419c054621abae4f', name: this.navStyle === 'expandable'
                ? open
                    ? 'chevron-down'
                    : 'chevron-right'
                : open
                    ? 'chevron-up'
                    : 'chevron-down' }), closeTrigger && open ? closeTrigger : openTrigger), index.h("ul", { key: 'be77203e415fe750b349dec603812cd8a8cb5bab', "aria-label": menuLabel, class: `gcds-nav-group__list gcds-nav--${this.navStyle}` }, index.h("slot", { key: '0e98b6827f549b1ff852d15dbbe7e4f8a0546c24' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsNotice = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8a00f86f682e7a061c99658762079acc79d2277e' }, this.validateRequiredProps() && (index.h("section", { key: '04219293eafd3fe86c13826820644a02584a389d', class: `gcds-notice notice--type-${type}` }, index.h("gcds-icon", { key: '9d095dbcf44d3d39a408f55531164e76ae969b42', class: "notice__icon", size: "h4", name: iconTypes[type] }), index.h("div", { key: '525e51d6030072ee8b88a99e4e01078868e6df87' }, index.h("gcds-heading", { key: 'fd5adaf2b185a71d0d70e5174af1d590fb405c2c', tag: noticeTitleTag, "margin-top": "0", "margin-bottom": "100", class: "notice__heading" }, index.h("gcds-sr-only", { key: 'b8955dccf72340580e7cf30ae2bba76b7704b50e', tag: "span" }, I18N$a[this.lang][type]), noticeTitle), index.h("slot", { key: '781c621945781994d22fc5c0e9974ac852e0fe39' }))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsPhaseBanner = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9e22cdaf600a5c04b1a6866e7ca6386a1c52b22f' }, index.h("div", { key: '8815335957b79321257d2652ab9412071678c835', class: `gcds-phase-banner banner--role-${bannerRole} ${isFixed ? 'banner--is-fixed' : ''}`, role: "status", "aria-label": I18N$8[lang].label }, index.h("gcds-container", { key: 'f2ea1e5e0462f877f5f220762dc2ba0731177956', size: container, centered: true }, index.h("div", { key: '8f53b7147fa6cda3d0c93e48d1af7e7ee5e939b3', class: "banner__content" }, index.h("figure", { key: '065b45c6af563cde9a1239e0d156e7851cd5ec9b', class: "banner__icon icon--left" }, index.h("slot", { key: '0ebff7836c9f90e51d99ce83ade049a4560061a9', name: "banner-icon-left" })), index.h("div", { key: '75c91c8cefc6258a786d7a8a5bb0a12192701555', class: "banner__details" }, index.h("slot", { key: '02d2d3d4bc23219520073a35c14da40e4a98df44', name: "banner-text" }), index.h("slot", { key: 'd23c8e87203df30dfbb97682fc610acbb4477b90', name: "banner-cta" })), index.h("figure", { key: 'eb80fcd4a211eae36bfeaf198c75f6fdf0eac375', class: "banner__icon icon--right" }, index.h("slot", { key: 'ab144b1be3f32ab0efdb19ad5be68f12b342e745', name: "banner-icon-right" })))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsSearch = class {
    ...
    render() {
        ...
        const formAction = action === '/sr/srb.html'
            ...
            : action;
        return (index.h(index.Host, { key: '6f097c6decfc75124cfb075d08d9538fac97f247' }, index.h("section", { key: 'cac50e05b5b1993c7b582c077b52ebc0347c684d', class: "gcds-search" }, index.h("gcds-sr-only", { key: 'da41472fe9dc9dc4278a4324c5c59727bf659737', tag: "h2" }, I18N$6[lang].search), index.h("form", { key: 'd8daa855f964aea373212e226410c18a174fc2f7', action: formAction, method: method, role: "search", onSubmit: e => utils.emitEvent(e, this.gcdsSubmit, this.value), class: "gcds-search__form" }, index.h("gcds-label", { key: 'eaa37cf81c073de64d06459be03f3d11bb35ee8b', label: labelText, "label-for": searchId, "hide-label": true }), index.h("input", Object.assign({ key: '7efdfeecf78cd58fae9fe13300da38a0883c40b2', type: "search", id: searchId }, (suggested ? { list: 'search-list' } : {}), { size: 34, maxLength: 170, onInput: e => this.handleInput(e, this.gcdsInput), onChange: e => this.handleInput(e, this.gcdsChange), onFocus: () => this.gcdsFocus.emit(), onBlur: () => this.gcdsBlur.emit() }, attrsInput, { class: "gcds-search__input", value: value })), suggested && (index.h("datalist", { key: 'a8c7737d2ad864cc08ac28fa19a4c3a4f2dbf654', id: "search-list" }, suggested.map((k, v) => (index.h("option", { value: k, key: v }))))), index.h("gcds-button", { key: 'b999f4297899ff1441b1fd201f14762b942b896a', type: "submit", class: "gcds-search__button", exportparts: "button" }, index.h("gcds-icon", { key: '148d9e7fb4265b12093070af8b0604341d300994', name: "search", label: I18N$6[lang].search, size: "h3" }))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsSignature = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9371550c9068d0041b6c661746206cd0f9eab90b' }, type === 'signature' ? (index.h(Tag, Object.assign({}, sigAttrs), index.h("div", { innerHTML: selectSVG }))) : (index.h("div", { class: "gcds-signature", innerHTML: selectSVG }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "type": ["validateType"],
...
const GcdsSrOnly = class {
    ...
    render() {
        const Tag = this.tag;
        return (index.h(index.Host, { key: 'c3d546661babf7e4c34bbf46600431ea761b2624' }, index.h(Tag, { key: '32bd3afe9621aa3bcd787bdb95d64ecb18819e0e' }, index.h("slot", { key: 'd2c250f425e5e988995957b984f7c05e3413651c' }))));
    }
    static get watchers() { return {
        "tag": ["validateTag"]
    }; }
...
const GcdsStepper = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '668131869ea8b9e4542e097e28efbfae9b5a6bae' }, this.validateRequiredProps() && (index.h("gcds-heading", { key: 'e50a066d662ef3e606e21da157731de6e6b6b78a', tag: tag, class: "gcds-stepper", "margin-top": "0", "margin-bottom": "225" }, index.h("span", { key: 'c573ba75a978b689698fb8eab50caa08853d12e3', class: "gcds-stepper__steps" }, `${I18N$3[lang].step} ${currentStep} ${I18N$3[lang].of} ${totalSteps}`, index.h("gcds-sr-only", { key: 'fea60de171d7e2412957e922944421f9cbb6d379' }, " : ")), index.h("slot", { key: '679d080d48b257b840ee9d78e693f06df548faee' })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const GcdsText = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '60d33fada39b1dd1af0af482be9d9d3d158d248b', class: `${display != 'block' ? `d-${display}` : ''}` }, index.h("p", { key: '5c890123f5244dd5a67f01819bbd309d67f2458a', class: `
            gcds-text
...
const GcdsVerifyBanner = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '81973537a21ff8bc06d7af751286180909137d4f' }, index.h("details", { key: 'ea98f8b396c065be3338f62f1b4bdfbffddc6d68', class: `gcds-verify-banner ${isFixed ? 'verify-banner--is-fixed' : ''}` }, index.h("summary", { key: 'b83b678363782e280872028016c1830f057f79a5', class: container ? `container-${container}` : '', "aria-expanded": "false", role: "button" }, index.h("span", { key: 'ea8489486256e7cf983ea62b534b3b953ffbdfd9', class: "svg-container", innerHTML: CanadaFlag }), index.h("p", { key: '441d0f62bfaa8232766fa25d4f293856d5919fc5' }, index.h("small", { key: 'fd9985644c5d448e783fe121392dcc752a11894c' }, I18N[lang].summary.text), index.h("button", { key: 'e367c1f16b77914512d7191d9c4acb979da28898', class: "verify-banner__toggle" }, index.h("small", { key: '1b7cec1da1f70df3108188f67c58df05e9f43265' }, I18N[lang].summary.link), index.h("span", { key: '88387f3e006781d43354182badf4db34ac890752', class: "svg-container", innerHTML: ContentToggleArrow })))), index.h("div", { key: '2a90d1b70f1ccf1c08f2d887f6bd4ec89138362a', class: `verify-banner__content ${container ? `container-${container}` : ''}` }, index.h("p", { key: 'c70e302d34681c52dbb2157020955821de2e66a0' }, index.h("small", { key: '91e86ac20f3241a976463438b7164183e16584ec' }, I18N[lang].content.description)), index.h("br", { key: '802f4c5b24f4b63b9764056638329a1be0580e2a' }), index.h("gcds-grid", { key: 'c9347190bdd322599825eb56bc78e63fcf28702f', tag: "ul", container: "lg", columns: "1fr", "columns-tablet": container === 'xs' || container === 'sm' ? '1fr' : '1fr 1fr' }, index.h("li", { key: 'bcbd1951e53638d63f335c3960c3be067f674f25' }, index.h("h4", { key: '093d8a04f8eb8ddb1d3b8aa07e430f2cc0ddc76d' }, I18N[lang].content.url.heading), index.h("p", { key: 'd5c47c818ecde61d8ef45138408231ec8332eee9' }, index.h("small", { key: '21e821fe073fa5260ba129da8e53f226e5f7922d' }, I18N[lang].content.url.text))), index.h("li", { key: '6bf334ae274e581dc7e7529b8e078123aa501836' }, index.h("h4", { key: '38001a7718f7a4384d8dbd7816285e193bd80f0f' }, I18N[lang].content.languages.heading), index.h("p", { key: 'a42c56b425effc00caf0a2b2d3c79aea52c7a4d5' }, index.h("small", { key: 'c05571e761970df2293667ca25f91d657d7784ff' }, I18N[lang].content.languages.text))), index.h("li", { key: 'f6c5b8619a5014470dd835c684244ac145f2c5fd' }, index.h("h4", { key: '3ac2cf2d08c5f94d07bcd7fbe1786b7a138d4f0d' }, I18N[lang].content.https.heading), index.h("p", { key: '596499c8b77e7260776da2ab782670820687a2b0' }, index.h("small", { key: '9b81bf698364397d705d0c20df078cb5f2f97171' }, I18N[lang].content.https.text, " ", index.h("strong", { key: 'b187d642957907d9501d13c617e3e54c1fa11887' }, "https://"), "."))), index.h("li", { key: '086c41a49bebea39aa287aa213e288ddd4c4d2f8' }, index.h("h4", { key: 'dd45cc64f0ad0779e28f228fdee78d6216c4c747' }, I18N[lang].content.contact.heading), index.h("p", { key: '745ab9a7fcfff95e6df069e182f334ecda0b27dd' }, index.h("small", { key: '7c7ae86324f385e9b23461126a418ecbb8f09a16' }, I18N[lang].content.contact.text))))))));
    }
    get el() { return index.getElement(this); }
};
