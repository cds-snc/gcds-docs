...
const GcdsDateInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bd299bd117299d1b0500413185a10a32501b7490', name: name, onBlur: () => this.onBlur() }, this.validateRequiredProps() && (index.h("fieldset", Object.assign({ key: '02d4a393d8336c29d060716f5ddd9c3e1eb4c46d', class: "gcds-date-input__fieldset" }, fieldsetAttrs, { ref: el => (this.fieldset = el) }), index.h("legend", { key: 'deb09ce61953147d78b00eb1ac45a821651ec80f', id: "date-input-legend" }, legend, required ? (index.h("span", { class: "legend__required" }, I18N$l[lang].required)) : null), hint ? (index.h("gcds-hint", { id: "date-input-hint", "hint-id": "date-input" }, hint)) : null, errorMessage ? (index.h("div", null, index.h("gcds-error-message", { id: "date-input-error", messageId: "date-input" }, errorMessage))) : null, format == 'compact'
            ? [month, year]
            : lang == 'en'
                ? [month, day, year]
                : [day, month, year]))));
...
const GcdsSearch = class {
    ...
    render() {
        ...
        const formAction = action === '/sr/srb.html'
            ...
            : action;
        return (index.h(index.Host, { key: 'a8447a475cd01c2470f0fcf59a811c7878993b45' }, index.h("section", { key: '85cd42252e0d347f31ed2cb00b34636e6c26eccc', class: "gcds-search" }, index.h("gcds-sr-only", { key: '750462bb0db188d542c56725d9b2e5ae76a3f4bb', tag: "h2" }, I18N$6[lang].search), index.h("form", { key: 'f8874db21951a4aeaa63e72f9ad186dae48e1470', action: formAction, method: method, role: "search", onSubmit: e => utils.emitEvent(e, this.gcdsSubmit, this.value), class: "gcds-search__form" }, index.h("gcds-label", { key: '3397eebceaaa860ec6a33a3f04adbe02885051ae', label: labelText, "label-for": searchId, "hide-label": true }), index.h("input", Object.assign({ key: '6e8919b8ed8ccefd290672bd785b825a2aec5e19', type: "search", id: searchId }, (suggestedArray ? { list: 'search-list' } : {}), { size: 34, maxLength: 170, onInput: e => this.handleInput(e, this.gcdsInput), onChange: e => this.handleInput(e, this.gcdsChange), onFocus: () => this.gcdsFocus.emit(), onBlur: () => this.gcdsBlur.emit() }, attrsInput, { class: "gcds-search__input", value: value })), suggestedArray && (index.h("datalist", { key: 'd2447eb6daceafbb51cf617bf206d381f5b53629', id: "search-list" }, suggestedArray.map((k, v) => (index.h("option", { value: k, key: v }))))), index.h("gcds-button", { key: 'ba672e2400fd432988f4dd01c5f176b15b6b3716', type: "submit", class: "gcds-search__button", exportparts: "button" }, index.h("gcds-icon", { key: '61eaab4eaac77486c49136af763793310d1e3c49', name: "search", label: I18N$6[lang].search, size: "h3" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const GcdsSelect = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b013745e4eff4fbea0a8c1cc345e5060e8e06db5' }, index.h("div", { key: 'a0afc1eba170ae6e33025112b5f48584e7a5c8e3', class: `gcds-select-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, index.h("gcds-label", Object.assign({ key: '33ee9c668f0adfa00854d38c6fda8fbad9c08eb9' }, attrsLabel, { "hide-label": hideLabel, "label-for": selectId, lang: lang })), hint ? index.h("gcds-hint", { "hint-id": selectId }, hint) : null, errorMessage ? (index.h("gcds-error-message", { messageId: selectId }, errorMessage)) : null, index.h("select", Object.assign({ key: '98566628be047f76761eaae900d5cc339520f6e7' }, attrsSelect, { id: selectId, onBlur: () => this.onBlur(), onFocus: () => this.gcdsFocus.emit(), onInput: e => this.handleInput(e, this.gcdsInput), onChange: e => this.handleInput(e, this.gcdsChange), "aria-invalid": inheritedAttributes['aria-invalid'] === 'true'
                ? inheritedAttributes['aria-invalid']
                : errorMessage
                    ? 'true'
...
const GcdsSignature = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9371550c9068d0041b6c661746206cd0f9eab90b' }, type === 'signature' ? (index.h(Tag, Object.assign({}, sigAttrs), index.h("div", { innerHTML: selectSVG }), index.h("gcds-sr-only", { tag: "span", lang: lang === 'en' ? 'fr' : 'en' }, lang === 'en'
            ? `/ ${I18N$4.fr.gc}`
