...
const index = require('./index-77861406.js');
...
const GcdsAlert = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, isOpen ? (index.h("div", { class: `gcds-alert alert--role-${alertRole} ${isFixed ? 'alert--is-fixed' : ''}`, role: "alert", "aria-label": alertRole === 'danger'
        ? I18N$l[lang].label.danger
        : alertRole === 'info'
          ? I18N$l[lang].label.info
          : alertRole === 'success'
            ? I18N$l[lang].label.success
            : alertRole === 'warning'
              ? I18N$l[lang].label.warning
              : null }, index.h("gcds-container", { size: isFixed ? container : 'full', centered: true }, index.h("div", { class: "alert__container" }, !hideRoleIcon && (index.h("gcds-icon", { "aria-hidden": "true", class: "alert__icon", size: "h5", name: alertRole === 'danger'
        ? 'exclamation-circle'
        : alertRole === 'info'
          ? 'info-circle'
          : alertRole === 'success'
            ...
            : alertRole === 'warning'
              ...
              : null })), index.h("div", { class: "alert__content" }, index.h("p", { class: "alert__heading" }, index.h("strong", null, heading)), index.h("slot", null)), !hideCloseBtn && (index.h("button", { class: "alert__close-btn", onClick: e => this.onDismiss(e), "aria-label": I18N$l[lang].closeBtn }, index.h("gcds-icon", { "aria-hidden": "true", name: "times", size: "text" }))))))) : null));
  }
...
const GcdsBreadcrumbs = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("nav", { "aria-label": I18N$k[lang].label, class: "gcds-breadcrumbs" }, index.h("ol", { class: hideCanadaLink ? '' : 'has-canada-link' }, !hideCanadaLink ? (index.h("gcds-breadcrumbs-item", { href: I18N$k[lang].link }, "Canada.ca")) : null, index.h("slot", null)))));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsBreadcrumbsItem = class {
  ...
  render() {
    const { href } = this;
    return (index.h(index.Host, { role: "listitem", class: "gcds-breadcrumbs-item" }, index.h("a", { href: href }, index.h("slot", null))));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsButton = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h(Tag, Object.assign({}, attrs, { id: buttonId, onBlur: e => this.onBlur(e), onFocus: e => this.onFocus(e), onClick: e => this.handleClick(e), class: `button--role-${buttonRole} button--${buttonStyle} button--${size}`, ref: element => (this.shadowElement = element) }, inheritedAttributes, { part: "button" }), index.h("slot", { name: "left" }), index.h("slot", null), type === 'link' && target === '_blank' ? (index.h("gcds-icon", { name: "external-link", label: I18N$j[lang].label, "margin-left": "200" })) : (index.h("slot", { name: "right" })))));
  }
  get el() { return index.getElement(this); }
...
const GcdsCard = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: `gcds-card gcds-card--${type}` }, imgSrc && (index.h("img", { src: imgSrc, alt: imgAlt ? imgAlt : '', class: "gcds-card__image" })), tag && index.h("span", { class: "gcds-card__tag" }, tag), Element != 'a' ? (index.h(Element, { class: "gcds-card__title" }, index.h("a", { href: href }, cardTitle))) : (index.h("a", { href: href, class: "gcds-card__title" }, cardTitle)), description && index.h("p", { class: "gcds-card__description" }, description), hasCardFooter && (index.h(index.Fragment, null, index.h("div", { class: "gcds-card__spacer" }), index.h("slot", { name: "footer" }))))));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsCheckbox = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: `gcds-checkbox ${disabled ? 'gcds-checkbox--disabled' : ''} ${hasError ? 'gcds-checkbox--error' : ''}` }, index.h("input", Object.assign({ id: checkboxId, type: "checkbox" }, attrsInput, { onBlur: e => this.onBlur(e), onFocus: e => this.onFocus(e), onChange: () => this.onChange(), onClick: e => {
        this.clickHandler && this.clickHandler(e);
      }, ref: element => (this.shadowElement = element) })), index.h("gcds-label", Object.assign({}, attrsLabel, { "label-for": checkboxId, lang: lang })), hint ? index.h("gcds-hint", { hint: hint, "hint-id": checkboxId }) : null, errorMessage ? (index.h("gcds-error-message", { messageId: checkboxId, message: errorMessage })) : null, parentError ? (index.h("span", { id: `parent-error-${checkboxId}`, hidden: true }, parentError)) : null)));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const GcdsDetails = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("button", { "aria-expanded": open.toString(), "aria-controls": "details__panel", onClick: () => (this.open = !open), class: "details__summary", id: "details__summary" }, detailsTitle), index.h("div", { id: "details__panel", class: "details__panel", "aria-labelledby": "details__summary" }, index.h("slot", null))));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsErrorMessage = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { id: `error-message-${messageId}`, class: "gcds-error-message-wrapper" }, index.h("p", { class: "error-message", role: "alert" }, message)));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsErrorSummary = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { role: "alert", tabindex: "-1", ref: element => (this.shadowElement = element), class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0
        ? 'gcds-show'
        : ''}` }, index.h("h2", { class: "summary__heading" }, heading !== null && heading !== void 0 ? heading : I18N$h[lang].heading), index.h("ol", { class: "summary__errorlist" }, (hasSubmitted || errorLinks) &&
      Object.keys(errorQueue).length > 0 &&
      Object.keys(errorQueue).map(key => {
        return (index.h("li", { class: "summary__listitem" }, index.h("a", { onClick: e => this.focusElement(e, key), class: "summary__link", href: key }, errorQueue[key])));
      })))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const GcdsFieldset = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("fieldset", Object.assign({ class: `gcds-fieldset ${hasError ? 'gcds-fieldset--error' : ''}`, id: fieldsetId }, fieldsetAttrs, { "aria-labelledby": hint
        ...
        : `legend-${fieldsetId}`, tabindex: "-1", ref: element => (this.shadowElement = element) }), index.h("legend", { id: `legend-${fieldsetId}` }, legend, required ? (index.h("strong", { class: "legend__required" }, "(", I18N$g[lang].required, ")")) : null), hint ? index.h("gcds-hint", { hint: hint, "hint-id": fieldsetId }) : null, errorMessage ? (index.h("gcds-error-message", { messageId: fieldsetId, message: errorMessage })) : null, index.h("slot", null))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
    "errorMessage": ["validateErrorMessage"],
...
const GcdsFileUploader = class {
  constructor(hostRef) {
    ...
    this.gcdsFocus = index.createEvent(this, "gcdsFocus", 7);
    this.gcdsBlur = index.createEvent(this, "gcdsBlur", 7);
    this.gcdsFileUploaderChange = index.createEvent(this, "gcdsFileUploaderChange", 7);
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: `gcds-file-uploader-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, index.h("gcds-label", Object.assign({}, attrsLabel, { "label-for": uploaderId, lang: lang })), hint ? index.h("gcds-hint", { hint: hint, "hint-id": uploaderId }) : null, errorMessage ? (index.h("gcds-error-message", { messageId: uploaderId, message: errorMessage })) : null, index.h("div", { class: `file-uploader__input ${value.length > 0 ? 'uploaded-files' : ''}` }, index.h("button", { type: "button", tabindex: "-1", onClick: () => this.shadowElement.click() }, I18N$f[lang].button.upload), index.h("input", Object.assign({ type: "file", id: uploaderId, name: uploaderId }, attrsInput, { onBlur: e => this.onBlur(e), onFocus: e => this.onFocus(e), onChange: e => this.handleChange(e), "aria-invalid": hasError ? 'true' : 'false', ref: element => (this.shadowElement = element) })), value.length > 0 ? (index.h("p", { id: "file-uploader__summary" }, index.h("span", null, I18N$f[lang].summary.selected, " "), value.map(file => (index.h("span", null, file, " "))))) : (index.h("p", { id: "file-uploader__summary" }, I18N$f[lang].summary.unselected))), value.length > 0
      ? value.map(file => (index.h("div", { class: "file-uploader__uploaded-file", "aria-label": `${I18N$f[lang].removeFile} ${file}.` }, index.h("span", null, file), index.h("button", { onClick: e => this.removeFile(e) }, index.h("span", null, I18N$f[lang].button.remove), index.h("gcds-icon", { name: "times", size: "text", "margin-left": "200" })))))
      : null)));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const GcdsFooter = class {
  ...
  render() {
    ...
    let subLinkCount = 0;
    return (index.h(index.Host, { role: "contentinfo" }, index.h("h2", { class: "gcds-footer__header" }, I18N$e[lang].about), contextualLinksObject && contextualHeading && (index.h("div", { class: "gcds-footer__contextual" }, index.h("div", { class: "contextual__container" }, index.h("nav", { "aria-label": contextualHeading }, index.h("h3", { class: "contextual__header" }, contextualHeading), index.h("ul", { class: "contextual__list" }, Object.keys(contextualLinksObject).map(key => {
      if (contextualLinkCount < 3) {
        contextualLinkCount++;
        return (index.h("li", null, index.h("a", { href: contextualLinksObject[key] }, key)));
      }
    })))))), display === 'full' ? (index.h("div", { class: "gcds-footer__main" }, index.h("div", { class: "main__container" }, index.h("nav", { class: "main__govnav", "aria-label": I18N$e[lang].gov.heading }, index.h("h3", null, I18N$e[lang].gov.heading), index.h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (index.h("li", null, index.h("a", { href: govNav[value].link }, govNav[value].text)))))), index.h("nav", { class: "main__themenav", "aria-label": I18N$e[lang].themes.heading }, index.h("h4", { class: "themenav__header" }, I18N$e[lang].themes.heading), index.h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (index.h("li", null, index.h("a", { href: themeNav[value].link }, themeNav[value].text))))))))) : null, index.h("div", { class: "gcds-footer__sub" }, index.h("div", { class: "sub__container" }, index.h("nav", { "aria-label": I18N$e[lang].site.heading }, index.h("h3", { class: "sub__header" }, I18N$e[lang].site.heading), index.h("ul", null, subLinks
      ? Object.keys(subLinksObject).map(key => {
        if (subLinkCount < 5) {
          subLinkCount++;
          return (index.h("li", null, index.h("a", { href: subLinksObject[key] }, key)));
        }
      })
      : Object.keys(siteNav).map(value => {
        return (index.h("li", null, index.h("a", { href: siteNav[value].link }, siteNav[value].text)));
      }))), renderSignature))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const GcdsHeader = class {
  ...
  get renderSkipToNav() {
    if (this.el.querySelector('[slot="skip-to-nav"]')) {
      ...
      return (index.h("nav", { class: "gcds-header__skip-to-nav" }, index.h("gcds-button", { type: "link", "button-role": "skip-to-content", href: this.skipToHref }, I18N$d[this.lang].skip)));
    }
    else {
      return;
    }
...
const gcdsHeadingCss = "@layer reset,\ndefaults,\nvariants;@layer reset{:host{color:var(--gcds-heading-default-text);display:block}:host h1,:host h2,:host h3,:host h4,:host h5,:host h6{-webkit-box-sizing:border-box;box-sizing:border-box;margin:0}:host slot{display:inherit}}@layer defaults{:host h1,:host h2,:host h3,:host h4,:host h5,:host h6{text-wrap:balance}:host h1.gcds-heading{font:var(--gcds-heading-h1-desktop)}@media only screen and (width < 48em){:host h1.gcds-heading{font:var(--gcds-heading-h1-mobile)}}:host h1.gcds-heading:after{background-color:var(--gcds-heading-h1-border-background);content:\"\";display:block;height:var(--gcds-heading-h1-border-height);-webkit-margin-before:var(--gcds-heading-h1-border-margin);margin-block-start:var(--gcds-heading-h1-border-margin);width:var(--gcds-heading-h1-border-width)}:host h2.gcds-heading{font:var(--gcds-heading-h2-desktop)}@media only screen and (width < 48em){:host h2.gcds-heading{font:var(--gcds-heading-h2-mobile)}}:host h3.gcds-heading{font:var(--gcds-heading-h3-desktop)}@media only screen and (width < 48em){:host h3.gcds-heading{font:var(--gcds-heading-h3-mobile)}}:host h4.gcds-heading{font:var(--gcds-heading-h4-desktop)}@media only screen and (width < 48em){:host h4.gcds-heading{font:var(--gcds-heading-h4-mobile)}}:host h5.gcds-heading{font:var(--gcds-heading-h5-desktop)}@media only screen and (width < 48em){:host h5.gcds-heading{font:var(--gcds-heading-h5-mobile)}}:host h6.gcds-heading{font:var(--gcds-heading-h6-desktop)}@media only screen and (width < 48em){:host h6.gcds-heading{font:var(--gcds-heading-h6-mobile)}}}@layer variants{:host h1.mt-0,:host h2.mt-0,:host h3.mt-0,:host h4.mt-0,:host h5.mt-0,:host h6.mt-0{-webkit-margin-before:var(--gcds-heading-spacing-0);margin-block-start:var(--gcds-heading-spacing-0)}:host h1.mt-50,:host h2.mt-50,:host h3.mt-50,:host h4.mt-50,:host h5.mt-50,:host h6.mt-50{-webkit-margin-before:var(--gcds-heading-spacing-50);margin-block-start:var(--gcds-heading-spacing-50)}:host h1.mt-100,:host h2.mt-100,:host h3.mt-100,:host h4.mt-100,:host h5.mt-100,:host h6.mt-100{-webkit-margin-before:var(--gcds-heading-spacing-100);margin-block-start:var(--gcds-heading-spacing-100)}:host h1.mt-150,:host h2.mt-150,:host h3.mt-150,:host h4.mt-150,:host h5.mt-150,:host h6.mt-150{-webkit-margin-before:var(--gcds-heading-spacing-150);margin-block-start:var(--gcds-heading-spacing-150)}:host h1.mt-200,:host h2.mt-200,:host h3.mt-200,:host h4.mt-200,:host h5.mt-200,:host h6.mt-200{-webkit-margin-before:var(--gcds-heading-spacing-200);margin-block-start:var(--gcds-heading-spacing-200)}:host h1.mt-250,:host h2.mt-250,:host h3.mt-250,:host h4.mt-250,:host h5.mt-250,:host h6.mt-250{-webkit-margin-before:var(--gcds-heading-spacing-250);margin-block-start:var(--gcds-heading-spacing-250)}:host h1.mt-300,:host h2.mt-300,:host h3.mt-300,:host h4.mt-300,:host h5.mt-300,:host h6.mt-300{-webkit-margin-before:var(--gcds-heading-spacing-300);margin-block-start:var(--gcds-heading-spacing-300)}:host h1.mt-400,:host h2.mt-400,:host h3.mt-400,:host h4.mt-400,:host h5.mt-400,:host h6.mt-400{-webkit-margin-before:var(--gcds-heading-spacing-400);margin-block-start:var(--gcds-heading-spacing-400)}:host h1.mt-450,:host h2.mt-450,:host h3.mt-450,:host h4.mt-450,:host h5.mt-450,:host h6.mt-450{-webkit-margin-before:var(--gcds-heading-spacing-450);margin-block-start:var(--gcds-heading-spacing-450)}:host h1.mt-500,:host h2.mt-500,:host h3.mt-500,:host h4.mt-500,:host h5.mt-500,:host h6.mt-500{-webkit-margin-before:var(--gcds-heading-spacing-500);margin-block-start:var(--gcds-heading-spacing-500)}:host h1.mt-550,:host h2.mt-550,:host h3.mt-550,:host h4.mt-550,:host h5.mt-550,:host h6.mt-550{-webkit-margin-before:var(--gcds-heading-spacing-550);margin-block-start:var(--gcds-heading-spacing-550)}:host h1.mt-600,:host h2.mt-600,:host h3.mt-600,:host h4.mt-600,:host h5.mt-600,:host h6.mt-600{-webkit-margin-before:var(--gcds-heading-spacing-600);margin-block-start:var(--gcds-heading-spacing-600)}:host h1.mt-700,:host h2.mt-700,:host h3.mt-700,:host h4.mt-700,:host h5.mt-700,:host h6.mt-700{-webkit-margin-before:var(--gcds-heading-spacing-700);margin-block-start:var(--gcds-heading-spacing-700)}:host h1.mt-800,:host h2.mt-800,:host h3.mt-800,:host h4.mt-800,:host h5.mt-800,:host h6.mt-800{-webkit-margin-before:var(--gcds-heading-spacing-800);margin-block-start:var(--gcds-heading-spacing-800)}:host h1.mt-900,:host h2.mt-900,:host h3.mt-900,:host h4.mt-900,:host h5.mt-900,:host h6.mt-900{-webkit-margin-before:var(--gcds-heading-spacing-900);margin-block-start:var(--gcds-heading-spacing-900)}:host h1.mt-1000,:host h2.mt-1000,:host h3.mt-1000,:host h4.mt-1000,:host h5.mt-1000,:host h6.mt-1000{-webkit-margin-before:var(--gcds-heading-spacing-1000);margin-block-start:var(--gcds-heading-spacing-1000)}:host h1.mb-0,:host h2.mb-0,:host h3.mb-0,:host h4.mb-0,:host h5.mb-0,:host h6.mb-0{-webkit-margin-after:var(--gcds-heading-spacing-0);margin-block-end:var(--gcds-heading-spacing-0)}:host h1.mb-50,:host h2.mb-50,:host h3.mb-50,:host h4.mb-50,:host h5.mb-50,:host h6.mb-50{-webkit-margin-after:var(--gcds-heading-spacing-50);margin-block-end:var(--gcds-heading-spacing-50)}:host h1.mb-100,:host h2.mb-100,:host h3.mb-100,:host h4.mb-100,:host h5.mb-100,:host h6.mb-100{-webkit-margin-after:var(--gcds-heading-spacing-100);margin-block-end:var(--gcds-heading-spacing-100)}:host h1.mb-150,:host h2.mb-150,:host h3.mb-150,:host h4.mb-150,:host h5.mb-150,:host h6.mb-150{-webkit-margin-after:var(--gcds-heading-spacing-150);margin-block-end:var(--gcds-heading-spacing-150)}:host h1.mb-200,:host h2.mb-200,:host h3.mb-200,:host h4.mb-200,:host h5.mb-200,:host h6.mb-200{-webkit-margin-after:var(--gcds-heading-spacing-200);margin-block-end:var(--gcds-heading-spacing-200)}:host h1.mb-250,:host h2.mb-250,:host h3.mb-250,:host h4.mb-250,:host h5.mb-250,:host h6.mb-250{-webkit-margin-after:var(--gcds-heading-spacing-250);margin-block-end:var(--gcds-heading-spacing-250)}:host h1.mb-300,:host h2.mb-300,:host h3.mb-300,:host h4.mb-300,:host h5.mb-300,:host h6.mb-300{-webkit-margin-after:var(--gcds-heading-spacing-300);margin-block-end:var(--gcds-heading-spacing-300)}:host h1.mb-400,:host h2.mb-400,:host h3.mb-400,:host h4.mb-400,:host h5.mb-400,:host h6.mb-400{-webkit-margin-after:var(--gcds-heading-spacing-400);margin-block-end:var(--gcds-heading-spacing-400)}:host h1.mb-450,:host h2.mb-450,:host h3.mb-450,:host h4.mb-450,:host h5.mb-450,:host h6.mb-450{-webkit-margin-after:var(--gcds-heading-spacing-450);margin-block-end:var(--gcds-heading-spacing-450)}:host h1.mb-500,:host h2.mb-500,:host h3.mb-500,:host h4.mb-500,:host h5.mb-500,:host h6.mb-500{-webkit-margin-after:var(--gcds-heading-spacing-500);margin-block-end:var(--gcds-heading-spacing-500)}:host h1.mb-550,:host h2.mb-550,:host h3.mb-550,:host h4.mb-550,:host h5.mb-550,:host h6.mb-550{-webkit-margin-after:var(--gcds-heading-spacing-550);margin-block-end:var(--gcds-heading-spacing-550)}:host h1.mb-600,:host h2.mb-600,:host h3.mb-600,:host h4.mb-600,:host h5.mb-600,:host h6.mb-600{-webkit-margin-after:var(--gcds-heading-spacing-600);margin-block-end:var(--gcds-heading-spacing-600)}:host h1.mb-700,:host h2.mb-700,:host h3.mb-700,:host h4.mb-700,:host h5.mb-700,:host h6.mb-700{-webkit-margin-after:var(--gcds-heading-spacing-700);margin-block-end:var(--gcds-heading-spacing-700)}:host h1.mb-800,:host h2.mb-800,:host h3.mb-800,:host h4.mb-800,:host h5.mb-800,:host h6.mb-800{-webkit-margin-after:var(--gcds-heading-spacing-800);margin-block-end:var(--gcds-heading-spacing-800)}:host h1.mb-900,:host h2.mb-900,:host h3.mb-900,:host h4.mb-900,:host h5.mb-900,:host h6.mb-900{-webkit-margin-after:var(--gcds-heading-spacing-900);margin-block-end:var(--gcds-heading-spacing-900)}:host h1.mb-1000,:host h2.mb-1000,:host h3.mb-1000,:host h4.mb-1000,:host h5.mb-1000,:host h6.mb-1000{-webkit-margin-after:var(--gcds-heading-spacing-1000);margin-block-end:var(--gcds-heading-spacing-1000)}:host h1.limit{max-width:var(--gcds-heading-character-limit-h1)}:host h2.limit{max-width:var(--gcds-heading-character-limit-h2)}:host h3.limit{max-width:var(--gcds-heading-character-limit-h3)}:host h4.limit{max-width:var(--gcds-heading-character-limit-h4)}:host h5.limit{max-width:var(--gcds-heading-character-limit-h5)}:host h6.limit{max-width:var(--gcds-heading-character-limit-h6)}}";
...
const GcdsHint = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { id: `hint-${hintId}` }, index.h("p", { class: "gcds-hint" }, hint)));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsLangToggle = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", null, index.h("h2", null, I18N$b[lang].heading), index.h("a", { href: href, lang: I18N$b[lang].abbreviation }, index.h("span", null, I18N$b[lang].language), index.h("abbr", { title: I18N$b[lang].language }, I18N$b[lang].abbreviation)))));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsLink = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("a", Object.assign({ role: "link", tabIndex: 0 }, attrs, { class: `link--${size} ${display != 'inline' ? `d-${display}` : ''}`, ref: element => (this.shadowElement = element), target: isExternal ? '_blank' : target, rel: isExternal ? 'noopener noreferrer' : rel }, inheritedAttributes, { part: "link", onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: () => this.gcdsClick.emit() }), index.h("slot", null), target === '_blank' || external ? (index.h("gcds-icon", { name: "external-link", label: I18N$a[lang].external, "margin-left": "100" })) : download !== undefined ? (index.h("gcds-icon", { name: "download", label: I18N$a[lang].download, "margin-left": "100" })) : href.toLowerCase().startsWith('mailto:') ? (index.h("gcds-icon", { "icon-style": "regular", name: "envelope", label: I18N$a[lang].email, "margin-left": "100" })) : (href.toLowerCase().startsWith('tel:') && (index.h("gcds-icon", { name: "phone", label: I18N$a[lang].phone, "margin-left": "100" }))))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
    "size": ["validateSize"],
...
const GcdsNavLink = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { role: "presentation", class: `gcds-nav-link--${this.navStyle}` }, index.h("a", Object.assign({ class: "gcds-nav-link", href: href }, linkAttrs, { role: "menuitem", onBlur: e => this.onBlur(e), onFocus: e => this.onFocus(e), onClick: e => this.onClick(e), ref: element => (this.linkElement = element) }), index.h("slot", null))));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsPagination = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { role: "navigation", "aria-label": label }, display === 'list' ? (index.h("div", null, index.h("ul", { class: "gcds-pagination-list" }, this.listitems), index.h("ul", { class: "gcds-pagination-list-mobile-prevnext" }, this.mobilePrevNext))) : (index.h("ul", { class: "gcds-pagination-simple" }, previousHref && (index.h("li", { class: "gcds-pagination-simple-previous" }, index.h("a", { href: previousHref, "aria-label": `${I18N$9[lang].previousPage}${previousLabel ? `: ${previousLabel}` : ''}`, onClick: e => this.onPageChange(e) }, index.h("gcds-icon", { "margin-right": "200", name: "arrow-left" }), index.h("div", { class: "gcds-pagination-simple-text" }, I18N$9[lang].previous), index.h("span", null, previousLabel)))), nextHref && (index.h("li", { class: "gcds-pagination-simple-next" }, index.h("a", { href: nextHref, "aria-label": `${I18N$9[lang].nextPage}${nextLabel ? `: ${nextLabel}` : ''}`, onClick: e => this.onPageChange(e) }, index.h("div", { class: "gcds-pagination-simple-text" }, I18N$9[lang].next), index.h("span", null, nextLabel), index.h("gcds-icon", { "margin-left": "200", name: "arrow-right" }))))))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const GcdsRadio = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.gcdsRadioChange = index.createEvent(this, "gcdsRadioChange", 7);
    this.gcdsFocus = index.createEvent(this, "gcdsFocus", 7);
    this.gcdsBlur = index.createEvent(this, "gcdsBlur", 7);
    this.onFocus = e => {
      if (this.focusHandler) {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: `gcds-radio ${disabled ? 'gcds-radio--disabled' : ''} ${hasError ? 'gcds-radio--error' : ''}` }, index.h("input", Object.assign({ id: radioId, type: "radio" }, attrsInput, { onChange: () => this.onChange(name), onBlur: e => this.onBlur(e), onFocus: e => this.onFocus(e), onClick: e => {
        this.clickHandler && this.clickHandler(e);
      }, ref: element => (this.shadowElement = element) })), index.h("gcds-label", { label: label, "label-for": radioId, lang: lang }), hint ? index.h("gcds-hint", { hint: hint, "hint-id": radioId }) : null, parentError && (index.h("span", { id: `parent-error-${radioId}`, hidden: true }, parentError)))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
    "hasError": ["validateHasError"]
...
const GcdsSelect = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.gcdsSelectChange = index.createEvent(this, "gcdsSelectChange", 7);
    this.gcdsFocus = index.createEvent(this, "gcdsFocus", 7);
    this.gcdsBlur = index.createEvent(this, "gcdsBlur", 7);
    this.gcdsError = index.createEvent(this, "gcdsError", 7);
    this.gcdsValid = index.createEvent(this, "gcdsValid", 7);
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: `gcds-select-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, index.h("gcds-label", Object.assign({}, attrsLabel, { "label-for": selectId, lang: lang })), hint ? index.h("gcds-hint", { hint: hint, "hint-id": selectId }) : null, errorMessage ? (index.h("gcds-error-message", { messageId: selectId, message: errorMessage })) : null, index.h("select", Object.assign({}, attrsSelect, { id: selectId, name: selectId, onBlur: e => this.onBlur(e), onFocus: e => this.onFocus(e), onChange: e => this.handleChange(e), "aria-invalid": hasError ? 'true' : 'false', ref: element => (this.shadowElement = element) }), defaultValue ? (index.h("option", { value: "", disabled: true, selected: true }, defaultValue)) : null, index.h("slot", null)))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
    "disabled": ["validateDisabledSelect"],
...
const GcdsSideNav = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("nav", { "aria-label": `${label}${I18N$6[lang].navLabel}` }, index.h("h2", { class: "gcds-side-nav__heading" }, label), index.h("gcds-nav-group", { menuLabel: "Menu", closeTrigger: lang == 'fr' ? 'Fermer' : 'Close', openTrigger: "Menu", class: "gcds-mobile-nav", role: "menu", ref: element => (this.mobile = element), lang: lang }, index.h("slot", null)))));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsSignature = class {
  ...
  render() {
    ...
    index.h("a", { href: I18N$5[lang].link, innerHTML: selectSVG })) : (index.h("div", { class: "gcds-signature", innerHTML: selectSVG }))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
    "type": ["validateType"],
...
const GcdsStepper = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("h6", { class: "gcds-stepper" }, `${I18N$4[lang].step} ${currentStep} ${I18N$4[lang].of} ${totalSteps}`)));
  }
  get el() { return index.getElement(this); }
};
...
const GcdsText = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: `${display != 'block' ? `d-${display}` : ''}` }, index.h("p", { class: `
            ...
            ${marginTop ? `mt-${marginTop}` : ''}
            ${marginBottom ? `mb-${marginBottom}` : ''}
          ` }, size === 'caption' ? (index.h("small", null, index.h("slot", null))) : (index.h("slot", null)))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const gcdsTextareaCss = ".sc-gcds-textarea-h .gcds-textarea-wrapper.sc-gcds-textarea{border:0;color:var(--gcds-textarea-default-text);font:var(--gcds-textarea-font);margin:0;max-width:75ch;padding:0;-webkit-transition:color .15s ease-in-out;transition:color .15s ease-in-out;width:100%}.sc-gcds-textarea-h .gcds-textarea-wrapper.sc-gcds-textarea:focus-within{color:var(--gcds-textarea-focus-text)}.sc-gcds-textarea-h .gcds-textarea-wrapper.gcds-disabled.sc-gcds-textarea{color:var(--gcds-textarea-disabled-text)}.sc-gcds-textarea-h .gcds-textarea-wrapper.sc-gcds-textarea .error-message-container.sc-gcds-textarea{display:block}.sc-gcds-textarea-h textarea.sc-gcds-textarea{background-color:var(--gcds-textarea-default-background);background-image:none;border:var(--gcds-textarea-border-width) solid;border-radius:var(--gcds-textarea-border-radius);-webkit-box-sizing:border-box;box-sizing:border-box;color:var(--gcds-textarea-default-text);display:block;font:inherit;height:auto;margin:var(--gcds-textarea-margin);max-width:100%;min-height:var(--gcds-textarea-min-height);min-width:50%;padding:var(--gcds-textarea-padding);-webkit-transition:border-color .15s ease-in-out,outline .15s ease-in-out,-webkit-box-shadow .15s ease-in-out;transition:border-color .15s ease-in-out,outline .15s ease-in-out,-webkit-box-shadow .15s ease-in-out;transition:border-color .15s ease-in-out,box-shadow .15s ease-in-out,outline .15s ease-in-out;transition:border-color .15s ease-in-out,box-shadow .15s ease-in-out,outline .15s ease-in-out,-webkit-box-shadow .15s ease-in-out;width:100%}.sc-gcds-textarea-h textarea.sc-gcds-textarea:focus{border-color:var(--gcds-textarea-focus-text);-webkit-box-shadow:var(--gcds-textarea-focus-box-shadow);box-shadow:var(--gcds-textarea-focus-box-shadow);outline:var(--gcds-textarea-outline-width) solid var(--gcds-textarea-focus-text);outline-offset:var(--gcds-textarea-border-width)}.sc-gcds-textarea-h textarea.sc-gcds-textarea:disabled{background-color:var(--gcds-textarea-disabled-background);border-color:var(--gcds-textarea-disabled-text);cursor:not-allowed}.sc-gcds-textarea-h textarea.gcds-error.sc-gcds-textarea:not(:focus){border-color:var(--gcds-textarea-danger-border)}";
...
const GcdsTextarea = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: `gcds-textarea-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, index.h("gcds-label", Object.assign({}, attrsLabel, { "hide-label": hideLabel, "label-for": textareaId, lang: lang })), hint ? index.h("gcds-hint", { hint: hint, "hint-id": textareaId }) : null, errorMessage ? (index.h("gcds-error-message", { messageId: textareaId, message: errorMessage })) : null, index.h("textarea", Object.assign({}, attrsTextarea, { class: hasError ? 'gcds-error' : null, id: textareaId, name: textareaId, onBlur: e => this.onBlur(e), onFocus: e => this.onFocus(e), onInput: e => this.handleChange(e), "aria-labelledby": `label-for-${textareaId}`, "aria-invalid": errorMessage ? 'true' : 'false', maxlength: characterCount ? characterCount : null, style: cols ? style : null, ref: element => (this.shadowElement = element) }), value), characterCount ? (index.h("p", { id: `textarea__count-${textareaId}`, "aria-live": "polite" }, value == undefined
...
const GcdsTopNav = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("nav", { "aria-label": `${label}${I18N$2[lang].navLabel}`, class: "gcds-top-nav__container" }, index.h("gcds-nav-group", { menuLabel: "Menu", closeTrigger: lang == 'fr' ? 'Fermer' : 'Close', openTrigger: "Menu", class: "gcds-mobile-nav gcds-mobile-nav-topnav", ref: element => (this.mobile = element), lang: lang }, index.h("slot", { name: "home" }), index.h("ul", { role: "menu", class: `nav-container__list nav-list--${alignment}` }, index.h("slot", null))))));
  }
  get el() { return index.getElement(this); }
};
...
const gcdsTopicMenuCss = "@layer reset, default, mobile, xs-mobile, focus;@layer reset{:host *{-webkit-box-sizing:border-box;box-sizing:border-box;margin:0}}@layer default{:host{display:block}:host .gcds-topic-menu__heading,:host .gcds-topic-menu__main{display:inherit;height:0;margin:0;overflow:hidden;width:0}:host .visible-sm-inline{display:none}:host .gcds-topic-menu{font:var(--gcds-topic-menu-font);margin-inline:auto;max-width:var(--gcds-topic-menu-max-width);position:relative;width:90%}:host .gcds-topic-menu button[aria-haspopup=true]{background-color:var(--gcds-topic-menu-button-background);border:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-button-border);color:var(--gcds-topic-menu-button-text);cursor:pointer;font:var(--gcds-topic-menu-button-font);-webkit-margin-start:0;margin-inline-start:0;padding:var(--gcds-topic-menu-button-padding);text-transform:uppercase}:host .gcds-topic-menu button[aria-haspopup=true].gcds-topic-menu--home{background-color:var(--gcds-topic-menu-button-home-background);border-color:var(--gcds-topic-menu-button-home-border-color);color:var(--gcds-topic-menu-button-home-text)}:host .gcds-topic-menu button[aria-haspopup=true]:hover,:host .gcds-topic-menu button[aria-haspopup=true][aria-expanded=true]{background-color:var(--gcds-topic-menu-button-expanded-background);border-color:var(--gcds-topic-menu-button-expanded-border-color);color:var(--gcds-topic-menu-button-expanded-text)}:host .gcds-topic-menu [aria-haspopup=true][aria-expanded=false]+[role=menu]{display:none}:host .gcds-topic-menu button[aria-haspopup=true][aria-expanded=true]+[role=menu]{z-index:9999}:host .gcds-topic-menu button[aria-haspopup=true][aria-expanded=true]+[role=menu] [role=menuitem]{position:relative;z-index:9999}:host .gcds-topic-menu [aria-haspopup=true][aria-expanded=true]+[role=menu]{z-index:9998}:host .gcds-topic-menu [role=menu]{background-color:var(--gcds-topic-menu-themelist-background);color:var(--gcds-topic-menu-themelist-text);list-style:none;margin:0;padding:0;position:absolute;width:var(--gcds-topic-menu-themelist-width)}:host .gcds-topic-menu [role=menu]>li{-webkit-border-start:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-themelist-item-border);border-inline-start:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-themelist-item-border)}:host .gcds-topic-menu [role=menu]>li:first-child{-webkit-border-before:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-themelist-item-border);border-block-start:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-themelist-item-border)}:host .gcds-topic-menu [role=menu]>li:last-child{-webkit-border-after:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-themelist-item-border);border-block-end:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-themelist-item-border)}:host .gcds-topic-menu [role=menu] [role=menu]{background-color:var(--gcds-topic-menu-topiclist-background);-webkit-border-before:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-topiclist-border);border-block-start:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-topiclist-border);-webkit-box-shadow:var(--gcds-topic-menu-topiclist-box-shadow);box-shadow:var(--gcds-topic-menu-topiclist-box-shadow);color:var(--gcds-topic-menu-topiclist-text);left:var(--gcds-topic-menu-topiclist-left);-webkit-margin-after:var(--gcds-topic-menu-topiclist-margin-block-end);margin-block-end:var(--gcds-topic-menu-topiclist-margin-block-end);min-height:var(--gcds-topic-menu-topiclist-min-height);padding:var(--gcds-topic-menu-topiclist-padding);top:0;width:var(--gcds-topic-menu-topiclist-width)}:host .gcds-topic-menu [role=menu] [role=menu] li{border:none;width:45%}:host .gcds-topic-menu [role=menu] [role=menu] li [role=menuitem]{-webkit-border-after:none;border-block-end:none;-webkit-border-end:none;border-inline-end:none;color:var(--gcds-topic-menu-topiclist-menuitem-text);padding:var(--gcds-topic-menu-topiclist-menuitem-padding);text-decoration:underline;width:auto}:host .gcds-topic-menu [role=menu] [role=menu] li [role=menuitem][aria-haspopup=true],:host .gcds-topic-menu [role=menu] [role=menu] li [role=menuitem][aria-haspopup=true]:hover{color:var(--gcds-topic-menu-topiclist-menuitem-popup-text);font:var(--gcds-topic-menu-topiclist-menuitem-popup-font);text-decoration:none}:host .gcds-topic-menu [role=menu] [role=menu] li [role=menuitem]:hover{color:var(--gcds-topic-menu-topiclist-menuitem-hover-text);text-decoration-thickness:var(\n                  --gcds-topic-menu-topiclist-menuitem-hover-text-decoration-thickness\n                )}:host .gcds-topic-menu [role=menu] [role=menu] li:first-child{-webkit-margin-after:var(\n                --gcds-topic-menu-topiclist-item-first-margin-block-end\n              );margin-block-end:var(\n                --gcds-topic-menu-topiclist-item-first-margin-block-end\n              );width:100%}:host .gcds-topic-menu [role=menu] [role=menu] li:first-child [role=menuitem]{font:var(--gcds-topic-menu-topiclist-item-first-font);text-decoration:underline}:host .gcds-topic-menu [role=menu] [role=menu] li:last-child{left:var(--gcds-topic-menu-topiclist-item-last-left);position:absolute;top:var(--gcds-topic-menu-topiclist-item-last-top)}:host .gcds-topic-menu [role=menu] [role=menu] li:last-child [aria-expanded=true]{background:transparent}:host .gcds-topic-menu [role=menu] [role=menu] li:last-child [role=menu]{list-style:disc;-webkit-padding-before:0;padding-block-start:0}:host .gcds-topic-menu [role=menu] [role=menu] [role=menu]{background:transparent;-webkit-border-before:none;border-block-start:none;-webkit-box-shadow:none;box-shadow:none;left:auto;min-height:auto;top:auto;width:auto}:host .gcds-topic-menu [role=menu] [role=menu] [role=menu] li{width:var(--gcds-topic-menu-mostrequested-item-width)}:host .gcds-topic-menu [role=menu] [role=menu] [role=menu] li:first-child{-webkit-margin-after:var(\n                  --gcds-topic-menu-mostrequested-item-first-margin-block-end\n                );margin-block-end:var(\n                  --gcds-topic-menu-mostrequested-item-first-margin-block-end\n                )}:host .gcds-topic-menu [role=menu] [role=menu] [role=menu] li:first-child [role=menuitem]{font:var(--gcds-topic-menu-mostrequested-item-first-font);text-decoration:underline;width:auto}:host .gcds-topic-menu [role=menu] [role=menu] [role=menu] li:last-child{left:auto;position:relative;top:auto}@media screen and (min-width:61.9375rem) and (max-width:74.9375rem){:host .gcds-topic-menu [role=menu] [role=menu] li{width:auto}:host .gcds-topic-menu [role=menu] [role=menu] li:last-child{left:auto;-webkit-margin-before:var(\n                --gcds-topic-menu-mostrequested-item-last-margin-block-start\n              );margin-block-start:var(\n                --gcds-topic-menu-mostrequested-item-last-margin-block-start\n              );position:relative;top:auto}:host .gcds-topic-menu [role=menu] [role=menu] [role=menu]{-webkit-margin-after:0;margin-block-end:0;-webkit-padding-after:0;padding-block-end:0;position:relative}:host .gcds-topic-menu [role=menu] [role=menu] [role=menu] li:last-child{-webkit-margin-before:0;margin-block-start:0}}:host .gcds-topic-menu [role=menuitem],:host .gcds-topic-menu [role=menuitem]:visited{-webkit-border-after:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-menuitem-border-block-end);border-block-end:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-menuitem-border-block-end);-webkit-border-end:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-menuitem-border-inline-end);border-inline-end:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-menuitem-border-inline-end);-webkit-box-sizing:border-box;box-sizing:border-box;color:var(--gcds-topic-menu-menuitem-text);display:block;font:var(--gcds-topic-menu-menuitem-font);padding:var(--gcds-topic-menu-menuitem-padding);text-decoration:none;text-underline-offset:var(\n          --gcds-topic-menu-menuitem-text-underline-offset\n        );width:var(--gcds-topic-menu-menuitem-width)}:host .gcds-topic-menu [role=menuitem]:hover,:host .gcds-topic-menu [role=menuitem]:visited:hover,:host .gcds-topic-menu [role=menuitem]:visited[aria-expanded=true],:host .gcds-topic-menu [role=menuitem][aria-expanded=true]{background-color:var(--gcds-topic-menu-menuitem-expanded-background);color:var(--gcds-topic-menu-menuitem-expanded-text)}}@layer mobile{@media screen and (max-width:61.9375rem){:host .gcds-topic-menu .visible-sm-inline{display:inline-block;text-decoration:underline}:host .gcds-topic-menu .hidden-sm{display:none}:host .gcds-topic-menu [role=menu]{-webkit-margin-after:var(\n            --gcds-topic-menu-mobile-themelist-margin-block-start\n          );margin-block-end:var(\n            --gcds-topic-menu-mobile-themelist-margin-block-start\n          );position:static;width:auto}:host .gcds-topic-menu [role=menu] [role=menu]{-webkit-border-before:none;border-block-start:none;-webkit-box-shadow:none;box-shadow:none;-webkit-margin-after:0;margin-block-end:0;min-height:auto;padding:0;width:auto}:host .gcds-topic-menu [role=menu] [role=menu] li{width:auto}:host .gcds-topic-menu [role=menu] [role=menu] li [role=menuitem]{-webkit-border-after:var(--gcds-topic-menu-border-width) solid var(\n                    --gcds-topic-menu-mobile-topiclist-menuitem-border-block-end\n                  );border-block-end:var(--gcds-topic-menu-border-width) solid var(\n                    --gcds-topic-menu-mobile-topiclist-menuitem-border-block-end\n                  );padding:var(\n                  --gcds-topic-menu-mobile-topiclist-menuitem-padding\n                )}:host .gcds-topic-menu [role=menu] [role=menu] li [role=menuitem]:hover{background-color:transparent;color:var(\n                    --gcds-topic-menu-mobile-topiclist-menuitem-hover-text\n                  )}:host .gcds-topic-menu [role=menu] [role=menu] li [role=menuitem][aria-haspopup]{font:var(\n                    --gcds-topic-menu-mobile-topiclist-menuitem-haspopup-font\n                  )}:host .gcds-topic-menu [role=menu] [role=menu] li:first-child{-webkit-margin-after:0;margin-block-end:0}:host .gcds-topic-menu [role=menu] [role=menu] li:first-child [role=menuitem]{-webkit-border-after:var(--gcds-topic-menu-border-width) solid var(\n                    --gcds-topic-menu-mobile-topiclist-item-first-menuitem-border\n                  );border-block-end:var(--gcds-topic-menu-border-width) solid var(\n                    --gcds-topic-menu-mobile-topiclist-item-first-menuitem-border\n                  );color:var(\n                  --gcds-topic-menu-mobile-topiclist-item-first-menuitem-text\n                );font:var(\n                  --gcds-topic-menu-mobile-topiclist-menuitem-haspopup-font\n                );text-decoration:underline;width:auto}:host .gcds-topic-menu [role=menu] [role=menu] li:last-child{left:auto;position:static;top:auto}:host .gcds-topic-menu [role=menu] [role=menu] li:last-child [role=menuitem]{-webkit-border-after:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-mobile-mostrequested-border);border-block-end:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-mobile-mostrequested-border);color:var(\n                  --gcds-topic-menu-mobile-topiclist-item-last-menuitem-text\n                );text-decoration:none}:host .gcds-topic-menu [role=menu] [role=menu] li:last-child [role=menuitem]:hover{color:var(\n                    --gcds-topic-menu-mobile-topiclist-item-last-menuitem-hover-text\n                  );text-decoration:underline}:host .gcds-topic-menu [role=menu] [role=menu] li:last-child [role=menu]{list-style:none;-webkit-padding-before:0;padding-block-start:0}:host .gcds-topic-menu [role=menu] [role=menu] li:last-child [role=menu] li{width:auto}:host .gcds-topic-menu [role=menu] [role=menu] li:last-child [role=menu] li [role=menuitem]{-webkit-border-after:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-mobile-mostrequested-border);border-block-end:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-mobile-mostrequested-border)}:host .gcds-topic-menu [role=menu] [role=menu] li:last-child [role=menu] li [role=menuitem]:hover{color:var(\n                        --gcds-topic-menu-mobile-mostrequested-hover-text\n                      );text-decoration:underline}:host .gcds-topic-menu [role=menu] [role=menu] li:first-child,:host .gcds-topic-menu [role=menu] [role=menu] li:last-child{background-color:var(\n                --gcds-topic-menu-mobile-mostrequested-background\n              )}:host .gcds-topic-menu [role=menuitem]{width:auto}:host .gcds-topic-menu [aria-expanded=true]:not(button)+[role=menu] li{-webkit-margin-start:var(\n                --gcds-topic-menu-mobile-item-expanded-margin-inline-start\n              );margin-inline-start:var(\n                --gcds-topic-menu-mobile-item-expanded-margin-inline-start\n              )}:host .gcds-topic-menu [aria-expanded=true]:not(button)+[role=menu] li:first-child,:host .gcds-topic-menu [aria-expanded=true]:not(button)+[role=menu] li:last-child{-webkit-margin-start:0;margin-inline-start:0}:host .gcds-topic-menu [aria-expanded=true]:not(button)+[role=menu] li:first-child [role=menuitem],:host .gcds-topic-menu [aria-expanded=true]:not(button)+[role=menu] li:last-child [role=menuitem]{-webkit-padding-start:var(\n                    --gcds-topic-menu-mobile-item-expanded-padding-inline-start\n                  );padding-inline-start:var(\n                    --gcds-topic-menu-mobile-item-expanded-padding-inline-start\n                  )}:host .gcds-topic-menu [aria-expanded=true]:not(button)+[role=menu] li:last-child [role=menu] [role=menuitem]{-webkit-padding-start:0;padding-inline-start:0}:host .gcds-topic-menu [aria-expanded=true]:not(button)+[role=menu] [role=menu] li{-webkit-margin-start:var(\n                --gcds-topic-menu-mobile-mostrequested-expanded-margin-inline-start\n              );margin-inline-start:var(\n                --gcds-topic-menu-mobile-mostrequested-expanded-margin-inline-start\n              )}:host .gcds-topic-menu [aria-expanded=true]+[role=menu] [role=menu] [role=menu]{background-color:var(\n              --gcds-topic-menu-mobile-mostrequested-background\n            )}:host .gcds-topic-menu [aria-haspopup]:not(button):before{content:\"\\25BA\\a0\"}:host .gcds-topic-menu [aria-haspopup][aria-expanded=true]:not(button):before{content:\"\\25BC\\a0\"}:host .gcds-topic-menu button[aria-haspopup=true][aria-expanded=true]+[role=menu]{-webkit-border-end:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-mobile-themelist-border);border-inline-end:var(--gcds-topic-menu-border-width) solid var(--gcds-topic-menu-mobile-themelist-border)}}}@layer xs-mobile{@media screen and (max-width:47.9375rem){:host .gcds-topic-menu>[role=menu]{margin-inline:calc(-50vw - -50%)}}}@layer focus{:host .gcds-topic-menu [role=menuitem]:focus,:host .gcds-topic-menu button[aria-haspopup=true]:focus{background-color:var(--gcds-topic-menu-focus-background);border-color:var(--gcds-topic-menu-focus-background);-webkit-border-end:none;border-inline-end:none;border-radius:var(--gcds-topic-menu-focus-border-radius);-webkit-box-shadow:var(--gcds-topic-menu-focus-box-shadow);box-shadow:var(--gcds-topic-menu-focus-box-shadow);color:var(--gcds-topic-menu-focus-text);outline:var(--gcds-topic-menu-focus-outline);outline-offset:var(--gcds-topic-menu-focus-outline-offset)}}";
...
const GcdsTopicMenu = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("nav", { class: "gcds-topic-menu" }, index.h("h2", { class: "gcds-topic-menu__heading" }, "Menu"), index.h("button", { "aria-haspopup": "true", "aria-expanded": this.open.toString(), "aria-label": I18N$1[lang].buttonLabel, onClick: async () => await this.toggleNav(), ref: element => (this.menuButton = element), class: home && 'gcds-topic-menu--home' }, this.lang == 'en' ? (index.h(index.Fragment, null, index.h("span", { class: "gcds-topic-menu__main" }, "Main "), "Menu")) : (index.h(index.Fragment, null, "Menu", index.h("span", { class: "gcds-topic-menu__main" }, " principal"))), index.h("gcds-icon", { name: "chevron-down", "margin-left": "150", size: "caption" })), index.h("ul", { role: "menu", "aria-orientation": "vertical", "data-top-menu": true, innerHTML: this.listItems, ref: element => (this.themeList = element) }))));
  }
  get el() { return index.getElement(this); }
};
