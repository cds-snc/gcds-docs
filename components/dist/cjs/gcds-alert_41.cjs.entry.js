...
GcdsCheckboxes.style = GcdsCheckboxesStyle0;
...
const GcdsErrorSummary = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '921bc4798b6c8ce0e52cc0e8377548d2f9f90a06' }, index.h("div", { key: 'c88ac2207f650dfcf2afc92c2382261e6062103d', role: "alert", tabindex: "-1", ref: element => (this.shadowElement = element), class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0
                ? 'gcds-show'
                : ''}` }, index.h("gcds-heading", { key: '3503d99d5747612a36354097ebe466c88311e4dc', tag: "h2", "margin-top": "0", "margin-bottom": "225" }, heading !== null && heading !== void 0 ? heading : I18N$k[lang].heading), index.h("ol", { key: '0751c01bfe6c44457fb9923c814fa1831aae4444', class: "summary__errorlist" }, (hasSubmitted || errorLinks) &&
...
const GcdsFooter = class {
    ...
    render() {
        ...
        let subLinkCount = 0;
        return (index.h(index.Host, { key: '5837980656caab330e544099513140319f21bf2b', role: "contentinfo", "aria-label": "Footer" }, index.h("gcds-sr-only", { key: '224923db016c4e7487a21e0c738b075b488b6af9', tag: "h2" }, I18N$i[lang].about), contextualLinksObject && contextualHeading && (index.h("div", { key: '6e59417fd295f8ad99f56ed6b2d60cadff12905f', class: "gcds-footer__contextual" }, index.h("div", { key: 'eed81cfd3b34bb7c55bb640b37770c11075add60', class: "contextual__container" }, index.h("nav", { key: '5bcc993b76d9bbbd45accce9800cd85db91d120e', "aria-labelledby": "contextual__heading" }, index.h("h3", { key: '7180a682e2c50b500dda0ce979fe511ca65a4e43', id: "contextual__heading", class: "contextual__heading" }, contextualHeading), index.h("ul", { key: '043ca05a01cf7a8161589839c8164d0001727759', class: "contextual__list" }, Object.keys(contextualLinksObject).map(key => {
            if (contextualLinkCount < 3) {
                contextualLinkCount++;
                return (index.h("li", null, index.h("gcds-link", { size: "small", href: contextualLinksObject[key] }, key)));
            }
        })))))), display === 'full' ? (index.h("div", { class: "gcds-footer__main" }, index.h("div", { class: "main__container" }, index.h("nav", { class: "main__govnav", "aria-labelledby": "govnav__heading" }, index.h("h3", { id: "govnav__heading" }, I18N$i[lang].gov.heading), index.h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (index.h("li", null, index.h("gcds-link", { size: "small", href: govNav[value].link }, govNav[value].text)))))), index.h("nav", { class: "main__themenav", "aria-labelledby": "themenav__heading" }, index.h("gcds-sr-only", { tag: "h4", id: "themenav__heading" }, I18N$i[lang].themes.heading), index.h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (index.h("li", null, index.h("gcds-link", { size: "small", href: themeNav[value].link }, themeNav[value].text))))))))) : null, index.h("div", { key: 'c220125a35a924a3acb840cf186b4cc5e09d865e', class: "gcds-footer__sub" }, index.h("div", { key: '5efa5ad5f42d7a4482a33f023acd68b5831ad429', class: "sub__container" }, index.h("nav", { key: '8c239b963a088c9b9dc2281b0c60e56ce2fcc7a2', "aria-labelledby": "sub__heading" }, index.h("gcds-sr-only", { key: 'fbeb0d6c5b102fdd6de322bcd56e54d4ba91dca2', tag: "h3", id: "sub__heading" }, I18N$i[lang].site.heading), index.h("ul", { key: 'f76aa2db981e25762466367ad9ca887c0fdd72b6' }, subLinks
...
const GcdsLabel = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9e726e5b4bfe04e7b5d4a9e35a177df57ab1badc', id: `label-for-${labelFor}` }, index.h("label", { key: '8026d5f89beea7d000e0b78891e0c11ca24eed19', htmlFor: labelFor, class: `gcds-label ${hideLabel ? 'label--hidden' : ''}` }, index.h("span", { key: '219be69e62f0b64f6afc816bf7b334670a8e68e1' }, label), required ? (index.h("span", { "aria-hidden": "true", class: "label--required" }, "(", I18N$e[lang].required, ")")) : null)));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsNavGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2e0fa8db039fb51abfa907fcffff16d1afea585b', role: "listitem", open: open }, index.h("button", { key: '53fe4debf8d01896f05eba8ccadcf98c9930aede', "aria-haspopup": "true", tabIndex: 0, "aria-expanded": open.toString(), ref: element => (this.triggerElement = element), class: `gcds-nav-group__trigger gcds-trigger--${this.navStyle}`, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => {
                const event = utils.emitEvent(e, this.gcdsClick);
                if (event) {
                    this.toggleNav();
                }
            } }, index.h("gcds-icon", { key: 'b839ff9e0618be4a075573ec6e07eac1c77be3ae', name: open ? 'chevron-up' : 'chevron-down' }), closeTrigger && open ? closeTrigger : openTrigger), index.h("ul", { key: 'e5d277b9cc733f578e9fee9dbed70f9d430d04ec', "aria-label": menuLabel, class: `gcds-nav-group__list gcds-nav--${this.navStyle}` }, index.h("slot", { key: 'e459a603ff49e2f646b65f0a888bcaada34cb50a' }))));
    }
    get el() { return index.getElement(this); }
};
    ...
    configurePaginationStep(page, end, mobile) {
        ...
        if (end) {
            return (index.h("li", null, end === 'next' ? (index.h("a", Object.assign({}, linkAttrs, { class: !mobile
                    ...
                    : 'gcds-pagination-end-button-mobile' }), index.h("span", null, I18N$a[this.lang].next), index.h("gcds-icon", { "margin-left": "150", name: "chevron-right" }))) : (index.h("a", Object.assign({}, linkAttrs, { class: !mobile
                    ? 'gcds-pagination-end-button'
...
GcdsRadios.style = GcdsRadiosStyle0;
...
const SignatureEn = `<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 819 78" preserveAspectRatio="xMinYMin meet" role="img" aria-labelledby="signature-en-title">
...
const SignatureFr = `<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 819 78" preserveAspectRatio="xMinYMin meet" role="img" aria-labelledby="signature-fr-title">
...
const GcdsTopicMenu = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '11a4e6cac47292c67d67f2860368ad937610475e' }, index.h("nav", { key: '9649d4b517f8a95ccfcbf5130a3429c639d45e1a', class: "gcds-topic-menu", "aria-labelledby": "gcds-topic-menu__heading" }, index.h("gcds-sr-only", { key: '8b11792760daf57c8991c78b0258dba19f78d57f', id: "gcds-topic-menu__heading", tag: "h2" }, I18N$1[lang].menuLabelFull), index.h("button", { key: '41190295fe3d65d13aa28f44fedf010bef4059d6', "aria-haspopup": "true", "aria-expanded": this.open.toString(), "aria-label": I18N$1[lang].buttonLabel, onClick: async () => await this.toggleNav(), ref: element => (this.menuButton = element), class: home && 'gcds-topic-menu--home' }, this.lang == 'en' ? (index.h(index.Fragment, null, index.h("gcds-sr-only", { tag: "span" }, I18N$1[lang].menuLabelHidden), I18N$1[lang].menuToggle)) : (index.h(index.Fragment, null, I18N$1[lang].menuToggle, index.h("gcds-sr-only", { tag: "span" }, I18N$1[lang].menuLabelHidden))), index.h("gcds-icon", { key: '1f378ba85facaa6aa9610ef2cf45b504870b7064', name: "chevron-down", "margin-left": "100", size: "text-small" })), index.h("ul", { key: 'a9250f162fe7f32ec9c0b561366d2723834e0990', role: "menu", "aria-orientation": "vertical", "data-top-menu": true, innerHTML: this.listItems, ref: element => (this.themeList = element) }))));
    }
    get el() { return index.getElement(this); }
};
