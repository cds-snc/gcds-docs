...
const GcdsSignature = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7fea220f14547470c38927cbb0d4c73c51cab70a' }, type === 'signature' ? (index.h(Tag, Object.assign({}, sigAttrs), index.h("div", { innerHTML: selectSVG }), svgLabel)) : (index.h("div", { class: "gcds-signature", innerHTML: selectSVG }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "type": ["validateType"],
...
const GcdsText = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a812309ef1f42e139d5cff1db4c83d2b1b7e3df5', class: `${display != 'block' ? `d-${display}` : ''}` }, index.h("p", { key: '044d31b7287fd57599acb2f4943c006552bd07b9', class: `
            gcds-text
