...
const GcdsAlert = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f0856a42192ff33a6157989152da33915175b3a7' }, isOpen ? (index.h("div", { class: `gcds-alert alert--role-${alertRole} ${isFixed ? 'alert--is-fixed' : ''}`, role: "alert", "aria-label": alertRole === 'danger'
            ...
            }, "aria-label": I18N$p[lang].closeBtn }, index.h("gcds-icon", { "aria-hidden": "true", name: "times", size: "text" }))))))) : null));
    }
...
const GcdsButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '956926cbc6e721d3f0bf7cbecef1641cb2d73c35' }, index.h(Tag, Object.assign({ key: 'd95ca1ef288deea20301ffe0975ed0260f1fc4c2' }, attrs, { id: buttonId, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => !disabled && this.handleClick(e), class: `gcds-button button--role-${buttonRole} button--${size}`, ref: element => (this.shadowElement = element) }, inheritedAttributes, { part: "button" }), index.h("slot", { key: '5e8ad081fc6d94be991705613aa5e0cb2d8880e8' }), type === 'link' && target === '_blank' ? (index.h("gcds-icon", { name: "external-link", label: I18N$n[lang].label, "margin-left": "150" })) : null)));
    }
...
const GcdsCard = class {
    ...
    render() {
        ...
        if (this.validateRequiredProps()) {
            return (index.h(index.Host, { key: '1ca25f4b643e43fbfd1c44acc397921f30f32d8f' }, index.h("div", { key: 'ceb107cae158eaee0c3c545cd7f17b104742ac6a', class: "gcds-card" }, badge && !errors.includes('badge') && (index.h("gcds-text", { key: '2fdbe2d8fb6ee0526cc81a4a27bd43d8a4c05353', id: "gcds-badge", class: "gcds-badge", "text-role": "light", "margin-bottom": "0", size: "small" }, index.h("strong", { key: '4f3abc137cc4825a59a50f992b97a2f9b2d2cfa4' }, index.h("gcds-sr-only", { key: 'fe5592bd351ceb2017acb1822ccf39efb292abb7' }, I18N$m[lang].tagged), badge))), imgSrc && (index.h("img", { key: 'c3b94f98e9900ad8b5acc82dc8f1db56ae38496e', src: imgSrc, alt: imgAlt ? imgAlt : '', class: "gcds-card__image" })), Element != 'a' ? (index.h(Element, Object.assign({ class: "gcds-card__title" }, taggedAttr), index.h("gcds-link", { href: href }, cardTitle))) : (index.h("gcds-link", Object.assign({ href: href, class: "gcds-card__title" }, taggedAttr), cardTitle)), renderDescription)));
        }
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const GcdsContainer = class {
    ...
    render() {
        ...
        const Tag = tag;
        return (index.h(index.Host, { key: '1a0d300e83cc191fccd62309d50acf2651fcf0de' }, index.h(Tag, { key: '57ebd74a5c1ffce5d67f85cac933bf108f36b450', class: `
            gcds-container
            ...
            ${padding ? `p-${padding}` : ''}
            ${size ? `size-${size}` : ''}
          ` }, index.h("slot", { key: '8ad3d9262e75693298a9a567aac2b9731c5ad96d' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsDateInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd9388aa00239180b8f9a657cd188748c2d1babce', name: name, onBlur: () => this.onBlur() }, this.validateRequiredProps() && (index.h("fieldset", Object.assign({ key: '1004ff844a1231495b95d598d9880ac03284464a', class: "gcds-date-input__fieldset" }, fieldsetAttrs), index.h("legend", { key: '0fea4a4db52510952d1911773a4f0d45b8af0b89', id: "date-input-legend" }, legend, required ? (index.h("span", { class: "legend__required" }, I18N$l[lang].required)) : null), hint ? (index.h("gcds-hint", { id: "date-input-hint", "hint-id": "date-input" }, hint)) : null, errorMessage ? (index.h("div", null, index.h("gcds-error-message", { id: "date-input-error", messageId: "date-input" }, errorMessage))) : null, format == 'compact'
            ? [month, year]
            : lang == 'en'
                ? [month, day, year]
                : [day, month, year]))));
...
const GcdsDateModified = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f63e29a192d3a4d658ca78335b064e84e4143c5b' }, this.validateRequiredProps() && (index.h("dl", { key: '934f13de2562460ebb81b01b19a969c5fca4604c', class: "gcds-date-modified" }, index.h("dt", { key: '71a5ff2bdcf6c6d7aaf857d459b7c465d13a7ab3' }, index.h("gcds-text", { key: 'b8ad0f896154c73fff49eb8e5f7aabc82a8fb6f0', display: "inline", "margin-bottom": "0" }, type === 'version' ? I18N$k[lang].version : I18N$k[lang].date)), index.h("dd", { key: '8624f50eb70cdfd7a448c6e5755235c729fa00f2' }, index.h("gcds-text", { key: '97c82c7759ea15d85f92dd19ebd40c24d010df13', display: "inline", "margin-bottom": "0" }, type === 'version' ? (index.h("slot", null)) : (index.h("time", null, index.h("slot", null)))))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsDetails = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '17839f99ea3d7d6f190a7bc5df72d1e056e09b3c' }, index.h("div", { key: '5ebfa6b8c4b0317728ebb114a0dac1b3574ceda8', class: "gcds-details" }, index.h("button", { key: '3e02dfd0ca368a4758a79edbf2b125e721427ce3', "aria-expanded": open.toString(), "aria-controls": "details__panel", onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => {
                const event = emitEvent(e, this.gcdsClick);
                if (event) {
                    this.toggle();
                }
            }, class: "details__summary", id: "details__summary" }, detailsTitle), index.h("div", { key: 'a12601d1dcad1cff247c32a59aeacdbe14100c6f', id: "details__panel", class: "details__panel", "aria-labelledby": "details__summary" }, index.h("slot", { key: '11209ad4acd9a6f6d678e1fb7047b070339779b2' })))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsErrorMessage = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3f2e26f31e50359a0e1726d5f714dd678005cf01', id: `error-message-${messageId}`, class: "gcds-error-message-wrapper" }, index.h("gcds-text", { key: 'a8a20a16968e9a4578466f4fbeafb727077d7424', class: "error-message", role: "alert", "margin-bottom": "75" }, index.h("gcds-icon", { key: 'a54fc1a0bca6eba54fe1422f6210f42fb94ba348', name: "triangle-exclamation", "margin-right": "50" }), index.h("strong", { key: '64159579526bfb8df612dac7862048a447e30de2' }, index.h("slot", { key: '5c9a927de03b56f60b80fe97afe0de19f2e84ee4' })))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsErrorSummary = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'dd90e9455ea1a422d5f4559c62df271259923249' }, index.h("div", { key: 'bb61b6d2eea84aead7d06e0355b464bf2e2281bb', role: "alert", tabindex: "-1", ref: element => (this.shadowElement = element), class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0
                ? 'gcds-show'
                : ''}` }, index.h("gcds-heading", { key: '170edbb97c73a0928aaa571f33eee36b72fee740', tag: "h2", "margin-top": "0", "margin-bottom": "225" }, heading !== null && heading !== void 0 ? heading : I18N$j[lang].heading), index.h("ol", { key: 'ce1c06b5047c8a1632a955c3cb5d7ed833a7284b', class: "summary__errorlist" }, (hasSubmitted || errorLinks) &&
...
const GcdsFieldset = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '28b6b012db193345b89688a3a49c23f46304c285' }, index.h("fieldset", Object.assign({ key: 'f540690d1a3f4f5cc430b581aa0ad4acd37c0df5', class: `gcds-fieldset ${hasError ? 'gcds-fieldset--error' : ''}`, id: fieldsetId }, fieldsetAttrs, { "aria-labelledby": hint
                ? `legend-${fieldsetId} hint-${fieldsetId}`
                : `legend-${fieldsetId}`, tabindex: "-1", ref: element => (this.shadowElement = element) }), index.h("legend", { key: 'b95da10304c515c19ad7610b10bc1ec6671b9918', id: `legend-${fieldsetId}` }, legend, required ? (index.h("span", { class: "legend__required" }, "(", I18N$i[lang].required, ")")) : null), hint ? index.h("gcds-hint", { "hint-id": fieldsetId }, hint) : null, errorMessage ? (index.h("gcds-error-message", { messageId: fieldsetId }, errorMessage)) : null, index.h("slot", { key: '4b72b0dec46d47075fa3edd6c693e24fa146dd7f' }))));
    }
    static get delegatesFocus() { return true; }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const GcdsFooter = class {
    ...
    render() {
        ...
        let subLinkCount = 0;
        return (index.h(index.Host, { key: '80705536aaa53acb16c95fbadbedf2ba8c2b44aa', role: "contentinfo", "aria-label": "Footer" }, index.h("gcds-sr-only", { key: '40b4f1f47f89230a7570b8a2ede87eea289f9769', tag: "h2" }, I18N$g[lang].about), contextualLinksObject && contextualHeading && (index.h("div", { key: 'd068b2e3d3ea29ab9dd0f45e9065a920b6cea387', class: "gcds-footer__contextual" }, index.h("div", { key: '4a4b92b90a82bfd938555d009fbdc869145d23ce', class: "contextual__container" }, index.h("nav", { key: 'cad548536170a273339c72fcf2d99d007c5c9a93', "aria-labelledby": "contextual__heading" }, index.h("h3", { key: '072647a4600ae33264bd19ffa7ee82fc1affa3cb', id: "contextual__heading", class: "contextual__heading" }, contextualHeading), index.h("ul", { key: '60d5f1368912a10b3e00528ee2f9a04d1aa7aa00', class: "contextual__list" }, Object.keys(contextualLinksObject).map(key => {
            if (contextualLinkCount < 3) {
                contextualLinkCount++;
                return (index.h("li", null, index.h("gcds-link", { size: "small", href: contextualLinksObject[key] }, key)));
            }
        })))))), display === 'full' ? (index.h("div", { class: "gcds-footer__main" }, index.h("div", { class: "main__container" }, index.h("nav", { class: "main__govnav", "aria-labelledby": "govnav__heading" }, index.h("h3", { id: "govnav__heading" }, I18N$g[lang].gov.heading), index.h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (index.h("li", null, index.h("gcds-link", { size: "small", href: govNav[value].link }, govNav[value].text)))))), index.h("nav", { class: "main__themenav", "aria-labelledby": "themenav__heading" }, index.h("gcds-sr-only", { tag: "h4", id: "themenav__heading" }, I18N$g[lang].themes.heading), index.h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (index.h("li", null, index.h("gcds-link", { size: "small", href: themeNav[value].link }, themeNav[value].text))))))))) : null, index.h("div", { key: 'f7e8acd7c6fe841e938510189fdf641ca9c22fe4', class: "gcds-footer__sub" }, index.h("div", { key: 'f9823441ebec110b002d0e08806e79ae745c3110', class: "sub__container" }, index.h("nav", { key: '12d8f65435c6435ac713fbd14d2659fcd013ba17', "aria-labelledby": "sub__heading" }, index.h("gcds-sr-only", { key: 'db80c42c3402e9d8cbfbc145e756bdcf0e7029c2', tag: "h3", id: "sub__heading" }, I18N$g[lang].site.heading), index.h("ul", { key: 'a78aef708a0aa3eb030e7e83961bbe32175c7302' }, subLinks
...
const GcdsGrid = class {
    ...
    `;
        ...
        return (index.h(index.Host, null, container ? (index.h("gcds-container", { size: container, centered: centered }, index.h(Tag, { class: classNames, style: handleGridStyles() }, index.h("slot", null)))) : (index.h(Tag, { class: classNames, style: handleGridStyles() }, index.h("slot", null)))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "gap": ["validateGap"],
...
const GcdsHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6efd0f4e2348ee9cf535345da9b29fa09e02bced', role: "banner" }, renderSkipToNav, hasBanner ? index.h("slot", { name: "banner" }) : null, index.h("div", { key: '3e3a968e58e1e43c1495947549b0699b205075c5', class: "gcds-header__brand" }, index.h("div", { key: 'fcede179bafd3b6d2a2825e38db8f6c067e4f413', class: `brand__container ${!hasSearch ? 'container--simple' : ''}` }, renderToggle, renderSignature, renderSearch)), index.h("slot", { key: 'd282b219be7cd92f9acd02b53fa68a89a87ea1b4', name: "menu" }), hasBreadcrumb ? (index.h("div", { class: "gcds-header__container" }, index.h("slot", { name: "breadcrumb" }))) : null));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsHeading = class {
    ...
    render() {
        ...
        const Tag = tag;
        return (index.h(index.Host, { key: 'b2f8e7fc2e0137c303657c7b6ead41f1911ed975' }, index.h(Tag, { key: '136f5f9083247a238aeeb58c72e3fb5e862956c3', class: `
            gcds-heading
            ${characterLimit ? 'limit' : ''}
            ${marginTop ? `mt-${marginTop}` : ''}
            ${marginBottom ? `mb-${marginBottom}` : ''}
          ` }, index.h("slot", { key: '881ac6dfd723d6352b8eb95937b1e340f38d26e1' }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "tag": ["validateTag"],
...
const GcdsHint = class {
    ...
    render() {
        const { hintId } = this;
        return (index.h(index.Host, { key: '8e9af18f71f043062a78de179236357539afe979', id: `hint-${hintId}` }, index.h("gcds-text", { key: 'bac3fc4edbbb00b2191989bc155636aa0ab6c68c', class: "gcds-hint", "margin-bottom": "0", part: "hint" }, index.h("slot", { key: '1fdb52992e56952156704305469a85e30b2bb398' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsIcon = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2ba6e3bf5ef68108bb38fefe0b11dd1b22d8345c' }, index.h("span", { key: 'c16c9011acc22297bad00b8342da08c22273f307', class: `
...
const GcdsLabel = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2f4fe7a9d0a0fcea5019edc8158adae424074428', id: `label-for-${labelFor}`, onClick: this.onClick }, index.h("label", { key: '721461d1eb5818ff6b28f06bb314e27a5c0eb0c5', htmlFor: labelFor, class: `gcds-label ${hideLabel ? 'label--hidden' : ''}`, ref: focusEl => (this.focusEl = focusEl) }, index.h("span", { key: '0564e25540c9a5ec81fbbba77c72e2892d5ccc51' }, label), required ? (index.h("span", { "aria-hidden": "true", class: "label--required" }, "(", I18N$d[lang].required, ")")) : null)));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsLangToggle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '05fc4f7ec61276b9e15ccb9fe75f257049bf3577' }, index.h("div", { key: 'dc156971e988f7c4024ad760777e27f65c30b533', class: "gcds-lang-toggle" }, index.h("gcds-sr-only", { key: 'dae3c2e582bbe214f9ec8422bacc3f6bb5f61dfe', id: "lang-toggle__heading", tag: "h2" }, I18N$c[lang].heading), index.h("gcds-link", { key: '6bf0e599cace009ab90efce6a355389b3374e8a7', size: "regular", href: href, lang: I18N$c[lang].abbreviation }, index.h("span", { key: 'cba5121aac09ac07fabc7c409653d83126f1da9d' }, I18N$c[lang].language), index.h("abbr", { key: 'bf8fc9ac514ed5c243c52d63be1cef06cb024b9e', title: I18N$c[lang].language }, I18N$c[lang].abbreviation)))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsLink = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '361b0eae9c009484a60cae6ab0c7dfc91f9bddec' }, index.h("a", Object.assign({ key: 'a1fb3f918373cc7e9374a0ee378005a1356274d2', role: "link", tabIndex: 0 }, attrs, { class: `gcds-link link--${size} ${display != 'inline' ? `d-${display}` : ''} ${variant != 'default' ? `variant-${variant}` : ''}`, ref: element => (this.shadowElement = element), target: isExternal ? '_blank' : target, rel: isExternal ? 'noopener noreferrer' : rel }, inheritedAttributes, { part: "link", onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => emitEvent(e, this.gcdsClick, href) }), index.h("slot", { key: '883dc938a4fe2c5ad27dc5bdc4276717c5b7c15f' }), target === '_blank' || external ? (index.h("gcds-icon", { name: "external-link", label: I18N$b[lang].external, "margin-left": "75" })) : download !== undefined ? (index.h("gcds-icon", { name: "download", label: I18N$b[lang].download, "margin-left": "75" })) : href && href.toLowerCase().startsWith('mailto:') ? (index.h("gcds-icon", { "icon-style": "regular", name: "envelope", label: I18N$b[lang].email, "margin-left": "75" })) : (href &&
            href.toLowerCase().startsWith('tel:') && (index.h("gcds-icon", { name: "phone", label: I18N$b[lang].phone, "margin-left": "75" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const GcdsNavGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a8ccd5b9fe3fc863f028659e07c3b8daf1490bf6', role: "listitem", open: open }, index.h("button", { key: '634a03ec34f6375e79989e6a2a5161f5cc08e608', "aria-haspopup": "true", "aria-expanded": open.toString(), ref: element => (this.triggerElement = element), class: `gcds-nav-group__trigger gcds-trigger--${this.navStyle}`, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => {
                const event = emitEvent(e, this.gcdsClick);
                if (event) {
                    this.toggleNav();
                }
            } }, index.h("gcds-icon", { key: 'f244c1963af50836c8f162be9ddecd7bde68b5eb', name: open ? 'angle-up' : 'angle-down' }), closeTrigger && open ? closeTrigger : openTrigger), index.h("ul", { key: '39a75c9589b30c34bc6763c66336ec91f0dc0835', "aria-label": menuLabel, class: `gcds-nav-group__list gcds-nav--${this.navStyle}` }, index.h("slot", { key: '0e0b5c1699600e032816cbe85ffa78dc342a88e8' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsNavLink = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '32ea4108ff71d895c105a9d0faca30969c9f5e79', role: "listitem" }, index.h("a", Object.assign({ key: '868cac143f2c49184119585822b34b507babf221', class: `gcds-nav-link gcds-nav-link--${this.navStyle}`, href: href }, linkAttrs, { onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => emitEvent(e, this.gcdsClick, href), ref: element => (this.linkElement = element) }), index.h("slot", { key: '9af801147738817622854622400df40fd5646620' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsNotice = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cc0b6ce484789c05fd099b7e0c0b94396bbf5cc9' }, this.validateRequiredProps() && (index.h("section", { key: '3643290523b2d266a8ac0a8422652782a5a1a7ca', class: `gcds-notice notice--type-${type}` }, index.h("gcds-icon", { key: '2be06da9bca52fa70ded02fad226c2c434186731', class: "notice__icon", size: "h4", name: iconTypes[type] }), index.h("div", { key: '2da5c9fe4808e1a5b79f7dfd04ca24b2cb3519e3' }, index.h("gcds-heading", { key: '733544e235c0832101c79c82a140d42bb6eb783a', tag: noticeTitleTag, "margin-top": "0", "margin-bottom": "100", class: "notice__heading" }, index.h("gcds-sr-only", { key: '34c677889a234722b2e672ebae4b700801dc8f67', tag: "span" }, I18N$a[this.lang][type]), noticeTitle), index.h("slot", { key: 'bdb1a6843f3386d766f241a62edfea9d06e3fad6' }))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsPagination = class {
    ...
    configurePaginationStep(page, end, mobile) {
        ...
        if (end) {
            return (index.h("li", null, end === 'next' ? (index.h("a", Object.assign({}, linkAttrs, { class: !mobile
                    ...
                    : 'gcds-pagination-end-button-mobile' }), I18N$9[this.lang].next, index.h("gcds-icon", { "margin-left": "150", name: "chevron-right" }))) : (index.h("a", Object.assign({}, linkAttrs, { class: !mobile
                    ? 'gcds-pagination-end-button'
                    : 'gcds-pagination-end-button-mobile' }), index.h("gcds-icon", { "margin-right": "150", name: "chevron-left" }), mobile
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5ff20c1b40e3f30430ab005d263b30b48c5be3d6', role: "navigation", "aria-label": label }, index.h("div", { key: '6dfb86d512fdd30b1298c4864113e6ed68adc06a', class: "gcds-pagination" }, display === 'list' ? (index.h("div", null, index.h("ul", { class: "gcds-pagination-list" }, this.listitems), index.h("ul", { class: "gcds-pagination-list-mobile-prevnext" }, this.mobilePrevNext))) : (index.h("ul", { class: "gcds-pagination-simple" }, previousHref && (index.h("li", { class: "gcds-pagination-simple-previous" }, index.h("a", { href: previousHref, tabindex: 0, "aria-label": `${I18N$9[lang].previousPage}${previousLabel ? `: ${previousLabel}` : ''}`, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => emitEvent(e, this.gcdsClick, previousHref) }, index.h("gcds-icon", { "margin-right": "150", name: "chevron-left" }), index.h("div", { class: "gcds-pagination-simple-text" }, I18N$9[lang].previous), index.h("span", null, previousLabel)))), nextHref && (index.h("li", { class: "gcds-pagination-simple-next" }, index.h("a", { href: nextHref, tabindex: 0, "aria-label": `${I18N$9[lang].nextPage}${nextLabel ? `: ${nextLabel}` : ''}`, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => emitEvent(e, this.gcdsClick, nextHref) }, index.h("div", { class: "gcds-pagination-simple-text" }, I18N$9[lang].next), index.h("span", null, nextLabel), index.h("gcds-icon", { "margin-left": "150", name: "chevron-right" })))))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const GcdsPhaseBanner = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '01721695ba82d2faad63aabf1308ab32a2277576' }, index.h("div", { key: '8f863517645dfd61949cc28d8fe4e4bfdb471734', class: `gcds-phase-banner banner--role-${bannerRole} ${isFixed ? 'banner--is-fixed' : ''}`, role: "status", "aria-label": I18N$8[lang].label }, index.h("gcds-container", { key: 'e09458246e2769bff036529d6ea7cdd12c4c78f0', size: container, centered: true }, index.h("div", { key: 'c52e8231ee66f8e68c85ca6d0dc98eb7343e94d9', class: "banner__content" }, index.h("figure", { key: '0360d88ce03c0ed816f700930bf2d7647cad3d87', class: "banner__icon icon--left" }, index.h("slot", { key: 'c59ff70d5fba77c3cb060674c3d61b5f427b3eb0', name: "banner-icon-left" })), index.h("div", { key: '89b3f4e118778f91983b3114fb134679d9b5be4d', class: "banner__details" }, index.h("slot", { key: 'dd5cc8315c49b2b10564ea9240f336ac9d0e79c9', name: "banner-text" }), index.h("slot", { key: '6d1f17700cc66416b93f2c80a6e4d6da3f4d5602', name: "banner-cta" })), index.h("figure", { key: '9596f293b8bed55c2738504f98b4827f21ce40ea', class: "banner__icon icon--right" }, index.h("slot", { key: '0355ed216936f151188a800fe50ebc4443ecccb6', name: "banner-icon-right" })))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsSearch = class {
    ...
    render() {
        ...
        const formAction = action === '/sr/srb.html'
            ...
            : action;
        return (index.h(index.Host, { key: '128049f5dd1902ece7e9a1e6c03754b5e3bc057d' }, index.h("div", { key: '79e0c575a737a8d9bc1495bbaea533a788c6e22e', class: "gcds-search" }, index.h("gcds-sr-only", { key: 'fa01d2aa8e4f923e1b1fb7146747444af5754ab6', tag: "h2" }, I18N$7[lang].search), index.h("form", { key: '6b418484503577b004402be2558d303a07596bc1', action: formAction, method: method, role: "search", onSubmit: e => emitEvent(e, this.gcdsSubmit, this.value), class: "gcds-search__form" }, index.h("gcds-label", { key: '3110b02d5a162d12d3390cc90278eb63df15ab4d', label: labelText, "label-for": searchId, "hide-label": true }), index.h("input", Object.assign({ key: 'be068ed5ce558a501843468015034de96b198eb6', type: "search", id: searchId, list: "search-list", size: 34, maxLength: 170, onInput: e => this.handleInput(e, this.gcdsInput), onChange: e => this.handleInput(e, this.gcdsChange), onFocus: () => this.gcdsFocus.emit(), onBlur: () => this.gcdsBlur.emit() }, attrsInput, { class: "gcds-search__input", value: value })), suggested && (index.h("datalist", { key: '9907ea35d301fa4bd6c8cd433a87aa1e9cdd1465', id: "search-list" }, suggested.map((k, v) => (index.h("option", { value: k, key: v }))))), index.h("gcds-button", { key: '34305968de8f5cf777dba3509f2f2d996ea9d4d2', type: "submit", class: "gcds-search__button", exportparts: "button" }, index.h("gcds-icon", { key: '5d5f2ec8a972bc820d4b56cdb4d7576ca2f80eb2', name: "search", label: I18N$7[lang].search, "fixed-width": true }))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsSideNav = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '344cf111e760b2b61b35b0a6cd571dde4b397135' }, index.h("nav", { key: '0775d15419006ceb206061d351fe54067cb5af6d', "aria-label": `${label}${I18N$6[lang].navLabel}`, class: "gcds-side-nav" }, index.h("h2", { key: '33710c507459d5a1ccf49831c68dc854b8e076bd', class: "gcds-side-nav__heading" }, label), index.h("ul", { key: '82ebb89be44aab8c201d82670239e0641cca8d18' }, index.h("gcds-nav-group", { key: 'a633c17d34ccd0ca08f2413e95f74f815e277abb', menuLabel: I18N$6[lang].menuLabel, closeTrigger: I18N$6[lang].closeTrigger, openTrigger: I18N$6[lang].menuLabel, class: "gcds-mobile-nav", ref: element => (this.mobile = element), lang: lang }, index.h("slot", { key: 'bd8c03e0b14ff32556b23ed89779ffb4d69553f2' }))))));
    }
    get el() { return index.getElement(this); }
};
...
const SignatureEn = `<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 819 75.97" preserveAspectRatio="xMinYMin meet" role="img" aria-labelledby="signature-title">
...
const SignatureFr = `<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 819 75.97" preserveAspectRatio="xMinYMin meet" role="img" aria-labelledby="signature-title">
...
const GcdsSignature = class {
    ...
    get svgLabel() {
        let altText = '';
        if (this.lang === 'en') {
            altText = (index.h(index.Fragment, null, I18N$5['en'].gc, " / ", index.h("span", { lang: "fr" }, I18N$5['fr'].gc)));
        }
        else {
            altText = (index.h(index.Fragment, null, I18N$5['fr'].gc, " / ", index.h("span", { lang: "en" }, I18N$5['en'].gc)));
        }
        return (index.h("gcds-sr-only", { tag: "span", id: "signature-title" }, altText));
    }
    render() {
        ...
        return (index.h(index.Host, { key: '47d75f32629a27d13f1026f00a584a9f8b580f05' }, type === 'signature' ? (index.h(Tag, Object.assign({}, sigAttrs), index.h("div", { innerHTML: selectSVG }), svgLabel)) : (index.h("div", { class: "gcds-signature", innerHTML: selectSVG }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "type": ["validateType"],
...
const GcdsSrOnly = class {
    ...
    render() {
        const Tag = this.tag;
        return (index.h(index.Host, { key: 'ca9a1ff72b50c391ac0ce0e4eb8242221aa43820' }, index.h(Tag, { key: '7e66d8786d82a9f48bd18a029e26d4a16fe825e6' }, index.h("slot", { key: '16009321706450caf62862686f82ee7158db97f5' }))));
    }
    static get watchers() { return {
        "tag": ["validateTag"]
    }; }
...
const GcdsStepper = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '237512cb8b5d8a3e516d8f832fc01ff6bb592d29' }, this.validateRequiredProps() && (index.h("gcds-heading", { key: '4280179cd8b0edc2d0abcf32d286d467b1d80c56', tag: tag, class: "gcds-stepper", "margin-top": "0", "margin-bottom": "225" }, index.h("span", { key: 'dbf96a764e6ebd0131d5b3bd61197dddd359c493', class: "gcds-stepper__steps" }, `${I18N$4[lang].step} ${currentStep} ${I18N$4[lang].of} ${totalSteps}`, index.h("gcds-sr-only", { key: 'e28f042579d393ffb0fd3c2ad70761d3112e9ab0' }, " : ")), index.h("slot", { key: 'e9557a09c6120174b16a184956e96b95efc695f1' })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const GcdsText = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9ca2919ce7535ecfdab92646c22df7a677f97465', class: `${display != 'block' ? `d-${display}` : ''}` }, index.h("p", { key: 'a2852d6e38530bac597e2a9b3156a3e1d61f4199', class: `
            gcds-text
...
const GcdsTopNav = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0b90b2ecfef9712330322dce2a65b6a360606520' }, index.h("div", { key: 'a8b05cb72ce2dfb6867e35fdbe39bf115d3c8673', class: "gcds-top-nav" }, index.h("nav", { key: '0d9282ce0348d037609ee36c0d83cada54b0f246', "aria-label": `${label}${I18N$2[lang].navLabel}` }, index.h("ul", { key: 'ec9aa9c60a2c28d7c80765f0c35429f1e936180c', class: "gcds-top-nav__container" }, index.h("gcds-nav-group", { key: '42ab733e63bfe7fb3f2fb7b5f588a6ee60f0a653', menuLabel: I18N$2[lang].menuLabel, closeTrigger: I18N$2[lang].closeTrigger, openTrigger: I18N$2[lang].menuLabel, class: "gcds-mobile-nav gcds-mobile-nav-topnav", ref: element => (this.mobile = element), lang: lang }, index.h("slot", { key: 'a3b4cbd6baba0493fefd154e41350f71c6eec57e', name: "home" }), index.h("li", { key: 'b82de02939f23e7e3a67cfb974f3cd292ccdb81b', class: `nav-container__list nav-list--${alignment}` }, index.h("ul", { key: 'da9cf11b43568b2143c0e70af1c3f92b75e13660', class: `nav-container__list nav-list--${alignment}` }, index.h("slot", { key: '0f98892f2e8c0c8d39055f301f5a0774ad68d63e' })))))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsTopicMenu = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '77e9f945df4058bd3c547231d6cdb6ec9052fc84' }, index.h("nav", { key: '5ca25a73101119a0ceffd543c7ff55b7d891e994', class: "gcds-topic-menu", "aria-labelledby": "gcds-topic-menu__heading" }, index.h("gcds-sr-only", { key: 'dd8d544d5de7d0445e1e163481fae5b25497d811', id: "gcds-topic-menu__heading", tag: "h2" }, I18N$1[lang].menuLabelFull), index.h("button", { key: '5b7d43ea46077bc46f364c4eaaa4ebfbd1fd3ec7', "aria-haspopup": "true", "aria-expanded": this.open.toString(), "aria-label": I18N$1[lang].buttonLabel, onClick: async () => await this.toggleNav(), ref: element => (this.menuButton = element), class: home && 'gcds-topic-menu--home' }, this.lang == 'en' ? (index.h(index.Fragment, null, index.h("gcds-sr-only", { tag: "span" }, I18N$1[lang].menuLabelHidden), I18N$1[lang].menuToggle)) : (index.h(index.Fragment, null, I18N$1[lang].menuToggle, index.h("gcds-sr-only", { tag: "span" }, I18N$1[lang].menuLabelHidden))), index.h("gcds-icon", { key: '72b28e6124b97e3781e693b0811c012d9a18dcd9', name: "chevron-down", "margin-left": "100", size: "text-small" })), index.h("ul", { key: '0dc47fdd32219dec0313e04da9e5e6df57dc906e', role: "menu", "aria-orientation": "vertical", "data-top-menu": true, innerHTML: this.listItems, ref: element => (this.themeList = element) }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsVerifyBanner = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '79bc4dc615e909274744d7c9658fbe004c2bf6bc' }, index.h("details", { key: '0e01a3f845f9f882c07b1c34ab51a2f381c8bf5f', class: `gcds-verify-banner ${isFixed ? 'verify-banner--is-fixed' : ''}` }, index.h("summary", { key: '60a371e675c308932c2f5af336c6e81035ca01f2', class: container ? `container-${container}` : '', "aria-expanded": "false", role: "button" }, index.h("span", { key: '7b0def4d6a9a4eb3a313fff1fe66a0bc6b1f051a', class: "svg-container", innerHTML: CanadaFlag }), index.h("p", { key: 'a074a77e354a0166aa6770f32fd83d1cdbd8532a' }, index.h("small", { key: '1acc5177f5d3ba56d97816fe2f99a7568107e433' }, I18N[lang].summary.text), index.h("button", { key: 'ec6a3f1625d23552f8d31c0cde5803ddc2a77272', class: "verify-banner__toggle" }, index.h("small", { key: '3f6d49e3165de7c1c6b2e7d6d06d274f0fbdd56a' }, I18N[lang].summary.link), index.h("span", { key: '153fc0c626c8a986db416c5ac29713a2ac0fcdf1', class: "svg-container", innerHTML: ContentToggleArrow })))), index.h("div", { key: 'e81165bfd96795ccf462da1d4a1dda868395cce5', class: `verify-banner__content ${container ? `container-${container}` : ''}` }, index.h("p", { key: '22045e8846b47339074fd5f38f031ca4b8959d8d' }, index.h("small", { key: '473ff5b3a65b167204a67097f66a6d84d0a4ce23' }, I18N[lang].content.description)), index.h("br", { key: '15af7e05f46d20060c48a59474588e60831a094e' }), index.h("gcds-grid", { key: '709f44671c2d73683385dbf9621718d9c20bc289', tag: "ul", container: "lg", columns: "1fr", "columns-tablet": container === 'xs' || container === 'sm' ? '1fr' : '1fr 1fr' }, index.h("li", { key: 'f65ebc8634708bc47b1a32e92782555083685064' }, index.h("h4", { key: '6c4cf0f3461551b7a0f6c1ab98a00d027f1dd5a2' }, I18N[lang].content.url.heading), index.h("p", { key: '85f95f3ca4a0fba659d60f6145d3e37089a8ecd4' }, index.h("small", { key: '1b105c8da0a8976ab8c4e1bad11447be51a65c8f' }, I18N[lang].content.url.text))), index.h("li", { key: '93c3f0c0487ba36d347f58bffc777ce66de6f3fd' }, index.h("h4", { key: 'f8481a2a32400da5a36109fa56a962593e0312e2' }, I18N[lang].content.languages.heading), index.h("p", { key: 'd9596aee415d7c38b2dc9a573805baae85d05a38' }, index.h("small", { key: '904e6811890b96a3bd96dea52204a6d15e3b44ac' }, I18N[lang].content.languages.text))), index.h("li", { key: '7844b115d12d5071d9d23ee3f7fef4507461b607' }, index.h("h4", { key: '36843578e05e2c110e759355324dc428c1902e7b' }, I18N[lang].content.https.heading), index.h("p", { key: '70cf52e7807ff64061d0ca654f5295e94bb32fd1' }, index.h("small", { key: '1764d52ed82aecfcf0ca8f533848d08114852403' }, I18N[lang].content.https.text, " ", index.h("strong", { key: '6675bf241c5f83bb100ccd15d78cd1d6351fdc37' }, "https://"), "."))), index.h("li", { key: '8779e017066292331a05451847ac7c3d5865999a' }, index.h("h4", { key: 'd82025f6d665cc8df4ddb97cc73e539c058ae1b0' }, I18N[lang].content.contact.heading), index.h("p", { key: '391899c66d166527c07eebaa1a017b665a45e354' }, index.h("small", { key: 'ea86b227a962ba2bfe0784d6bf89b24c592c26ba' }, I18N[lang].content.contact.text))))))));
    }
    get el() { return index.getElement(this); }
};
...
//# sourceMappingURL=gcds-alert_42.cjs.entry.js.map