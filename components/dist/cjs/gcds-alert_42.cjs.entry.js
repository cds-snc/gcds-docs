...
const GcdsButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b77e1cd9aefb341e8a130d88d3285d553115f6c7' }, index.h(Tag, Object.assign({ key: '667858f8a889c0820735d6008bfb04a043122eb1' }, attrs, { id: buttonId, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => !disabled ? this.handleClick(e) : e.stopImmediatePropagation(), class: `gcds-button button--role-${buttonRole} button--${size}`, ref: element => (this.shadowElement = element) }, inheritedAttributes, { part: "button" }), index.h("slot", { key: 'db523fdaf7e8acd851963701ecc233d8fa7a2f22' }), type === 'link' && target === '_blank' ? (index.h("gcds-icon", { name: "external", label: I18N$o[lang].label, "margin-left": "150" })) : null)));
    }
...
const GcdsDateInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd9388aa00239180b8f9a657cd188748c2d1babce', name: name, onBlur: () => this.onBlur() }, this.validateRequiredProps() && (index.h("fieldset", Object.assign({ key: '1004ff844a1231495b95d598d9880ac03284464a', class: "gcds-date-input__fieldset" }, fieldsetAttrs), index.h("legend", { key: '0fea4a4db52510952d1911773a4f0d45b8af0b89', id: "date-input-legend" }, legend, required ? (index.h("span", { class: "legend__required" }, I18N$m[lang].required)) : null), hint ? (index.h("gcds-hint", { id: "date-input-hint", "hint-id": "date-input" }, hint)) : null, errorMessage ? (index.h("div", null, index.h("gcds-error-message", { id: "date-input-error", messageId: "date-input" }, errorMessage))) : null, format == 'compact'
            ? [month, year]
            : lang == 'en'
                ? [month, day, year]
                : [day, month, year]))));
...
const GcdsDateModified = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f63e29a192d3a4d658ca78335b064e84e4143c5b' }, this.validateRequiredProps() && (index.h("dl", { key: '934f13de2562460ebb81b01b19a969c5fca4604c', class: "gcds-date-modified" }, index.h("dt", { key: '71a5ff2bdcf6c6d7aaf857d459b7c465d13a7ab3' }, index.h("gcds-text", { key: 'b8ad0f896154c73fff49eb8e5f7aabc82a8fb6f0', display: "inline", "margin-bottom": "0" }, type === 'version' ? I18N$l[lang].version : I18N$l[lang].date)), index.h("dd", { key: '8624f50eb70cdfd7a448c6e5755235c729fa00f2' }, index.h("gcds-text", { key: '97c82c7759ea15d85f92dd19ebd40c24d010df13', display: "inline", "margin-bottom": "0" }, type === 'version' ? (index.h("slot", null)) : (index.h("time", null, index.h("slot", null)))))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsErrorMessage = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3f2e26f31e50359a0e1726d5f714dd678005cf01', id: `error-message-${messageId}`, class: "gcds-error-message-wrapper" }, index.h("gcds-text", { key: 'a8a20a16968e9a4578466f4fbeafb727077d7424', class: "error-message", role: "alert", "margin-bottom": "75" }, index.h("gcds-icon", { key: '0ec129fc4a98c7232c2fd9a6fbbfa936f9ce471a', name: "warning-triangle", "margin-right": "50" }), index.h("strong", { key: 'bcb3dd9ed9b3e4d31979abeb6a2772c7073a7918' }, index.h("slot", { key: 'f5b40163bd642d274789295c3b9cd84d27e157dd' })))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsErrorSummary = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'dd90e9455ea1a422d5f4559c62df271259923249' }, index.h("div", { key: 'bb61b6d2eea84aead7d06e0355b464bf2e2281bb', role: "alert", tabindex: "-1", ref: element => (this.shadowElement = element), class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0
                ? 'gcds-show'
                : ''}` }, index.h("gcds-heading", { key: '170edbb97c73a0928aaa571f33eee36b72fee740', tag: "h2", "margin-top": "0", "margin-bottom": "225" }, heading !== null && heading !== void 0 ? heading : I18N$k[lang].heading), index.h("ol", { key: 'ce1c06b5047c8a1632a955c3cb5d7ed833a7284b', class: "summary__errorlist" }, (hasSubmitted || errorLinks) &&
...
const GcdsFooter = class {
    ...
    render() {
        ...
        let subLinkCount = 0;
        return (index.h(index.Host, { key: '80705536aaa53acb16c95fbadbedf2ba8c2b44aa', role: "contentinfo", "aria-label": "Footer" }, index.h("gcds-sr-only", { key: '40b4f1f47f89230a7570b8a2ede87eea289f9769', tag: "h2" }, I18N$h[lang].about), contextualLinksObject && contextualHeading && (index.h("div", { key: 'd068b2e3d3ea29ab9dd0f45e9065a920b6cea387', class: "gcds-footer__contextual" }, index.h("div", { key: '4a4b92b90a82bfd938555d009fbdc869145d23ce', class: "contextual__container" }, index.h("nav", { key: 'cad548536170a273339c72fcf2d99d007c5c9a93', "aria-labelledby": "contextual__heading" }, index.h("h3", { key: '072647a4600ae33264bd19ffa7ee82fc1affa3cb', id: "contextual__heading", class: "contextual__heading" }, contextualHeading), index.h("ul", { key: '60d5f1368912a10b3e00528ee2f9a04d1aa7aa00', class: "contextual__list" }, Object.keys(contextualLinksObject).map(key => {
            if (contextualLinkCount < 3) {
                contextualLinkCount++;
                return (index.h("li", null, index.h("gcds-link", { size: "small", href: contextualLinksObject[key] }, key)));
            }
        })))))), display === 'full' ? (index.h("div", { class: "gcds-footer__main" }, index.h("div", { class: "main__container" }, index.h("nav", { class: "main__govnav", "aria-labelledby": "govnav__heading" }, index.h("h3", { id: "govnav__heading" }, I18N$h[lang].gov.heading), index.h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (index.h("li", null, index.h("gcds-link", { size: "small", href: govNav[value].link }, govNav[value].text)))))), index.h("nav", { class: "main__themenav", "aria-labelledby": "themenav__heading" }, index.h("gcds-sr-only", { tag: "h4", id: "themenav__heading" }, I18N$h[lang].themes.heading), index.h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (index.h("li", null, index.h("gcds-link", { size: "small", href: themeNav[value].link }, themeNav[value].text))))))))) : null, index.h("div", { key: 'f7e8acd7c6fe841e938510189fdf641ca9c22fe4', class: "gcds-footer__sub" }, index.h("div", { key: 'f9823441ebec110b002d0e08806e79ae745c3110', class: "sub__container" }, index.h("nav", { key: '12d8f65435c6435ac713fbd14d2659fcd013ba17', "aria-labelledby": "sub__heading" }, index.h("gcds-sr-only", { key: 'db80c42c3402e9d8cbfbc145e756bdcf0e7029c2', tag: "h3", id: "sub__heading" }, I18N$h[lang].site.heading), index.h("ul", { key: 'a78aef708a0aa3eb030e7e83961bbe32175c7302' }, subLinks
...
const GcdsIcon = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c1007874d5124b1b6a922176716182ddf1d2856f' }, index.h("span", { key: '6d1934a3ae40303b9246820187f25bb3eec65648', class: `
...
const GcdsNavGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a8ccd5b9fe3fc863f028659e07c3b8daf1490bf6', role: "listitem", open: open }, index.h("button", { key: '4ff6bd558a2b8e380130754fc1fc1cb4efc133cb', "aria-haspopup": "true", tabIndex: 0, "aria-expanded": open.toString(), ref: element => (this.triggerElement = element), class: `gcds-nav-group__trigger gcds-trigger--${this.navStyle}`, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => {
                const event = emitEvent(e, this.gcdsClick);
                if (event) {
                    this.toggleNav();
                }
            } }, index.h("gcds-icon", { key: '64bb2e9c579c7f28b9a52764b54e42ea4ac4cd23', name: open ? 'chevron-up' : 'chevron-down' }), closeTrigger && open ? closeTrigger : openTrigger), index.h("ul", { key: 'b8de299b4d122f1251e5822a2a1056d8f63ab583', "aria-label": menuLabel, class: `gcds-nav-group__list gcds-nav--${this.navStyle}` }, index.h("slot", { key: '67a8a53ac07bb72994f218101f3c45d5c58d34bc' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsNotice = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7d04d0e19067c8a1f0f6bef1ba21f9bb6e05b379' }, this.validateRequiredProps() && (index.h("section", { key: '92300518f0f6a084603043451272705d18f32b10', class: `gcds-notice notice--type-${type}` }, index.h("gcds-icon", { key: 'd08a464788d4ab04e25aaefd883510b178580b3e', class: "notice__icon", size: "h4", name: iconTypes[type] }), index.h("div", { key: 'beb615aef718ad429868df2dfca31d997b08f862' }, index.h("gcds-heading", { key: '139221a5b81115d19700a0e3fef7bbb1386d2497', tag: noticeTitleTag, "margin-top": "0", "margin-bottom": "100", class: "notice__heading" }, index.h("gcds-sr-only", { key: 'cec841b35332c0f7cf4cd68a7c9a6a387c87165b', tag: "span" }, I18N$a[this.lang][type]), noticeTitle), index.h("slot", { key: 'e24597dad7914e2c0cf3ad53f4aee87994a6d72f' }))))));
    }
    get el() { return index.getElement(this); }
};
    ...
    configurePaginationStep(page, end, mobile) {
        ...
        if (end) {
            return (index.h("li", null, end === 'next' ? (index.h("a", Object.assign({}, linkAttrs, { class: !mobile
                    ...
                    : 'gcds-pagination-end-button-mobile' }), index.h("span", null, I18N$9[this.lang].next), index.h("gcds-icon", { "margin-left": "150", name: "chevron-right" }))) : (index.h("a", Object.assign({}, linkAttrs, { class: !mobile
                    ? 'gcds-pagination-end-button'
