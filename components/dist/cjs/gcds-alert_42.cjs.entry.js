...
const GcdsButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f879906e23b82587fd539f65f4089d52f7ebac8f' }, index.h(Tag, Object.assign({ key: 'a2193325c515bcafa420a4c3b70aac52c4a4d248' }, attrs, { id: buttonId, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => this.handleClick(e), class: `gcds-button button--role-${buttonRole} button--${size}`, ref: element => (this.shadowElement = element) }, inheritedAttributes, { part: "button" }), index.h("slot", { key: '5d106a6af6fa23a394fc1387c3ccb96c93b7b490' }), type === 'link' && target === '_blank' ? (index.h("gcds-icon", { name: "external-link", label: I18N$l[lang].label, "margin-left": "150" })) : null)));
    }
...
const GcdsDateInput = class {
    ...
    render() {
        ...
        const day = (index.h("gcds-input", Object.assign({ key: 'd9f341a356c4e4d7dc5cc3e38cdac2931dd98a87', name: "day", label: I18N$j[lang].day, inputId: "day", type: "number", size: 2, disabled: disabled, value: this.dayValue, onInput: e => this.handleInput(e, 'day'), onChange: e => {
        ...
        return (index.h(index.Host, { key: '00e97ecb52e332d43e6917b72005cbab39254c25', name: name, onBlur: () => this.onBlur() }, this.validateRequiredProps() && (index.h("gcds-fieldset", { key: '9909941d6ab3bde3b630dfcbfbcf6a475b44be2c', legend: legend, fieldsetId: "date-input", hint: hint, errorMessage: errorMessage, required: required, class: `gcds-date-input__fieldset${hint ? ' gcds-date-input--hint' : ''}${errorMessage ? ' gcds-date-input--error' : ''}`, lang: lang, "data-date": "true" }, format == 'compact'
            ? [month, year]
            : lang == 'en'
                ? [month, day, year]
                : [day, month, year]))));
...
const GcdsDateModified = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '39fca62bf69af99e9d52995d1cea0c22d9c13949' }, this.validateRequiredProps() && (index.h("dl", { key: 'f9dfcb28b36f5481480233e54e4f66c19016addc', class: "gcds-date-modified" }, index.h("dt", { key: '71c512bd925df8bf35ad55ba20377340878c670d' }, index.h("gcds-text", { key: '8964d2b21c1c3660eb5ee4321795275c0006847d', display: "inline", "margin-bottom": "0" }, type === 'version' ? I18N$i[lang].version : I18N$i[lang].date)), index.h("dd", { key: 'f203c814fb4da7ddaf1fab80233b2c1d2448fc68' }, index.h("gcds-text", { key: '8d20378fb151f0faea84fbfab13a723b0b3d3727', display: "inline", "margin-bottom": "0" }, type === 'version' ? (index.h("slot", null)) : (index.h("time", null, index.h("slot", null)))))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsErrorMessage = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c772a009299851d08165315989a3459ba148c69f', id: `error-message-${messageId}`, class: "gcds-error-message-wrapper" }, index.h("gcds-text", { key: 'bfd1698985476b6a0454dc97b5b13cc95d44e1b0', class: "error-message", role: "alert", "margin-bottom": "100" }, index.h("gcds-icon", { key: '1c2298cd79b7cf5ef2aee44db03adbdf0308e1ab', name: "triangle-exclamation", "margin-right": "50" }), index.h("strong", { key: '745e3eb8218f02a15832e5adc7d802473819c7cd' }, index.h("slot", { key: 'fd0412b7526c83be37b0302362611be4764f588d' })))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsErrorSummary = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1e78ebc181c6f25c95316a980d0618ce30854e71' }, index.h("div", { key: '5bc1d9c797665c4fcbc3483ee0075fa0d30498f4', role: "alert", tabindex: "-1", ref: element => (this.shadowElement = element), class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0
                ? 'gcds-show'
                : ''}` }, index.h("gcds-heading", { key: 'b25ea686a38672748271ac291d09af604344883a', tag: "h2", "margin-top": "0", "margin-bottom": "225" }, heading !== null && heading !== void 0 ? heading : I18N$h[lang].heading), index.h("ol", { key: '059c002f1c0bc84e9c1ced147bce03f8f95640c2', class: "summary__errorlist" }, (hasSubmitted || errorLinks) &&
...
const GcdsHeading = class {
    ...
    render() {
        ...
        const Tag = tag;
        return (index.h(index.Host, { key: 'decf305fa7a128be6b541d3ad3a831a1a52797a6' }, index.h(Tag, { key: '8b3b768c40221bcd42efe0da080b0aeeb77fec9e', class: `
            gcds-heading
            ${characterLimit ? 'limit' : ''}
            ${marginTop ? `mt-${marginTop}` : ''}
            ${marginBottom ? `mb-${marginBottom}` : ''}
          ` }, index.h("slot", { key: '447128aaa454ae0f840331cc2eea4098627f9d30' }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "tag": ["validateTag"],
...
const GcdsIcon = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '33a2027afb36b43c62addcd9bf3762a2e214ed25' }, index.h("span", { key: '8c4bf985eff79cbe01526fb158ca0155c854c9a5', class: `
...
const GcdsNotice = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b2e164006dfa7bdbefbfea565e99b56107d4b860' }, this.validateRequiredProps() && (index.h("section", { key: '53c1c6def3c260efea32c5d024eac59750be8dab', class: `gcds-notice notice--type-${type}` }, index.h("gcds-icon", { key: 'f4b88229b0723e63edef882d44faf155eccd7ea2', class: "notice__icon", size: "h4", name: iconTypes[type] }), index.h("div", { key: '551792b1a73d873aa1139151af829f3dd83d97f5' }, index.h("gcds-heading", { key: 'fd790db93fac16a22103243af53c0385ac9b955b', tag: noticeTitleTag, "margin-top": "0", "margin-bottom": "100", class: "notice__heading" }, noticeTitle), index.h("slot", { key: '5755a641b120de8f93b3fab7e8438d4c2764f528' }))))));
    }
    get el() { return index.getElement(this); }
};
    ...
    configurePaginationStep(page, end, mobile) {
        ...
        if (end) {
            return (index.h("li", null, end === 'next' ? (index.h("a", Object.assign({}, linkAttrs, { class: !mobile
                    ...
                    : 'gcds-pagination-end-button-mobile' }), I18N$9[this.lang].next, index.h("gcds-icon", { "margin-left": "150", name: "arrow-right" }))) : (index.h("a", Object.assign({}, linkAttrs, { class: !mobile
                    ? 'gcds-pagination-end-button'
                    : 'gcds-pagination-end-button-mobile' }), index.h("gcds-icon", { "margin-right": "150", name: "arrow-left" }), mobile
...
const GcdsPhaseBanner = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '03d1a8de7df2a91d9a8b79cca4bef17377585269' }, index.h("div", { key: 'e6194d8cf29385c2c6079393ff7c235735d7d807', class: `gcds-phase-banner banner--role-${bannerRole} ${isFixed ? 'banner--is-fixed' : ''}`, role: "status", "aria-label": I18N$8[lang].label }, index.h("gcds-container", { key: '5b05537336d102ca070af8199acdf2444f729de8', size: container, centered: true }, index.h("div", { key: '8ac815e722f021f7d23f7b23267410f1dbefd613', class: "banner__content" }, index.h("figure", { key: 'afec7938dc8628e23a73b46baa6f01490d9d1d6c', class: "banner__icon icon--left" }, index.h("slot", { key: '749ff139daab3c0d92cc1bcc707d36beb860c6eb', name: "banner-icon-left" })), index.h("div", { key: '17adb8cb3b7f9b0a076407c611748e1f665e7eca', class: "banner__details" }, index.h("slot", { key: '8482f2af1178f5f070f81c54c0e4f7e886055a14', name: "banner-text" }), index.h("slot", { key: '6b240f9a45c7466b145610020cc45bacf23c82d7', name: "banner-cta" })), index.h("figure", { key: '15046443505ce0469c648d914b14f990a1c61a8c', class: "banner__icon icon--right" }, index.h("slot", { key: 'e539510f180473f2497c2634b16e91202af86cdf', name: "banner-icon-right" })))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsSearch = class {
    ...
    render() {
        ...
        const formAction = action === '/sr/srb.html'
            ...
            : action;
        return (index.h(index.Host, { key: '127843a74f45499fd5470727bbb846b1ee203ec7' }, index.h("div", { key: '3211fee418e7019ba50ca9c64ab3ddac6861ea9c', class: "gcds-search" }, index.h("gcds-sr-only", { key: '20a1386129bd0d9d53a4b3052d7fd7d9232bbcc7', tag: "h2" }, I18N$7[lang].search), index.h("form", { key: 'b538c34be842faf9c5dc834779b835cce1a76348', action: formAction, method: method, role: "search", onSubmit: e => emitEvent(e, this.gcdsSubmit, this.value), class: "gcds-search__form" }, index.h("gcds-label", { key: '9b6f44ab0e9b8e8f929ca45438a8315856cecfd7', label: labelText, "label-for": searchId, "hide-label": true }), index.h("input", Object.assign({ key: '989b67be6bb92553cae5bb76912e84f05fdb90e4', type: "search", id: searchId, list: "search-list", size: 34, maxLength: 170, onInput: e => this.handleInput(e, this.gcdsInput), onChange: e => this.handleInput(e, this.gcdsChange), onFocus: () => this.gcdsFocus.emit(), onBlur: () => this.gcdsBlur.emit() }, attrsInput, { class: "gcds-search__input", value: value })), suggested && (index.h("datalist", { key: 'd7bf8d367ccf1166f18aa01098fdf3874fb1256d', id: "search-list" }, suggested.map((k, v) => (index.h("option", { value: k, key: v }))))), index.h("gcds-button", { key: 'd3952275da85ba06b8147d6d954256ef1b0f4079', type: "submit", class: "gcds-search__button", exportparts: "button" }, index.h("gcds-icon", { key: 'a043d69293738b5beeee1c2ff2c81596e15a39a6', name: "search", label: I18N$7[lang].search, "fixed-width": true }))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsSignature = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9e7b4e9eb3ddd7d4826140ecf3214b6e3c011e2e' }, type === 'signature' ? (index.h(Tag, Object.assign({}, sigAttrs), index.h("div", { innerHTML: selectSVG }), svgLabel)) : (index.h("div", { class: "gcds-signature", innerHTML: selectSVG }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "type": ["validateType"],
...
const GcdsTopNav = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a6f1a411d942315d91c809dc01964919726c6a17' }, index.h("div", { key: 'c7aa58465b9c8b00c0fc98c5cb2076f71b93eab5', class: "gcds-top-nav" }, index.h("nav", { key: '64d8b3477818fd28fe31d02b00813320bcc76b37', "aria-label": `${label}${I18N$2[lang].navLabel}` }, index.h("ul", { key: 'cbf98a6a884f5c60026e733f112081888f05b172', class: "gcds-top-nav__container" }, index.h("gcds-nav-group", { key: 'c5e65207c4b11272261a2ec8737631a2c622227b', menuLabel: I18N$2[lang].menuLabel, closeTrigger: I18N$2[lang].closeTrigger, openTrigger: I18N$2[lang].menuLabel, class: "gcds-mobile-nav gcds-mobile-nav-topnav", ref: element => (this.mobile = element), lang: lang }, index.h("slot", { key: '5007a00f24466cdced473c1f0dcad5f6239d3dd3', name: "home" }), index.h("li", { key: '4814d9192b12c45325d5cb6c4d1443b84143b09e', class: `nav-container__list nav-list--${alignment}` }, index.h("ul", { key: 'db7082dfac66582051f5324adc8fe00821fc6b5d', class: `nav-container__list nav-list--${alignment}` }, index.h("slot", { key: '90dac207f2befecdd758079afa957dcb47de3231' })))))))));
    }
    get el() { return index.getElement(this); }
};
