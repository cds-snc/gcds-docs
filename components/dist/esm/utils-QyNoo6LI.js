...
const validationErrors = {
    ...
    fr: {
        ...
        tooLong: 'Saisissez {max} caractères ou moins pour continuer. Vous avez saisi {current} caractères.',
        tooShort: 'Saisissez au moins {min} caractères pour continuer. Vous avez saisi {current} caractères.',
        rangeUnderflow: 'Saisissez un nombre égal ou supérieur à {min} pour continuer.',
        rangeOverflow: 'Saisissez un nombre égal ou inférieur à {max} pour continuer.',
        stepMismatch: 'Saisissez un nombre parmi les options disponibles pour continuer. Les nombres les plus proches de celui que vous avez saisi sont {lower} et {upper}.',
...
const assignLanguage = (el) => {
    var _a;
    const rawLang = el.lang ||
        el.getAttribute('lang') ||
        ((_a = closestElement('[lang]', el)) === null || _a === void 0 ? void 0 : _a.getAttribute('lang')) ||
        'en';
