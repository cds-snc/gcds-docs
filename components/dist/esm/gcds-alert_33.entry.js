  ...
  */
  ...
  render() {
    ...
    return (h(Host, null, isOpen ?
      h("div", { class: `gcds-alert alert--role-${alertRole} ${isFixed ? 'alert--is-fixed' : ''}`, role: "alert", "aria-label": alertRole === 'danger' ? I18N$h[lang].label.danger
        ...
        h("button", { class: "alert__close-btn", onClick: (e) => this.onDismiss(e), "aria-label": I18N$h[lang].closeBtn }, h("gcds-icon", { "aria-hidden": "true", name: "times", size: "text" }))))))
      : null));
  }
...
const GcdsBreadcrumbs = class {
  ...
  */
  ...
  render() {
    ...
    return (h(Host, null, h("nav", { "aria-label": I18N$g[lang].label, class: "gcds-breadcrumbs" }, h("ol", { class: hideCanadaLink ? '' : 'has-canada-link' }, !hideCanadaLink ?
  ...
  */
  ...
  render() {
    ...
    return (h(Host, null, h(Tag, Object.assign({}, attrs, { id: buttonId, onBlur: (e) => this.onBlur(e), onFocus: (e) => this.onFocus(e), onClick: (e) => this.handleClick(e), class: `button--role-${buttonRole} button--${buttonStyle} button--${size}`, ref: element => this.shadowElement = element }, inheritedAttributes), h("slot", { name: "left" }), h("slot", null), type === 'link' && target === '_blank' ?
      h("gcds-icon", { name: "external-link", label: I18N$f[lang].label, "margin-left": "200" })
      : h("slot", { name: "right" }))));
  }
  get el() { return getElement(this); }
...
const GcdsDateModified = class {
  ...
  */
  ...
  render() {
    ...
    return (h(Host, null, h("dl", { class: "gcds-date-modified" }, h("dt", null, type === 'version' ? 'Version ' : I18N$e[lang].term), h("dd", null, type === 'version' ?
      h("slot", null)
      :
  ...
  */
  ...
  render() {
    ...
    return (h(Host, null, h("fieldset", Object.assign({ class: `gcds-fieldset ${hasError ? "gcds-fieldset--error" : ''}`, id: fieldsetId }, fieldsetAttrs, { "aria-labelledby": hint ? `legend-${fieldsetId} hint-${fieldsetId}` : `legend-${fieldsetId}`, tabindex: "-1", ref: element => this.shadowElement = element }), h("legend", { id: `legend-${fieldsetId}` }, legend, required ?
      h("strong", { class: "legend__required" }, "(", I18N$c[lang].required, ")")
  ...
  */
  ...
  render() {
    ...
    return (h(Host, null, h("div", { class: `gcds-file-uploader-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, h("gcds-label", Object.assign({}, attrsLabel, { "label-for": uploaderId, lang: lang })), hint ? h("gcds-hint", { hint: hint, "hint-id": uploaderId }) : null, errorMessage ?
      ...
      : null, h("div", { class: `file-uploader__input ${value.length > 0 ? "uploaded-files" : ''}` }, h("button", { type: "button", tabindex: "-1", onClick: () => this.shadowElement.click() }, I18N$b[lang].button.upload, h("gcds-icon", { name: "upload", "margin-left": "200" })), h("input", Object.assign({ type: "file", id: uploaderId, name: uploaderId }, attrsInput, { onBlur: (e) => this.onBlur(e), onFocus: (e) => this.onFocus(e), onChange: (e) => this.handleChange(e), "aria-invalid": hasError ? 'true' : 'false', ref: element => this.shadowElement = element })), value.length > 0 ?
      h("p", { id: "file-uploader__summary" }, h("span", null, I18N$b[lang].summary.selected, " "), value.map(file => (h("span", null, file, " "))))
      :
        h("p", { id: "file-uploader__summary" }, I18N$b[lang].summary.unselected)), value.length > 0 ? value.map(file => (h("div", { class: "file-uploader__uploaded-file", "aria-label": `${I18N$b[lang].removeFile} ${file}.` }, h("span", null, file), h("button", { onClick: (e) => this.removeFile(e) }, h("span", null, I18N$b[lang].button.remove), h("gcds-icon", { name: "times", size: "text", "margin-left": "200" }))))) : null)));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
...
const GcdsFooter = class {
  ...
  */
  ...
  render() {
    ...
    let subLinkCount = 0;
    return (h(Host, { role: "contentinfo" }, h("h2", { class: "gcds-footer__header" }, I18N$a[lang].about), (contextualLinksObject && contextualHeading) &&
      ...
      (h("div", { class: "gcds-footer__main" }, h("div", { class: "main__container" }, h("nav", { class: "main__govnav", "aria-label": I18N$a[lang].gov.heading }, h("h3", null, I18N$a[lang].gov.heading), h("ul", { class: "govnav__list" }, Object.keys(govNav).map((value) => h("li", null, h("a", { href: govNav[value].link }, govNav[value].text))))), h("nav", { class: "main__themenav", "aria-label": I18N$a[lang].themes.heading }, h("h4", { class: "themenav__header" }, I18N$a[lang].themes.heading), h("ul", { class: "themenav__list" }, Object.keys(themeNav).map((value) => h("li", null, h("a", { href: themeNav[value].link }, themeNav[value].text))))))))
      : null, h("div", { class: "gcds-footer__sub" }, h("div", { class: "sub__container" }, h("nav", { "aria-label": I18N$a[lang].site.heading }, h("h3", { class: "sub__header" }, I18N$a[lang].site.heading), h("ul", null, subLinks ?
  ...
  */
  ...
  render() {
    ...
    return (h(Host, { id: `label-for-${labelFor}`, onClick: this.onClick }, h("label", { htmlFor: labelFor, class: `gcds-label ${hideLabel ? 'label--hidden' : ''}`, ref: (focusEl) => (this.focusEl = focusEl) }, h("span", null, label), required ?
      h("span", { "aria-hidden": "true", class: "label--required" }, "(", I18N$9[lang].required, ")")
      : null)));
  }
  get el() { return getElement(this); }
};
...
const GcdsLangToggle = class {
  ...
  */
  ...
  render() {
    ...
    return (h(Host, null, h("div", null, h("h2", null, I18N$8[lang].heading), h("a", { href: href, lang: I18N$8[lang].abbreviation }, h("span", null, I18N$8[lang].language), h("abbr", { title: I18N$8[lang].language }, I18N$8[lang].abbreviation)))));
  }
  get el() { return getElement(this); }
};
  ...
  configurePaginationStep(page, end, mobile) {
    ...
    if (end) {
      return (h("li", null, end === "next" ?
        h("a", Object.assign({}, linkAttrs, { class: !mobile ? "gcds-pagination-end-button" : "gcds-pagination-end-button-mobile" }), I18N$6[this.lang].next, h("gcds-icon", { "margin-left": "200", name: "arrow-right" }))
        :
          h("a", Object.assign({}, linkAttrs, { class: !mobile ? "gcds-pagination-end-button" : "gcds-pagination-end-button-mobile" }), h("gcds-icon", { "margin-right": "200", name: "arrow-left" }), I18N$6[this.lang].previous)));
    }
    else {
    ...
    return (h(Host, { role: "navigation", "aria-label": label }, display === "list" ?
      ...
      :
        h("ul", { class: "gcds-pagination-simple" }, previousHref &&
          h("li", { class: "gcds-pagination-simple-previous" }, h("a", { href: previousHref, "aria-label": `${I18N$6[lang].previousPage}${previousLabel ? `: ${previousLabel}` : ""}`, onClick: (e) => this.onPageChange(e) }, h("gcds-icon", { "margin-right": "200", name: "arrow-left" }), h("div", { class: "gcds-pagination-simple-text" }, I18N$6[lang].previous), h("span", null, previousLabel))), nextHref &&
          h("li", { class: "gcds-pagination-simple-next" }, h("a", { href: nextHref, "aria-label": `${I18N$6[lang].nextPage}${nextLabel ? `: ${nextLabel}` : ""}`, onClick: (e) => this.onPageChange(e) }, h("div", { class: "gcds-pagination-simple-text" }, I18N$6[lang].next), h("span", null, nextLabel), h("gcds-icon", { "margin-left": "200", name: "arrow-right" }))))));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
