import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, F as Fragment } from './index-22a4f5b2.js';
        ...
        : alertRole === 'info'
          ...
          : alertRole === 'success'
            ...
            : alertRole === 'warning'
              ...
              : null })), h("div", { class: "alert__content" }, h("p", { class: "alert__heading" }, h("strong", null, heading)), h("slot", null)), !hideCloseBtn && (h("button", { class: "alert__close-btn", onClick: e => this.onDismiss(e), "aria-label": I18N$l[lang].closeBtn }, h("gcds-icon", { "aria-hidden": "true", name: "times", size: "text" }))))))) : null));
  }
...
const GcdsBreadcrumbs = class {
  ...
  render() {
    ...
    return (h(Host, null, h("nav", { "aria-label": I18N$k[lang].label, class: "gcds-breadcrumbs" }, h("ol", { class: hideCanadaLink ? '' : 'has-canada-link' }, !hideCanadaLink ? (h("gcds-breadcrumbs-item", { href: I18N$k[lang].link }, "Canada.ca")) : null, h("slot", null)))));
  }
  get el() { return getElement(this); }
};
...
const GcdsButton = class {
  ...
  render() {
    ...
    return (h(Host, null, h(Tag, Object.assign({}, attrs, { id: buttonId, onBlur: e => this.onBlur(e), onFocus: e => this.onFocus(e), onClick: e => this.handleClick(e), class: `button--role-${buttonRole} button--${buttonStyle} button--${size}`, ref: element => (this.shadowElement = element) }, inheritedAttributes, { part: "button" }), h("slot", { name: "left" }), h("slot", null), type === 'link' && target === '_blank' ? (h("gcds-icon", { name: "external-link", label: I18N$j[lang].label, "margin-left": "200" })) : (h("slot", { name: "right" })))));
  }
  get el() { return getElement(this); }
...
const GcdsDateModified = class {
  ...
  render() {
    ...
    return (h(Host, null, h("dl", { class: "gcds-date-modified" }, h("dt", null, type === 'version' ? 'Version ' : I18N$i[lang].term), h("dd", null, type === 'version' ? (h("slot", null)) : (h("time", null, h("slot", null)))))));
  }
  get el() { return getElement(this); }
};
...
const GcdsErrorSummary = class {
  ...
  render() {
    ...
    return (h(Host, null, h("div", { role: "alert", tabindex: "-1", ref: element => (this.shadowElement = element), class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0
        ? 'gcds-show'
        : ''}` }, h("h2", { class: "summary__heading" }, heading !== null && heading !== void 0 ? heading : I18N$h[lang].heading), h("ol", { class: "summary__errorlist" }, (hasSubmitted || errorLinks) &&
...
const GcdsFieldset = class {
  ...
  render() {
    ...
    return (h(Host, null, h("fieldset", Object.assign({ class: `gcds-fieldset ${hasError ? 'gcds-fieldset--error' : ''}`, id: fieldsetId }, fieldsetAttrs, { "aria-labelledby": hint
        ...
        : `legend-${fieldsetId}`, tabindex: "-1", ref: element => (this.shadowElement = element) }), h("legend", { id: `legend-${fieldsetId}` }, legend, required ? (h("strong", { class: "legend__required" }, "(", I18N$g[lang].required, ")")) : null), hint ? h("gcds-hint", { hint: hint, "hint-id": fieldsetId }) : null, errorMessage ? (h("gcds-error-message", { messageId: fieldsetId, message: errorMessage })) : null, h("slot", null))));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
    "errorMessage": ["validateErrorMessage"],
...
const GcdsFileUploader = class {
  ...
  render() {
    ...
    return (h(Host, null, h("div", { class: `gcds-file-uploader-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, h("gcds-label", Object.assign({}, attrsLabel, { "label-for": uploaderId, lang: lang })), hint ? h("gcds-hint", { hint: hint, "hint-id": uploaderId }) : null, errorMessage ? (h("gcds-error-message", { messageId: uploaderId, message: errorMessage })) : null, h("div", { class: `file-uploader__input ${value.length > 0 ? 'uploaded-files' : ''}` }, h("button", { type: "button", tabindex: "-1", onClick: () => this.shadowElement.click() }, I18N$f[lang].button.upload), h("input", Object.assign({ type: "file", id: uploaderId, name: uploaderId }, attrsInput, { onBlur: e => this.onBlur(e), onFocus: e => this.onFocus(e), onChange: e => this.handleChange(e), "aria-invalid": hasError ? 'true' : 'false', ref: element => (this.shadowElement = element) })), value.length > 0 ? (h("p", { id: "file-uploader__summary" }, h("span", null, I18N$f[lang].summary.selected, " "), value.map(file => (h("span", null, file, " "))))) : (h("p", { id: "file-uploader__summary" }, I18N$f[lang].summary.unselected))), value.length > 0
      ? value.map(file => (h("div", { class: "file-uploader__uploaded-file", "aria-label": `${I18N$f[lang].removeFile} ${file}.` }, h("span", null, file), h("button", { onClick: e => this.removeFile(e) }, h("span", null, I18N$f[lang].button.remove), h("gcds-icon", { name: "times", size: "text", "margin-left": "200" })))))
      : null)));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
...
const GcdsFooter = class {
  ...
  render() {
    ...
    let subLinkCount = 0;
    return (h(Host, { role: "contentinfo" }, h("h2", { class: "gcds-footer__header" }, I18N$e[lang].about), contextualLinksObject && contextualHeading && (h("div", { class: "gcds-footer__contextual" }, h("div", { class: "contextual__container" }, h("nav", { "aria-label": contextualHeading }, h("h3", { class: "contextual__header" }, contextualHeading), h("ul", { class: "contextual__list" }, Object.keys(contextualLinksObject).map(key => {
      if (contextualLinkCount < 3) {
        contextualLinkCount++;
        return (h("li", null, h("a", { href: contextualLinksObject[key] }, key)));
      }
    })))))), display === 'full' ? (h("div", { class: "gcds-footer__main" }, h("div", { class: "main__container" }, h("nav", { class: "main__govnav", "aria-label": I18N$e[lang].gov.heading }, h("h3", null, I18N$e[lang].gov.heading), h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (h("li", null, h("a", { href: govNav[value].link }, govNav[value].text)))))), h("nav", { class: "main__themenav", "aria-label": I18N$e[lang].themes.heading }, h("h4", { class: "themenav__header" }, I18N$e[lang].themes.heading), h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (h("li", null, h("a", { href: themeNav[value].link }, themeNav[value].text))))))))) : null, h("div", { class: "gcds-footer__sub" }, h("div", { class: "sub__container" }, h("nav", { "aria-label": I18N$e[lang].site.heading }, h("h3", { class: "sub__header" }, I18N$e[lang].site.heading), h("ul", null, subLinks
...
const GcdsHeader = class {
  ...
  get renderSkipToNav() {
    if (this.el.querySelector('[slot="skip-to-nav"]')) {
      ...
      return (h("nav", { class: "gcds-header__skip-to-nav" }, h("gcds-button", { type: "link", "button-role": "skip-to-content", href: this.skipToHref }, I18N$d[this.lang].skip)));
    }
    else {
      return;
    }
...
const GcdsLabel = class {
  ...
  render() {
    ...
    return (h(Host, { id: `label-for-${labelFor}`, onClick: this.onClick }, h("label", { htmlFor: labelFor, class: `gcds-label ${hideLabel ? 'label--hidden' : ''}`, ref: focusEl => (this.focusEl = focusEl) }, h("span", null, label), required ? (h("span", { "aria-hidden": "true", class: "label--required" }, "(", I18N$c[lang].required, ")")) : null)));
  }
  get el() { return getElement(this); }
};
...
const GcdsLangToggle = class {
  ...
  render() {
    ...
    return (h(Host, null, h("div", null, h("h2", null, I18N$b[lang].heading), h("a", { href: href, lang: I18N$b[lang].abbreviation }, h("span", null, I18N$b[lang].language), h("abbr", { title: I18N$b[lang].language }, I18N$b[lang].abbreviation)))));
  }
  get el() { return getElement(this); }
};
...
const GcdsLink = class {
  ...
  render() {
    ...
    return (h(Host, null, h("a", Object.assign({ role: "link", tabIndex: 0 }, attrs, { class: `link--${size} ${display != 'inline' ? `d-${display}` : ''}`, ref: element => (this.shadowElement = element), target: isExternal ? '_blank' : target, rel: isExternal ? 'noopener noreferrer' : rel }, inheritedAttributes, { part: "link", onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: () => this.gcdsClick.emit() }), h("slot", null), target === '_blank' || external ? (h("gcds-icon", { name: "external-link", label: I18N$a[lang].external, "margin-left": "100" })) : download !== undefined ? (h("gcds-icon", { name: "download", label: I18N$a[lang].download, "margin-left": "100" })) : href.toLowerCase().startsWith('mailto:') ? (h("gcds-icon", { "icon-style": "regular", name: "envelope", label: I18N$a[lang].email, "margin-left": "100" })) : (href.toLowerCase().startsWith('tel:') && (h("gcds-icon", { name: "phone", label: I18N$a[lang].phone, "margin-left": "100" }))))));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
    "size": ["validateSize"],
...
const GcdsPagination = class {
  ...
  configurePaginationStep(page, end, mobile) {
    ...
    if (end) {
      return (h("li", null, end === 'next' ? (h("a", Object.assign({}, linkAttrs, { class: !mobile
          ...
          : 'gcds-pagination-end-button-mobile' }), I18N$9[this.lang].next, h("gcds-icon", { "margin-left": "200", name: "arrow-right" }))) : (h("a", Object.assign({}, linkAttrs, { class: !mobile
          ? 'gcds-pagination-end-button'
  ...
  render() {
    ...
    return (h(Host, { role: "navigation", "aria-label": label }, display === 'list' ? (h("div", null, h("ul", { class: "gcds-pagination-list" }, this.listitems), h("ul", { class: "gcds-pagination-list-mobile-prevnext" }, this.mobilePrevNext))) : (h("ul", { class: "gcds-pagination-simple" }, previousHref && (h("li", { class: "gcds-pagination-simple-previous" }, h("a", { href: previousHref, "aria-label": `${I18N$9[lang].previousPage}${previousLabel ? `: ${previousLabel}` : ''}`, onClick: e => this.onPageChange(e) }, h("gcds-icon", { "margin-right": "200", name: "arrow-left" }), h("div", { class: "gcds-pagination-simple-text" }, I18N$9[lang].previous), h("span", null, previousLabel)))), nextHref && (h("li", { class: "gcds-pagination-simple-next" }, h("a", { href: nextHref, "aria-label": `${I18N$9[lang].nextPage}${nextLabel ? `: ${nextLabel}` : ''}`, onClick: e => this.onPageChange(e) }, h("div", { class: "gcds-pagination-simple-text" }, I18N$9[lang].next), h("span", null, nextLabel), h("gcds-icon", { "margin-left": "200", name: "arrow-right" }))))))));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
...
const GcdsSideNav = class {
  ...
  render() {
    ...
    return (h(Host, null, h("nav", { "aria-label": `${label}${I18N$6[lang].navLabel}` }, h("h2", { class: "gcds-side-nav__heading" }, label), h("gcds-nav-group", { menuLabel: "Menu", closeTrigger: lang == 'fr' ? 'Fermer' : 'Close', openTrigger: "Menu", class: "gcds-mobile-nav", role: "menu", ref: element => (this.mobile = element), lang: lang }, h("slot", null)))));
  }
  get el() { return getElement(this); }
};
...
const GcdsSignature = class {
  ...
  render() {
    ...
    h("a", { href: I18N$5[lang].link, innerHTML: selectSVG })) : (h("div", { class: "gcds-signature", innerHTML: selectSVG }))));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
    "type": ["validateType"],
...
const GcdsStepper = class {
  ...
  render() {
    ...
    return (h(Host, null, h("h6", { class: "gcds-stepper" }, `${I18N$4[lang].step} ${currentStep} ${I18N$4[lang].of} ${totalSteps}`)));
  }
  get el() { return getElement(this); }
};
