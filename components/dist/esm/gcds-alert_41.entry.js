...
const GcdsBreadcrumbs = class {
    ...
    render() {
        ...
        return (h(Host, null, h("nav", { "aria-label": I18N$m[lang].label, class: "gcds-breadcrumbs" }, h("ol", { class: hideCanadaLink ? '' : 'has-canada-link' }, !hideCanadaLink ? (h("gcds-breadcrumbs-item", { href: I18N$m[lang].link }, "Canada.ca")) : null, h("slot", null)))));
    }
    get el() { return getElement(this); }
};
...
const GcdsButton = class {
    ...
    render() {
        ...
        return (h(Host, null, h(Tag, Object.assign({}, attrs, { id: buttonId, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => this.handleClick(e), class: `gcds-button button--role-${buttonRole} button--${size}`, ref: element => (this.shadowElement = element) }, inheritedAttributes, { part: "button" }), h("slot", null), type === 'link' && target === '_blank' ? (h("gcds-icon", { name: "external-link", label: I18N$l[lang].label, "margin-left": "200" })) : null)));
    }
...
const GcdsDateInput = class {
    ...
    render() {
        ...
        const day = (h("gcds-input", Object.assign({ name: "day", label: I18N$j[lang].day, inputId: "day", type: "number", size: 2, disabled: disabled, value: this.dayValue, onInput: e => this.handleInput(e, 'day'), onChange: e => {
...
const GcdsFieldset = class {
    ...
    render() {
        ...
        return (h(Host, null, h("fieldset", Object.assign({ class: `gcds-fieldset ${hasError ? 'gcds-fieldset--error' : ''}`, id: fieldsetId }, fieldsetAttrs, { "aria-labelledby": hint
                ...
                : `legend-${fieldsetId}`, tabindex: "-1", ref: element => (this.shadowElement = element) }), h("legend", { id: `legend-${fieldsetId}` }, legend, required ? (h("span", { class: "legend__required" }, "(", I18N$g[lang].required, ")")) : null), hint ? h("gcds-hint", { "hint-id": fieldsetId }, hint) : null, errorMessage ? (h("gcds-error-message", { messageId: fieldsetId }, errorMessage)) : null, h("slot", null))));
    }
    static get delegatesFocus() { return true; }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const GcdsStepper = class {
    ...
    render() {
        ...
        return (h(Host, null, this.validateRequiredProps() && (h("gcds-heading", { tag: tag, class: "gcds-stepper", "margin-top": "0", "margin-bottom": "300" }, h("span", { class: "gcds-stepper__steps" }, `${I18N$4[lang].step} ${currentStep} ${I18N$4[lang].of} ${totalSteps}`, h("gcds-sr-only", null, " : ")), h("slot", null)))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
