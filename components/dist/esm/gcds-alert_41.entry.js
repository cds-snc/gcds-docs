...
const GcdsButton = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'f879906e23b82587fd539f65f4089d52f7ebac8f' }, h(Tag, Object.assign({ key: 'a2193325c515bcafa420a4c3b70aac52c4a4d248' }, attrs, { id: buttonId, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => this.handleClick(e), class: `gcds-button button--role-${buttonRole} button--${size}`, ref: element => (this.shadowElement = element) }, inheritedAttributes, { part: "button" }), h("slot", { key: '5d106a6af6fa23a394fc1387c3ccb96c93b7b490' }), type === 'link' && target === '_blank' ? (h("gcds-icon", { name: "external-link", label: I18N$l[lang].label, "margin-left": "200" })) : null)));
    }
...
const GcdsCard = class {
    ...
    render() {
        ...
        if (this.validateRequiredProps()) {
            return (h(Host, { key: '124e17eb577553da16ff506265dd5d7cba152b4b' }, h("div", { key: '97a3007905773f8d492d2e922db6492e754bee78', class: "gcds-card" }, imgSrc && (h("img", { key: '34fadc31c5777696b71e63a11e930bc3837ce6bb', src: imgSrc, alt: imgAlt ? imgAlt : '', class: "gcds-card__image" })), badge && !errors.includes('badge') && (h("gcds-text", { key: '021898a01f410cb6847cacf4adc67cca076a59dc', id: "gcds-badge", class: "gcds-badge", "text-role": "light", "margin-bottom": "0", size: "caption" }, h("strong", { key: 'f0dded8e1880527bef338860136730df5722646e' }, h("gcds-sr-only", { key: 'ae5f58fc919fc3654b2f8d64b540e60b92a136eb' }, I18N$k[lang].tagged), badge))), Element != 'a' ? (h(Element, Object.assign({ class: "gcds-card__title" }, taggedAttr), h("gcds-link", { href: href }, cardTitle))) : (h("gcds-link", Object.assign({ href: href, class: "gcds-card__title" }, taggedAttr), cardTitle)), renderDescription)));
        }
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const GcdsDateInput = class {
    ...
    render() {
        ...
        const day = (h("gcds-input", Object.assign({ key: '3957eb8d33c856038a21ef2af45293e6124b48ce', name: "day", label: I18N$j[lang].day, inputId: "day", type: "number", size: 2, disabled: disabled, value: this.dayValue, onInput: e => this.handleInput(e, 'day'), onChange: e => {
...
const GcdsDateModified = class {
    ...
    render() {
        ...
        return (h(Host, { key: '6a35ef0fbee9deb64fb76fb14179eb7f92258671' }, h("dl", { key: '0b9057598c023a246c5f0afea8a7d8943cd947ef', class: "gcds-date-modified" }, h("dt", { key: 'ce426d33cbb358b0fd2fefe9328b2eebbb998196' }, h("gcds-text", { key: 'f11bc0d5d3737efa8ff9e3555668d854bb84e9ec', display: "inline", "margin-bottom": "0" }, type === 'version' ? I18N$i[lang].version : I18N$i[lang].date)), h("dd", { key: '4ef846ec165917abc28ba20e5343c513430d3da0' }, h("gcds-text", { key: '656ce0d42ed450dd316947c5473c3ea5703b8c76', display: "inline", "margin-bottom": "0" }, type === 'version' ? (h("slot", null)) : (h("time", null, h("slot", null))))))));
    }
    get el() { return getElement(this); }
};
...
const GcdsErrorSummary = class {
    ...
    render() {
        ...
        return (h(Host, { key: '1e78ebc181c6f25c95316a980d0618ce30854e71' }, h("div", { key: '5bc1d9c797665c4fcbc3483ee0075fa0d30498f4', role: "alert", tabindex: "-1", ref: element => (this.shadowElement = element), class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0
                ? 'gcds-show'
                : ''}` }, h("gcds-heading", { key: 'b25ea686a38672748271ac291d09af604344883a', tag: "h2", "margin-top": "0", "margin-bottom": "300" }, heading !== null && heading !== void 0 ? heading : I18N$h[lang].heading), h("ol", { key: '059c002f1c0bc84e9c1ced147bce03f8f95640c2', class: "summary__errorlist" }, (hasSubmitted || errorLinks) &&
