...
const GcdsAlert = class {
    ...
    render() {
        ...
        return (h(Host, { key: '28c68640cfa9a7c35800d3f755b1202afc3d78b0' }, isOpen ? (h("div", { class: `gcds-alert alert--role-${alertRole} ${isFixed ? 'alert--is-fixed' : ''}`, role: alertRole === 'info' || alertRole === 'success'
                ? 'status'
...
const GcdsFileUploader = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'cbfcb18f04afd2723b3e06b9f4d2a892a2e5b511' }, h("div", { key: 'b181c9753ac2e088d034aa6e0bc6f16bcd47ab6a', class: `gcds-file-uploader-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, h("gcds-label", Object.assign({ key: '8bc181208c5ec0b5b3ac365f4c1642509d46f382' }, attrsLabel, { "hide-label": hideLabel, "label-for": uploaderId, lang: lang })), hint ? h("gcds-hint", { "hint-id": uploaderId }, hint) : null, errorMessage ? (h("gcds-error-message", { messageId: uploaderId }, errorMessage)) : null, h("div", { key: 'c25ac05901231e8d186457289c449b6ac17a3a24', class: `file-uploader__input ${value.length > 0 ? 'uploaded-files' : ''}`, onDrop: e => this.handleDrop(e), onDragOver: e => e.preventDefault() }, h("button", { key: '7a72325415f11928d9a71d206c997c4259751896', type: "button", tabindex: "-1", onClick: () => this.shadowElement.click() }, I18N$i[lang].button.upload), h("input", Object.assign({ key: '5a566254bde25d9276fa04063ee0ebf5e80f1d2e', type: "file", id: uploaderId }, attrsInput, { onBlur: () => this.onBlur(), onFocus: () => this.gcdsFocus.emit(), onInput: e => this.handleInput(e, this.gcdsInput), onChange: e => this.handleInput(e, this.gcdsChange), "aria-invalid": hasError ? 'true' : 'false', ref: element => (this.shadowElement = element) })), value.length > 0 ? (h("gcds-sr-only", { id: "file-uploader__summary" }, h("span", null, I18N$i[lang].summary.selected, " "), value.map(file => (h("span", null, file, " "))))) : (h("gcds-sr-only", { id: "file-uploader__summary" }, I18N$i[lang].summary.unselected)), h("gcds-sr-only", { key: '7361b43685e1b9012bb14ba33fa51fa24b638d6e', role: "status", "aria-live": "polite" }, removedFileMessage)), value.length > 0
            ? value.map(file => (h("div", { class: "file-uploader__uploaded-file", "aria-label": `${I18N$i[lang].removeFile} ${file}.` }, h("gcds-text", { "margin-bottom": "0" }, file), h("button", { onClick: e => this.removeFile(e), ref: element => {
                    if (element && !this.uploadedFiles.includes(element)) {
                        this.uploadedFiles = [...this.uploadedFiles, element];
                    }
                } }, h("span", null, I18N$i[lang].button.remove), h("gcds-icon", { name: "close", size: "text", "margin-left": "150" })))))
            : null)));
    }
    static get delegatesFocus() { return true; }
    static get formAssociated() { return true; }
...
const GcdsHeading = class {
    ...
    render() {
        ...
        const Tag = tag;
        return (h(Host, { key: 'c4cb5e3a667ea1b7f0297966e472b6e19ac65357' }, h(Tag, { key: 'afe7e86f7896f7b9761fa47279726373cf98a109', class: `
            gcds-heading
            ${headingRole ? `role-${headingRole}` : ''}
            ${characterLimit ? 'limit' : ''}
            ${marginTop ? `mt-${marginTop}` : ''}
            ${marginBottom ? `mb-${marginBottom}` : ''}
          ` }, h("slot", { key: '6df48e86fb118f48e2c92324fc238aefc078f2ec' }))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
        "tag": [{
...
const GcdsLabel = class {
    ...
    render() {
        ...
        return (h(Host, { key: '37a6681d7fed70d37313a5d93d5d61de1502e538', id: `label-for-${labelFor}` }, h("label", { key: '1ce8e12182daeeff2d47e667028c735c9bab44e3', htmlFor: labelFor, class: `gcds-label ${hideLabel ? 'label--hidden' : ''}` }, h("span", { key: '5883396a2787821cf582b66bf21e6553fcc2641e' }, label), required ? (h("span", { "aria-hidden": "true", class: "label--required" }, "(", I18N$d[lang].required, ")")) : null)));
    }
    get el() { return getElement(this); }
};
...
const GcdsLangToggle = class {
    ...
    render() {
        ...
        return (h(Host, { key: '62aa9c22bff1a0f8778c5835f7e63646cbfe1a46' }, h("div", { key: '88d41598195886ac785f5892a98b21b4ec6305a1', class: "gcds-lang-toggle" }, h("gcds-sr-only", { key: '6237c11ac97300f34d12b1514353715ff08cc3c7', id: "lang-toggle__heading", tag: "h2" }, I18N$c[lang].heading), h("gcds-link", { key: 'd71e4738bf386fce9bd917c7ebad9996e668c109', size: "regular", href: href, lang: I18N$c[lang].abbreviation }, h("span", { key: 'ad354cf5d68967abc49af62bd13dcb403f1247b0' }, I18N$c[lang].language), h("abbr", { key: '5d4d1a9b12e51c2fdb1740aea1d0a237b926ba85', title: I18N$c[lang].language }, I18N$c[lang].abbreviation)))));
    }
    get el() { return getElement(this); }
};
...
const GcdsNotice = class {
    ...
    render() {
        ...
        return (h(Host, { key: '03e09c9feca750421af5461d3530a3b459f8c0a1' }, this.validateRequiredProps() && (h("section", { key: 'a662553fe15c9b04690a5fa3b5904d7c8f04ebcf', class: `gcds-notice notice--role-${noticeRole}` }, h("gcds-icon", { key: '710bf5e2c0eddf52f765d1247b79147139a57f44', class: "notice__icon", size: "h4", name: iconRoles[noticeRole] }), h("div", { key: '148dc06af3014b33b0180865839cf920b18aabdd' }, h("gcds-heading", { key: '7f9c4947154fc5ecf7cf7023968da3d5e7c48c46', tag: noticeTitleTag, "margin-top": "0", "margin-bottom": "100", class: "notice__heading" }, h("gcds-sr-only", { key: 'f954a5fd1b3846dfe82e69be40eac77cc10a363a', tag: "span" }, I18N$a[this.lang][noticeRole]), noticeTitle), h("slot", { key: 'ac208cbe2c085f09358cd043b5a925b881d21300' }))))));
    }
    get el() { return getElement(this); }
};
...
const renderFilterSortModal = element => {
    ...
    return (h("div", { class: "gcds-table__filters" }, h("gcds-button", { size: "small", "button-role": "primary", onClick: () => {
        ...
        } }, I18N$3[lang].modalClose)), h("form", { class: "gcds-table__modal-body", onKeyUp: ev => {
            var _a, _b, _c, _d, _e;
            if (ev.key === 'Enter') {
                if (justOpened) {
                    justOpened = false;
...
const GcdsTopicMenu = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'f57f3ad6fed21288c1dee157293a55838ed3f621' }, h("nav", { key: 'dca2b15071085e65059b7d885ca95187207c314a', class: "gcds-topic-menu", "aria-labelledby": "gcds-topic-menu__heading" }, h("gcds-sr-only", { key: 'aeec862fe3f79f7b6c6d6b6fc666081af9d13073', id: "gcds-topic-menu__heading", tag: "h2" }, I18N[lang].menuLabelFull), h("p", { key: '2e22bbe8d65a2ee5a4a61f31eaef95baea0ccee3', id: "gcds-topic-menu-desc", hidden: true }, I18N[lang].buttonLabel), h("button", { key: '293680fd663e42f65ae2844acebc1b68290b1c56', "aria-haspopup": "true", "aria-expanded": this.open.toString(), "aria-describedby": 'gcds-topic-menu-desc', onClick: async () => await this.toggleNav(), ref: element => (this.menuButton = element), class: home && 'gcds-topic-menu--home' }, this.lang == 'en' ? (h(Fragment, null, h("gcds-sr-only", { tag: "span" }, I18N[lang].menuLabelHidden), I18N[lang].menuToggle)) : (h(Fragment, null, I18N[lang].menuToggle, h("gcds-sr-only", { tag: "span" }, I18N[lang].menuLabelHidden))), h("gcds-icon", { key: '107b59d320ba4123c51474c45440a825bd433847', name: "chevron-down", "margin-left": "100", size: "text-small" })), h("ul", { key: '2fc64b82ca3ad4a57f10467d5532471d6000f858', role: "menu", "aria-orientation": "vertical", "data-top-menu": true, innerHTML: this.listItems, ref: element => (this.themeList = element) }))));
    }
    get el() { return getElement(this); }
};
