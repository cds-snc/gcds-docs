import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, F as Fragment } from './index-4c0d7937.js';
                ...
                : alertRole === 'info'
                    ...
                    : alertRole === 'success'
                        ...
                        : alertRole === 'warning'
                            ...
                            : null })), h("div", { class: "alert__content" }, h("p", { class: "alert__heading" }, h("strong", null, heading)), h("slot", null)), !hideCloseBtn && (h("button", { class: "alert__close-btn", onClick: e => this.onDismiss(e), "aria-label": I18N$m[lang].closeBtn }, h("gcds-icon", { "aria-hidden": "true", name: "times", size: "text" }))))))) : null));
    }
...
const GcdsBreadcrumbs = class {
    ...
    render() {
        ...
        return (h(Host, null, h("nav", { "aria-label": I18N$l[lang].label, class: "gcds-breadcrumbs" }, h("ol", { class: hideCanadaLink ? '' : 'has-canada-link' }, !hideCanadaLink ? (h("gcds-breadcrumbs-item", { href: I18N$l[lang].link }, "Canada.ca")) : null, h("slot", null)))));
    }
    get el() { return getElement(this); }
};
...
const GcdsButton = class {
    ...
    render() {
        ...
        return (h(Host, null, h(Tag, Object.assign({}, attrs, { id: buttonId, onBlur: e => this.onBlur(e), onFocus: e => this.onFocus(e), onClick: e => this.handleClick(e), class: `gcds-button button--role-${buttonRole} button--${size}`, ref: element => (this.shadowElement = element) }, inheritedAttributes, { part: "button" }), h("slot", null), type === 'link' && target === '_blank' ? (h("gcds-icon", { name: "external-link", label: I18N$k[lang].label, "margin-left": "200" })) : null)));
    }
    get el() { return getElement(this); }
...
const GcdsFooter = class {
    ...
    render() {
        ...
        })))))), display === 'full' ? (h("div", { class: "gcds-footer__main" }, h("div", { class: "main__container" }, h("nav", { class: "main__govnav", "aria-labelledby": "govnav__header" }, h("h3", { id: "govnav__header" }, I18N$e[lang].gov.heading), h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (h("li", null, h("a", { href: govNav[value].link }, govNav[value].text)))))), h("nav", { class: "main__themenav", "aria-labelledby": "themenav__header" }, h("h4", { id: "themenav__header", class: "themenav__header" }, I18N$e[lang].themes.heading), h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (h("li", null, h("a", { href: themeNav[value].link }, themeNav[value].text))))))))) : null, h("div", { class: "gcds-footer__sub" }, h("div", { class: "sub__container" }, h("nav", { "aria-labelledby": "sub__header" }, h("h3", { id: "sub__header", class: "sub__header" }, I18N$e[lang].site.heading), h("ul", null, subLinks
...
const GcdsHeader = class {
    ...
    get renderSkipToNav() {
        if (this.el.querySelector('[slot="skip-to-nav"]')) {
            ...
            return (h("nav", { class: "gcds-header__skip-to-nav" }, h("gcds-link", { href: this.skipToHref }, I18N$d[this.lang].skip)));
        }
        else {
            return;
        }
