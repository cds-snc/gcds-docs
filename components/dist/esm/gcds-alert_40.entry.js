import { r as registerInstance, d as createEvent, h, a as Host, c as getElement } from './index-Bjnb6Mm3.js';
...
const GcdsDateInput = class {
    ...
    render() {
        ...
        return (h(Host, { key: '7c0838bb2578726ce1b5482d56f0b2c0cb8e9062', name: name, onBlur: () => this.onBlur() }, this.validateRequiredProps() && (h("fieldset", Object.assign({ key: '91d18432610b87ab450b37a1d4b4c69fa22545f1', class: "gcds-date-input__fieldset" }, fieldsetAttrs), h("legend", { key: '54afc89772cec988f4d70f4348a0181b1aa129fb', id: "date-input-legend" }, legend, required ? (h("span", { class: "legend__required" }, I18N$l[lang].required)) : null), hint ? (h("gcds-hint", { id: "date-input-hint", "hint-id": "date-input" }, hint)) : null, errorMessage ? (h("div", null, h("gcds-error-message", { id: "date-input-error", messageId: "date-input" }, errorMessage))) : null, format == 'compact'
            ? [month, year]
            : lang == 'en'
                ? [month, day, year]
                : [day, month, year]))));
...
const GcdsDateModified = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'ae1d5ceeefb2826a675edeca1f2fa0c81828b425' }, this.validateRequiredProps() && (h("dl", { key: '989b2ca91b4887f0a47c956c022550b475221a7d', class: "gcds-date-modified" }, h("dt", { key: '1d05ceb07362ad9b010769489ad3b0a057d9d754' }, h("gcds-text", { key: '61bb8fbe85f6614eeec0ebb9fabacc7b710dfc8d', display: "inline", "margin-bottom": "0" }, type === 'version' ? I18N$k[lang].version : I18N$k[lang].date)), h("dd", { key: '45cdfd7944ba0ca7ea4251d673eaf2f59f2346a0' }, h("gcds-text", { key: 'f2c0744b1a28ff5cd98ff8e3da8ce44384656b4d', display: "inline", "margin-bottom": "0" }, type === 'version' ? (h("slot", null)) : (h("time", null, h("slot", null)))))))));
    }
    get el() { return getElement(this); }
};
...
const GcdsErrorSummary = class {
    ...
    render() {
        ...
        return (h(Host, { key: '921bc4798b6c8ce0e52cc0e8377548d2f9f90a06' }, h("div", { key: 'c88ac2207f650dfcf2afc92c2382261e6062103d', role: "alert", tabindex: "-1", ref: element => (this.shadowElement = element), class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0
                ? 'gcds-show'
                : ''}` }, h("gcds-heading", { key: '3503d99d5747612a36354097ebe466c88311e4dc', tag: "h2", "margin-top": "0", "margin-bottom": "225" }, heading !== null && heading !== void 0 ? heading : I18N$j[lang].heading), h("ol", { key: '0751c01bfe6c44457fb9923c814fa1831aae4444', class: "summary__errorlist" }, (hasSubmitted || errorLinks) &&
...
const GcdsFooter = class {
    ...
    render() {
        ...
        let subLinkCount = 0;
        return (h(Host, { key: '5837980656caab330e544099513140319f21bf2b', role: "contentinfo", "aria-label": "Footer" }, h("gcds-sr-only", { key: '224923db016c4e7487a21e0c738b075b488b6af9', tag: "h2" }, I18N$h[lang].about), contextualLinksObject && contextualHeading && (h("div", { key: '6e59417fd295f8ad99f56ed6b2d60cadff12905f', class: "gcds-footer__contextual" }, h("div", { key: 'eed81cfd3b34bb7c55bb640b37770c11075add60', class: "contextual__container" }, h("nav", { key: '5bcc993b76d9bbbd45accce9800cd85db91d120e', "aria-labelledby": "contextual__heading" }, h("h3", { key: '7180a682e2c50b500dda0ce979fe511ca65a4e43', id: "contextual__heading", class: "contextual__heading" }, contextualHeading), h("ul", { key: '043ca05a01cf7a8161589839c8164d0001727759', class: "contextual__list" }, Object.keys(contextualLinksObject).map(key => {
            if (contextualLinkCount < 3) {
                contextualLinkCount++;
                return (h("li", null, h("gcds-link", { size: "small", href: contextualLinksObject[key] }, key)));
            }
        })))))), display === 'full' ? (h("div", { class: "gcds-footer__main" }, h("div", { class: "main__container" }, h("nav", { class: "main__govnav", "aria-labelledby": "govnav__heading" }, h("h3", { id: "govnav__heading" }, I18N$h[lang].gov.heading), h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (h("li", null, h("gcds-link", { size: "small", href: govNav[value].link }, govNav[value].text)))))), h("nav", { class: "main__themenav", "aria-labelledby": "themenav__heading" }, h("gcds-sr-only", { tag: "h4", id: "themenav__heading" }, I18N$h[lang].themes.heading), h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (h("li", null, h("gcds-link", { size: "small", href: themeNav[value].link }, themeNav[value].text))))))))) : null, h("div", { key: 'c220125a35a924a3acb840cf186b4cc5e09d865e', class: "gcds-footer__sub" }, h("div", { key: '5efa5ad5f42d7a4482a33f023acd68b5831ad429', class: "sub__container" }, h("nav", { key: '8c239b963a088c9b9dc2281b0c60e56ce2fcc7a2', "aria-labelledby": "sub__heading" }, h("gcds-sr-only", { key: 'fbeb0d6c5b102fdd6de322bcd56e54d4ba91dca2', tag: "h3", id: "sub__heading" }, I18N$h[lang].site.heading), h("ul", { key: 'f76aa2db981e25762466367ad9ca887c0fdd72b6' }, subLinks
...
const GcdsLabel = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'ffac8e66f0bb20913277b17a04080913cc661f84', id: `label-for-${labelFor}` }, h("label", { key: 'b663e88ae67734de47f91cae325f0ebdfa41bbcc', htmlFor: labelFor, class: `gcds-label ${hideLabel ? 'label--hidden' : ''}` }, h("span", { key: 'cf9369de0b3f91bfb67087b14969e0c137cf3f99' }, label), required ? (h("span", { "aria-hidden": "true", class: "label--required" }, "(", I18N$d[lang].required, ")")) : null)));
    }
    get el() { return getElement(this); }
};
...
const GcdsLangToggle = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'e7c2600f42e0d941cbaef4e2599645dfdd65348a' }, h("div", { key: 'f4794500d6da469c8a39ec04a21ce636b40d64ea', class: "gcds-lang-toggle" }, h("gcds-sr-only", { key: '9d6672ff42b404b7af4c9689cfc38197dda42cca', id: "lang-toggle__heading", tag: "h2" }, I18N$c[lang].heading), h("gcds-link", { key: '247e2ee655c2f9e16e7b6e19320864ef06bd8280', size: "regular", href: href, lang: I18N$c[lang].abbreviation }, h("span", { key: 'da07bdf4b438ad9144e5ba301a73b83c2aabf713' }, I18N$c[lang].language), h("abbr", { key: '10363892959c246a591463fbdbd42f605c5a164b', title: I18N$c[lang].language }, I18N$c[lang].abbreviation)))));
    }
    get el() { return getElement(this); }
};
