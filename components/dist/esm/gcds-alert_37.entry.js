import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, F as Fragment } from './index-0e8c1d80.js';
        ...
        : alertRole === 'info'
          ...
          : alertRole === 'success'
            ...
            : alertRole === 'warning'
              ...
              : null })), h("div", { class: "alert__content" }, h("p", { class: "alert__heading" }, h("strong", null, heading)), h("slot", null)), !hideCloseBtn && (h("button", { class: "alert__close-btn", onClick: e => this.onDismiss(e), "aria-label": I18N$k[lang].closeBtn }, h("gcds-icon", { "aria-hidden": "true", name: "times", size: "text" }))))))) : null));
  }
...
const GcdsBreadcrumbs = class {
  ...
  render() {
    ...
    return (h(Host, null, h("nav", { "aria-label": I18N$j[lang].label, class: "gcds-breadcrumbs" }, h("ol", { class: hideCanadaLink ? '' : 'has-canada-link' }, !hideCanadaLink ? (h("gcds-breadcrumbs-item", { href: I18N$j[lang].link }, "Canada.ca")) : null, h("slot", null)))));
  }
  get el() { return getElement(this); }
};
...
const GcdsButton = class {
  ...
  render() {
    ...
    return (h(Host, null, h(Tag, Object.assign({}, attrs, { id: buttonId, onBlur: e => this.onBlur(e), onFocus: e => this.onFocus(e), onClick: e => this.handleClick(e), class: `button--role-${buttonRole} button--${buttonStyle} button--${size}`, ref: element => (this.shadowElement = element) }, inheritedAttributes, { part: "button" }), h("slot", { name: "left" }), h("slot", null), type === 'link' && target === '_blank' ? (h("gcds-icon", { name: "external-link", label: I18N$i[lang].label, "margin-left": "200" })) : (h("slot", { name: "right" })))));
  }
  get el() { return getElement(this); }
...
const GcdsDateModified = class {
  ...
  render() {
    ...
    return (h(Host, null, h("dl", { class: "gcds-date-modified" }, h("dt", null, type === 'version' ? 'Version ' : I18N$h[lang].term), h("dd", null, type === 'version' ? (h("slot", null)) : (h("time", null, h("slot", null)))))));
  }
  get el() { return getElement(this); }
};
...
const GcdsErrorSummary = class {
  ...
  render() {
    ...
    return (h(Host, null, h("div", { role: "alert", tabindex: "-1", ref: element => (this.shadowElement = element), class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0
        ? 'gcds-show'
        : ''}` }, h("h2", { class: "summary__heading" }, heading !== null && heading !== void 0 ? heading : I18N$g[lang].heading), h("ol", { class: "summary__errorlist" }, (hasSubmitted || errorLinks) &&
...
const GcdsFieldset = class {
  ...
  render() {
    ...
    return (h(Host, null, h("fieldset", Object.assign({ class: `gcds-fieldset ${hasError ? 'gcds-fieldset--error' : ''}`, id: fieldsetId }, fieldsetAttrs, { "aria-labelledby": hint
        ...
        : `legend-${fieldsetId}`, tabindex: "-1", ref: element => (this.shadowElement = element) }), h("legend", { id: `legend-${fieldsetId}` }, legend, required ? (h("strong", { class: "legend__required" }, "(", I18N$f[lang].required, ")")) : null), hint ? h("gcds-hint", { hint: hint, "hint-id": fieldsetId }) : null, errorMessage ? (h("gcds-error-message", { messageId: fieldsetId, message: errorMessage })) : null, h("slot", null))));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
    "errorMessage": ["validateErrorMessage"],
...
const GcdsFileUploader = class {
  ...
  render() {
    ...
    return (h(Host, null, h("div", { class: `gcds-file-uploader-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, h("gcds-label", Object.assign({}, attrsLabel, { "label-for": uploaderId, lang: lang })), hint ? h("gcds-hint", { hint: hint, "hint-id": uploaderId }) : null, errorMessage ? (h("gcds-error-message", { messageId: uploaderId, message: errorMessage })) : null, h("div", { class: `file-uploader__input ${value.length > 0 ? 'uploaded-files' : ''}` }, h("button", { type: "button", tabindex: "-1", onClick: () => this.shadowElement.click() }, I18N$e[lang].button.upload), h("input", Object.assign({ type: "file", id: uploaderId, name: uploaderId }, attrsInput, { onBlur: e => this.onBlur(e), onFocus: e => this.onFocus(e), onChange: e => this.handleChange(e), "aria-invalid": hasError ? 'true' : 'false', ref: element => (this.shadowElement = element) })), value.length > 0 ? (h("p", { id: "file-uploader__summary" }, h("span", null, I18N$e[lang].summary.selected, " "), value.map(file => (h("span", null, file, " "))))) : (h("p", { id: "file-uploader__summary" }, I18N$e[lang].summary.unselected))), value.length > 0
      ? value.map(file => (h("div", { class: "file-uploader__uploaded-file", "aria-label": `${I18N$e[lang].removeFile} ${file}.` }, h("span", null, file), h("button", { onClick: e => this.removeFile(e) }, h("span", null, I18N$e[lang].button.remove), h("gcds-icon", { name: "times", size: "text", "margin-left": "200" })))))
      : null)));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
...
const GcdsFooter = class {
  ...
  render() {
    ...
    let subLinkCount = 0;
    return (h(Host, { role: "contentinfo" }, h("h2", { class: "gcds-footer__header" }, I18N$d[lang].about), contextualLinksObject && contextualHeading && (h("div", { class: "gcds-footer__contextual" }, h("div", { class: "contextual__container" }, h("nav", { "aria-label": contextualHeading }, h("h3", { class: "contextual__header" }, contextualHeading), h("ul", { class: "contextual__list" }, Object.keys(contextualLinksObject).map(key => {
      if (contextualLinkCount < 3) {
        contextualLinkCount++;
        return (h("li", null, h("a", { href: contextualLinksObject[key] }, key)));
      }
    })))))), display === 'full' ? (h("div", { class: "gcds-footer__main" }, h("div", { class: "main__container" }, h("nav", { class: "main__govnav", "aria-label": I18N$d[lang].gov.heading }, h("h3", null, I18N$d[lang].gov.heading), h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (h("li", null, h("a", { href: govNav[value].link }, govNav[value].text)))))), h("nav", { class: "main__themenav", "aria-label": I18N$d[lang].themes.heading }, h("h4", { class: "themenav__header" }, I18N$d[lang].themes.heading), h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (h("li", null, h("a", { href: themeNav[value].link }, themeNav[value].text))))))))) : null, h("div", { class: "gcds-footer__sub" }, h("div", { class: "sub__container" }, h("nav", { "aria-label": I18N$d[lang].site.heading }, h("h3", { class: "sub__header" }, I18N$d[lang].site.heading), h("ul", null, subLinks
...
const GcdsHeader = class {
  ...
  get renderSkipToNav() {
    if (this.el.querySelector('[slot="skip-to-nav"]')) {
      ...
      return (h("nav", { class: "gcds-header__skip-to-nav" }, h("gcds-button", { type: "link", "button-role": "skip-to-content", href: this.skipToHref }, I18N$c[this.lang].skip)));
    }
    else {
      return;
    }
...
const GcdsLabel = class {
  ...
  render() {
    ...
    return (h(Host, { id: `label-for-${labelFor}`, onClick: this.onClick }, h("label", { htmlFor: labelFor, class: `gcds-label ${hideLabel ? 'label--hidden' : ''}`, ref: focusEl => (this.focusEl = focusEl) }, h("span", null, label), required ? (h("span", { "aria-hidden": "true", class: "label--required" }, "(", I18N$b[lang].required, ")")) : null)));
  }
  get el() { return getElement(this); }
};
...
const GcdsLangToggle = class {
  ...
  render() {
    ...
    return (h(Host, null, h("div", null, h("h2", null, I18N$a[lang].heading), h("a", { href: href, lang: I18N$a[lang].abbreviation }, h("span", null, I18N$a[lang].language), h("abbr", { title: I18N$a[lang].language }, I18N$a[lang].abbreviation)))));
  }
  get el() { return getElement(this); }
};
...
//# sourceMappingURL=gcds-alert_37.entry.js.map