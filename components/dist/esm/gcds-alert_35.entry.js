  ...
  configurePaginationStep(page, end, mobile) {
    ...
    if (end) {
      return (h("li", null, end === "next" ?
        h("a", Object.assign({}, linkAttrs, { class: !mobile ? "gcds-pagination-end-button" : "gcds-pagination-end-button-mobile" }), I18N$8[this.lang].next, h("gcds-icon", { "margin-left": "200", name: "arrow-right" }))
        :
          h("a", Object.assign({}, linkAttrs, { class: !mobile ? "gcds-pagination-end-button" : "gcds-pagination-end-button-mobile" }), h("gcds-icon", { "margin-right": "200", name: "arrow-left" }), mobile ? I18N$8[this.lang].previousMobile : I18N$8[this.lang].previous)));
    }
    else {
    ...
    return (h(Host, { role: "navigation", "aria-label": label }, display === "list" ?
      ...
      :
        h("ul", { class: "gcds-pagination-simple" }, previousHref &&
          h("li", { class: "gcds-pagination-simple-previous" }, h("a", { href: previousHref, "aria-label": `${I18N$8[lang].previousPage}${previousLabel ? `: ${previousLabel}` : ""}`, onClick: (e) => this.onPageChange(e) }, h("gcds-icon", { "margin-right": "200", name: "arrow-left" }), h("div", { class: "gcds-pagination-simple-text" }, I18N$8[lang].previous), h("span", null, previousLabel))), nextHref &&
          h("li", { class: "gcds-pagination-simple-next" }, h("a", { href: nextHref, "aria-label": `${I18N$8[lang].nextPage}${nextLabel ? `: ${nextLabel}` : ""}`, onClick: (e) => this.onPageChange(e) }, h("div", { class: "gcds-pagination-simple-text" }, I18N$8[lang].next), h("span", null, nextLabel), h("gcds-icon", { "margin-left": "200", name: "arrow-right" }))))));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
...
const GcdsSearch = class {
  ...
  */
  ...
  render() {
    ...
    return (h(Host, null, h("div", { class: "gcds-search" }, h("h2", { class: "gcds-search__header" }, I18N$6[lang].search), h("form", { action: formAction, method: method, role: "search", onSubmit: () => this.gcdsSubmit.emit(), class: "gcds-search__form" }, h("gcds-label", { label: labelText, "label-for": searchId, "hide-label": true }), h("input", Object.assign({ type: "search", id: searchId, list: "search-list", size: 34, maxLength: 170, onChange: () => this.gcdsChange.emit(), onFocus: () => this.gcdsFocus.emit(), onBlur: () => this.gcdsBlur.emit() }, attrsInput, { class: "gcds-search__input" })), suggested &&
      h("datalist", { id: "search-list" }, suggested.map((k, v) => h("option", { value: k, key: v }))), h("gcds-button", { type: "submit", class: "gcds-search__button", exportparts: "button" }, h("gcds-icon", { name: "search", label: I18N$6[lang].search, "fixed-width": true }))))));
  }
  get el() { return getElement(this); }
};
...
const GcdsSideNav = class {
  ...
  */
  ...
  render() {
    ...
    return (h(Host, null, h("nav", { "aria-label": `${label}${I18N$5[lang].navLabel}` }, h("h2", { class: "gcds-side-nav__heading" }, label), h("gcds-nav-group", { menuLabel: "Menu", closeTrigger: lang == 'fr' ? 'Fermer' : 'Close', openTrigger: "Menu", class: "gcds-mobile-nav", role: "menu", ref: element => this.mobile = element, lang: lang }, h("slot", null)))));
  }
  get el() { return getElement(this); }
};
  ...
  */
  ...
  render() {
    ...
    return (h(Host, null, h("div", { class: `gcds-textarea-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, h("gcds-label", Object.assign({}, attrsLabel, { "hide-label": hideLabel, "label-for": textareaId, lang: lang })), hint ? h("gcds-hint", { hint: hint, "hint-id": textareaId }) : null, errorMessage ?
      ...
      h("p", { id: `textarea__count-${textareaId}`, "aria-live": "polite" }, value == undefined ? `${characterCount} ${I18N$3[lang].characters.allowed}`
        :
...
const GcdsTopicMenu = class {
  ...
  */
  ...
  render() {
    ...
    return (h(Host, null, h("nav", { class: "gcds-topic-menu" }, h("h2", { class: "gcds-topic-menu__heading" }, "Menu"), h("button", { "aria-haspopup": "true", "aria-expanded": this.open.toString(), "aria-label": I18N$1[lang].buttonLabel, onClick: async () => await this.toggleNav(), ref: element => this.menuButton = element, class: home && 'gcds-topic-menu--home' }, this.lang == 'en' ?
      h(Fragment, null, h("span", { class: "gcds-topic-menu__main" }, "Main "), "Menu")
      :
        h(Fragment, null, "Menu", h("span", { class: "gcds-topic-menu__main" }, " principal")), h("gcds-icon", { name: "chevron-down", "margin-left": "150", size: "caption" })), h("ul", { role: "menu", "aria-orientation": "vertical", "data-top-menu": true, innerHTML: this.listItems, ref: element => this.themeList = element }))));
  }
  get el() { return getElement(this); }
};
