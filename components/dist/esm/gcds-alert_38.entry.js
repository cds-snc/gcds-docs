...
const GcdsAlert = class {
    ...
    render() {
        ...
        return (h(Host, { key: '9ca55e2b6562e7dfda9e367b21b5d2aa3bbe37d7' }, isOpen ? (h("div", { class: `gcds-alert alert--role-${alertRole} ${isFixed ? 'alert--is-fixed' : ''}`, role: "alert", "aria-label": alertRole === 'danger'
            ...
            }, "aria-label": I18N$o[lang].closeBtn }, h("gcds-icon", { "aria-hidden": "true", name: "close", size: "text" }))))))) : null));
    }
    ...
    configurePaginationStep(page, end, mobile) {
        ...
        if (end) {
            return (h("li", null, end === 'next' ? (h("a", Object.assign({}, linkAttrs, { class: !mobile
                    ...
                    : 'gcds-pagination-end-button-mobile' }), h("span", null, I18N$7[this.lang].listNext), h("gcds-icon", { "margin-left": "150", name: "chevron-right" }))) : (h("a", Object.assign({}, linkAttrs, { class: !mobile
                    ? 'gcds-pagination-end-button'
...
const GcdsSideNav = class {
    ...
    render() {
        ...
        return (h(Host, { key: '8221fa7bc5a7504bc9373dcd791a955ccf7595a8' }, h("nav", { key: 'd03d74cdcf03e78fdfe4ea8f782d44eb0a4c3229', "aria-label": `${label}${I18N$4[lang].navLabel}`, class: "gcds-side-nav" }, h("h2", { key: '296c2207b09b4ac48f2d753e03ef1f3f7bbb9443', class: "gcds-side-nav__heading" }, label), h("ul", { key: '487bf04ce21f73a22dd12582257463c670025b64' }, h("gcds-nav-group", { key: 'd22d5cad3feca464205e5449175c532ee62756a7', menuLabel: I18N$4[lang].menuLabel, closeTrigger: I18N$4[lang].closeTrigger, openTrigger: I18N$4[lang].menuLabel, class: "gcds-mobile-nav", ref: element => (this.mobile = element), lang: lang }, h("slot", { key: '25f76853bdba7ac0b60c871dc29238d2b9321278' }))))));
    }
    get el() { return getElement(this); }
};
...
const GcdsText = class {
    ...
    render() {
        ...
        return (h(Host, { key: '2633edb632cbb2afa8a88b8bd9508d2f298c1d90', class: `${display != 'block' ? `d-${display}` : ''}` }, h("p", { key: '3c06bbe8cd91246a4f212e54631d3c790a90ab19', class: `
            gcds-text
