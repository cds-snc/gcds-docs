...
const GcdsSelect = /*@__PURE__*/ proxyCustomElement(class GcdsSelect extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
export { GcdsSelect as G, defineCustomElement as d };

//# sourceMappingURL=gcds-select2.js.map