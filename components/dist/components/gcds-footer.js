...
const GcdsFooter$1 = /*@__PURE__*/ proxyCustomElement(class GcdsFooter extends HTMLElement {
  ...
  render() {
    ...
    })))))), display === 'full' ? (h("div", { class: "gcds-footer__main" }, h("div", { class: "main__container" }, h("nav", { class: "main__govnav", "aria-label": I18N[lang].gov.heading }, h("h3", null, I18N[lang].gov.heading), h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (h("li", null, h("a", { href: govNav[value].link }, govNav[value].text)))))), h("nav", { class: "main__themenav", "aria-label": I18N[lang].themes.heading }, h("h4", { class: "themenav__header" }, I18N[lang].themes.heading), h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (h("li", null, h("a", { href: themeNav[value].link }, themeNav[value].text))))))))) : null, h("div", { class: "gcds-footer__sub" }, h("div", { class: "sub__container" }, h("nav", { "aria-label": I18N[lang].site.heading }, h("h3", { class: "sub__header" }, I18N[lang].site.heading), h("ul", null, subLinks
...
function defineCustomElement$1() {
  ...
  const components = ["gcds-footer", "gcds-signature"];
