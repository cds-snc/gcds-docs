...
<AnatomyImage
  ...
  alt="Le composant de pagination, avec des numéros pointant vers les différentes parties de la structure de la pagination simple."
/>
...
<AnatomyImage
  ...
  alt="Le composant de pagination, avec des numéros pointant vers les différentes parties de la structure de la pagination sous forme de liste sur écran de grande taille."
/>
...
<AnatomyImage
  ...
  alt="Le composant de pagination, avec des numéros pointant vers les différentes parties de la structure de la pagination sous forme de liste sur écran de petite taille."
/>
