...
import { CodePreview, TablePreviewScript, CodeBuilder } from '~components';
...
<CodePreview
  iframe
  demoClass='columns-data-preview'
  code={`<gcds-table
...
<CodePreview iframe demoClass='filter-preview'
  code={`<gcds-table filter></gcds-table>`}
/>
...
<CodePreview iframe demoClass="filter-value-preview"
  code={`<gcds-table filter filter-value="Dav"></gcds-table>`}
/>
...
<CodePreview iframe demoClass='pagination-preview'
  code={`<gcds-table pagination></gcds-table>`}
/>
...
<CodePreview iframe demoClass='pagination-current-page-preview'
  code={`<gcds-table pagination pagination-current-page="2"
  ></gcds-table>`}
/>
...
<CodePreview iframe demoClass='pagination-size-preview'
  code={`<gcds-table pagination pagination-size="10"
  ></gcds-table>`}
/>
...
<CodePreview iframe demoClass='pagination-size-options-preview'
  code={`<gcds-table pagination pagination-size-options="[10, 15, 20, 25, 0]"></gcds-table>`}
/>
...
<CodePreview iframe demoClass='sort-preview'
  code={`<gcds-table sort></gcds-table>`}
/>
