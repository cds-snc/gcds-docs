...
dateModified: '2025-04-15T15:47:33-04:00'
---

import { AnatomyImage, AnatomyList } from '~components';
import anatomy from './assets/gcds-icon-anatomy.svg';
...
<AnatomyImage
  src={anatomy.src}
  alt="Le diagramme montre une icône d’information à côté des mots « Texte d’accompagnement ». Le texte et l’icône ont la même couleur et la même taille."
/>
