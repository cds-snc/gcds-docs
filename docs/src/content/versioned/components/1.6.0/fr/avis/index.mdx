...
pageTitle: Avis - Cas d'utilisation
componentName: Avis
tagName: '<gcds-notice>'
...
<a href={links.fr.errorMessage}>Message d’erreur</a> ou <a href={links.fr.errorSummary}>résumé des erreurs</a> pour des erreurs au sein d’un champ de formulaire, d’une page ou d’un flux.
