...
- Évitez d'utiliser du texte en gras comme titre. Le [titre](/fr/composants/titre) est le composant accessible conçu pour identifier les sections de contenu.
...
- Utilisez uniquement l'italique dans les cas suivants :
  <ul class="list-circle">
    ...
    <li>Titres de publications, d'œuvres d'art et de documents mathématiques ou scientifiques.</li>
  </ul>
