...
import anatomyOpen from './assets/gcds-details-anatomy-open.svg';
import anatomyClosed from './assets/gcds-details-anatomy-closed.svg';
...
<AnatomyImage
  src={anatomyOpen.src}
  alt="L'anatomie du composant en savoir plus identifiant l'icône, une flèche pointant vers le bas, le titre du lien en savoir plus sur ce sujet et le contenu représenté par du texte information additionnelle."
/>

### Composant Détails fermé

<AnatomyImage
  src={anatomyClosed.src}
  alt="L'anatomie du composant en savoir plus identifiant l'icône, une flèche pointant vers la droite et le titre du lien en savoir plus sur ce sujet."
/>
