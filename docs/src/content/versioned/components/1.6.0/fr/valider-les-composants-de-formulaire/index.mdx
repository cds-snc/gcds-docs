...
pageTitle: Valider les composants de formulaire
description: Les composants de formulaire de Système de design GC ont une propriété de validation intégrée. La validation s’exécute par défaut lors de l’évènement blur. Les champs comportant des exigences de saisie spécifiques seront validés même s’ils ne sont pas obligatoires.
version: 1.6.0
dateModified: '2026-07-20T12:02:56-07:00'
---

import { ErrorMessageTable, HelpUs } from "~components";

# Valider les composants de formulaire
...
<gcds-details details-title="Exemple de validation de texte">
  ...
  <gcds-input
    input-id="form-name"
    label="Nom de la bibliothèque de composants"
    name="library-name"
    required
  ></gcds-input>
