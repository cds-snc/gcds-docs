...
pageTitle: "Bouton - Cas d'utilisation"
...
<a href={links.fr.link}>Liens</a> lorsque vous souhaitez naviguer vers une nouvelle page, un site web, un fichier ou une section de la page actuelle.

<a href={links.fr.details}>Détails</a> lorsque vous souhaitez masquer ou afficher une section de contenu.
...
Remarque : Utilisez le <a href={links.fr.link}>composant lien</a> pour intégrer un lien dans le texte d'un paragraphe ou d'une barre de navigation.
...
<gcds-grid columns="1fr" columns-tablet="1fr 2fr" align-items="start">
  <ComponentPreview label="Aperçu du bouton principal" class="mt-500" demoClass="px-225 py-300">
...
<gcds-grid columns="1fr" columns-tablet="1fr 2fr" align-items="start">
  <ComponentPreview label="Aperçu du Bouton de démarrage" class="mt-500" demoClass="px-225 py-300">
...
<gcds-grid columns="1fr" columns-tablet="1fr 2fr" align-items="start">
  <ComponentPreview label="Aperçu du bouton secondaire" class="mt-500" demoClass="px-225 py-300">
...
<gcds-grid columns="1fr" columns-tablet="1fr 2fr" align-items="start">
  <ComponentPreview label={"Aperçu du bouton « Danger »"} class="mt-500" demoClass="px-225 py-300">
