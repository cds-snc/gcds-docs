...
<AnatomyImage
  src={anatomy.src}
  alt="La structure d'une carte représentée par 5 éléments: le conteneur, le badge, l'image, le titre et la description."
/>
...
Organisez les cartes à l'aide du <a href={links.fr.grid}>composant grille</a>.
...
<img src={example.src} alt="Cartes groupées en deux rangées. La première rangée contient 3 cartes (carte à 4 colonnes de largeur). La deuxième rangée contient deux cartes (carte à 6 colonnes de largeur)" />
