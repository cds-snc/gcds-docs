...
pageTitle: Chemin de navigation - Design
...
import anatomy from './assets/gcds-breadcrumbs-anatomy.svg';
...
<AnatomyImage
  src={anatomy.src}
  alt="Chemin de navigation avec deux liens côte à côte et un chevron pointant vers la droite entre eux. Chaque élément du composant est identifié à l’aide d’un chiffre."
/>
...
Conseil : Si vous utilisez aussi un autre composant de navigation, comme la <gcds-link href={links.fr.topNav}>barre de navigation supérieure</gcds-link> ou la <gcds-link href={links.fr.sideNav}>barre de navigation latérale</gcds-link>, harmonisez les libellés des liens. L'expérience de navigation s'en trouvera uniforme et aidera les utilisateurs et utilisatrices à comprendre leur emplacement actuel.
