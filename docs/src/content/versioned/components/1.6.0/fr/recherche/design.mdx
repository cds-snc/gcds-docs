...
dateModified: '2026-03-09T12:02:56-07:00'
---

import { AnatomyImage, AnatomyList } from '~components';
import { links } from '~i18n/links';
import anatomy from './assets/gcds-search-anatomy.svg';
...
<AnatomyImage
  src={anatomy.src}
  alt="Une boîte de recherche avec la mention « Rechercher dans Canada.ca » à l’intérieur, à côté d’un bouton de loupe immédiatement à droite. Chaque élément du composant est identifié à l’aide d’un chiffre."
/>
...
- La recherche est requise dans l’<gcds-link href={links.fr.header}>en-tête</gcds-link> des pages standard et de campagne de Canada.ca.
