...
dateModified: '2026-03-05T12:02:56-07:00'
---

import { AnatomyImage, AnatomyList } from '~components';
import { links } from '~i18n/links';
import anatomy from './assets/gcds-link-anatomy.svg';
...
<AnatomyImage
  src={anatomy.src}
  alt="Une étiquette soulignée pour indiquer qu'il s'agit d'un lien interactif que l'on peut suivre. Une icône avec une flèche pointant vers le bas se trouve à droite du lien."
/>
...
Conseil : Utilisez des éléments de navigation comme le <gcds-link href={links.fr.breadcrumbs}>chemin de navigation</gcds-link> ou la <gcds-link href={links.fr.topNav}>barre de navigation supérieure</gcds-link> pour qu'une personne puisse revenir à leur emplacement original.
