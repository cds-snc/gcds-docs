...
requiredCanada: true
requiredGc: true
dateModified: '2026-08-27T15:47:33-04:00'
---
...
<CheckList>
  <li><a href={links.en.signature}>Signature.</a></li>
  <li><a href={links.en.langToggle}>Language toggle.</a></li>
  <li>Skip-to-content <a href={links.en.link}>link.</a></li>
...
- Set up a skip-to-content <gcds-link href={links.en.link}>link</gcds-link> as a shortcut for people using an assistive technology and improve keyboard navigation. The link skips navigation elements to lead directly to the main page content.
...
- Consider using the <gcds-link href={links.en.topNav}>top navigation</gcds-link> for:
