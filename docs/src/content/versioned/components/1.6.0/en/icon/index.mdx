...
<a href={links.en.text}>Text</a> to display written content in a styled and formatted paragraph.

<a href={links.en.notice}>Notice</a> to display a short, prominent message.
