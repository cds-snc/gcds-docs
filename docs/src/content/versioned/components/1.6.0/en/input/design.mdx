...
<AnatomyImage
  src={anatomy.src}
  alt="Input anatomy showing the Input label, Hint text/ example message and dark blue outline white box for text input."
/>
...
- Choose unique labels for each input and <gcds-link href={links.en.textarea}>textarea</gcds-link> within a page, like "Your full name", "Manager's name".
