...
<AnatomyImage
  src={anatomy.src}
  alt="A search box with the words “Search Canada.ca” inside next to a magnifying glass button immediately on the right. Each individual element of the component has a number pointing to it."
/>
...
- Search is required in the <gcds-link href={links.en.header}>header</gcds-link> on Canada.ca standard and campaign pages.
...
<gcds-details details-title="What’s required on a Canada.ca standard or campaign page" class="mb-300">
  ...
  <ul class="list-disc">
    ...
    <li>Use <span lang="fr">“Rechercher dans Canada.ca”</span> as the search prompt text in French.</li>
  </ul>
