...
<AnatomyImage
  src={anatomy.src}
  alt="Checkboxes anatomy showing the labels “legend” at the top followed by “hint text” underneath. Under that are two checkboxes with labels and hint text beside them. One of the checkboxes has a checkmark."
/>
