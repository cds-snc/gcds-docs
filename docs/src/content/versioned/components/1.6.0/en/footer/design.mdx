...
<AnatomyList>
  ...
  <li>
    <p>The <strong>GC footer links band</strong> contains the official Government of Canada wordmark and up to five links. Some of the links are optional and some can be modified.</p>
...
<AnatomyImage
  src="/images/en/components/anatomy/gcds-footer-anatomy.svg"
...
<gcds-details details-title="What’s required on a Canada.ca standard page" class="mb-300">
  ...
  <ul class="list-disc mb-300">
    <li>Main band.</li>
    <li>
      <p class="mb-0">GC footer links band.</p>
