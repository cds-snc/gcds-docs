...
pageTitle: Accessibilité au sein de Système de design GC
description: L'outil Système de design GC respecte ou dépasse les exigences des Règles pour l'accessibilité des contenus Web (WCAG) niveau 2.1 AA, ce qui le rend totalement conforme aux normes d'accessibilité du gouvernement du Canada.
---
...
L'outil Système de design GC respecte ou dépasse les exigences des Règles pour l'accessibilité des contenus Web (WCAG) niveau 2.1 AA, ce qui le rend totalement conforme aux <gcds-link external href={links.fr.tbsStandardsOnWebA11y}> normes d'accessibilité du gouvernement du Canada </gcds-link>.
...
<gcds-card
  ...
  href={links.fr.accessibilityTesting}
  card-title-tag="h3"
...
Si vous avec des questions ou si vous rencontrez des obstacles en matière d'accessibilité lors de l'utilisation de Système de design GC, <gcds-link href={links.fr.contact}>contactez-nous</gcds-link>.
