...
pageTitle: Outils de tests d'accessibilité
description: Si vous voulez faire vos propres tests, voici quelques outils et processus que vous pouvez utiliser pour obtenir une meilleure couverture pour votre site Web ou votre application.
---
...
1. Utilisez nos composants Web modernes que <gcds-link href={links.fr.accessibility}>nous avons testés</gcds-link>.
2. Suivez les conseils en matière d'accessibilité sur nos <gcds-link href={links.fr.components}>pages de composants</gcds-link>.
...
Ces outils ne sont pas fournis ni approuvés par le gouvernement du Canada. Référencez nos <gcds-link href={links.fr.termsOfUse}>Conditions d'utilisation</gcds-link> lorsque vous consultez des sites Web qui n'appartiennent pas au gouvernement du Canada.
...
Si vous avez des questions ou rencontrez des obstacles lors de tests d'accessibilité supplémentaires visant Système de design GC, <gcds-link href={links.fr.contact}>contactez-nous</gcds-link>.
