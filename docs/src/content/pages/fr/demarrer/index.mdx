...
import bannerDesign from '~assets/img/common/start-to-use/banner-design.svg';
import bannerDevelop from '~assets/img/common/start-to-use/banner-develop.svg';
...
Utilisez les bibliothèques de Système de design GC dans Figma pour créer des expériences front-end cohérentes et accessibles pour les outils et services du gouvernement du Canada. Nos composants sont conçus pour les sites statiques et les applications dynamiques.
...
<gcds-button button-role="secondary" type="link" href={links.fr.startToUseDesign}>Configurer une bibliothèque Figma</gcds-button>
...
- Construisez des produits qui <gcds-link href={links.fr.accessibility}>répondent aux normes d'accessibilité du GC ou qui les surpassent</gcds-link>.
...
- Système de design GC utilise des <gcds-link href={links.fr.designTokens}>unités de style</gcds-link> pour capturer les décisions de marque et de design dans le code pour des éléments de style comme les couleurs, la typographie et l'espacement.
...
<gcds-button button-role="secondary" type="link" href={links.fr.startToUseDevelop}>Installer Système de design GC</gcds-button>
