...
pageTitle: Installation dans un projet HTML
description: Utilisez les composants Web de Système de design GC directement dans un projet HTML. Ces composants s'adaptent à tout cadriciel et ont un comportement similaire aux éléments HTML natifs.
---
...
Si vous utilisez les cadres React, Angular ou Vue, consultez la <gcds-link href={links.fr.startToUseDevelop}>page d'installation</gcds-link> pour connaître les options propres à chaque cadre.
...
Vérifiez régulièrement s'il y a des <gcds-link href={links.fr.releaseNotes} external>nouvelles versions de Système de design GC</gcds-link> afin de mettre à jour la dernière version épinglée.
...
Nous recommandons d'utiliser les <gcds-link href={links.fr.cssShortcuts} external>raccourcis CSS de Système de design GC</gcds-link> pour appliquer des classes utilitaires CSS prédéfinies. Ces classes sont conformes à nos composants et aident à construire plus rapidement tout en assurant l'uniformité.
...
<link
  rel="stylesheet"
  href="https://cdn.design-system.canada.ca/@gcds-core/css-shortcuts@||shortcuts-version||/dist/gcds-css-shortcuts.min.css"
/>
```
