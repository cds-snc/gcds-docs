...
pageTitle: Installation dans un projet Vue
description: Pour faciliter l'intégration des composants Web de Système de design GC dans les projets Vue, le paquet gcds-components-vue propose différentes enveloppes Vue.
---
...
Pour faciliter l'intégration des composants Web de Système de design GC dans les projets Vue, le paquet <gcds-link href={links.fr.npmGcdsComponentsVue} external>gcds-components-vue</gcds-link> propose différentes enveloppes Vue.
