...
pageTitle: Entente sur les niveaux de service
description: Le Service numérique canadien (SNC), d'Emploi et Développement social Canada, possède et exploite le service Système de design GC.
---
...
- Héberger <gcds-link href={links.fr.home}>Système de design GC</gcds-link> ainsi qu'offrir l'assistance qui s'y rapporte.
...
- Alerter la clientèle par le biais de notre <gcds-link href={links.fr.home}>site Web</gcds-link> et de la <gcds-link href={links.fr.contact}>liste de diffusion</gcds-link> si Système de design GC est indisponible pour quelque raison que ce soit, et ce, dès que le SNC apprend la situation.
...
Le SNC est tenu de transmettre à la clientèle toute information relative à une interruption du service AWS, Amazon CloudFront, Figma ou npm, et ce, par le biais du <gcds-link href={links.fr.home}>site Web</gcds-link> et de la <gcds-link href={links.fr.contact}>liste de diffusion</gcds-link> de Système de design GC.

## Garantie sur le temps de fonctionnement

La présente entente sur les niveaux de service (ENS) vise l'infrastructure utilisant la <gcds-link href={links.fr.startToUseDevelop}>base de code</gcds-link> et la <gcds-link href={links.fr.home}>base de données</gcds-link> de Système de design GC.
...
Si l'équipe de Système de design GC doit planifier une interruption de service, elle en informera la clientèle une semaine à l'avance par le biais de son <gcds-link href={links.fr.home}>site Web</gcds-link> et de la <gcds-link href={links.fr.contact}>liste de diffusion</gcds-link> et tentera de faire en sorte que le temps d'arrêt planifié n'interfère pas avec l'exploitation du système.
...
- Page <gcds-link href={links.fr.contact} external>Nous contacter</gcds-link> sur le site Web de Système de design GC.
- <gcds-link href={links.fr.githubCompsIssues} external>New issue</gcds-link> (nouveau problème) dans le référentiel GitHub du SNC.
...
L'équipe de Système de design GC notifiera la clientèle de toute période de maintenance planifiée au moins deux jours ouvrables avant le début de la période en question par le biais de son <gcds-link href={links.fr.home}>site Web</gcds-link> et de la <gcds-link href={links.fr.contact}>liste de diffusion</gcds-link>. Les périodes de maintenance planifiées seront programmées pour survenir en dehors des périodes d'activité élevée.

Une perte de disponibilité du service survenant en dehors d'une période de maintenance planifiée mais causée par des travaux effectués durant la période de maintenance planifiée est considérée comme une interruption de service. Les renseignements liés aux périodes de maintenance planifiée sont communiqués par le biais de la <gcds-link href={links.fr.contact}>liste de diffusion</gcds-link>.

### Avis de mise hors service

Si le SNC n'est plus en mesure d'offrir du soutien technique pour Système de design GC et de l'exploiter pour des raisons qui échappent à son contrôle, il en informera la clientèle deux mois à l'avance par le biais de son <gcds-link href={links.fr.home}>site Web</gcds-link> et de la <gcds-link href={links.fr.contact}>liste de diffusion</gcds-link>.
...
- Conformément aux <gcds-link href={links.fr.termsOfUse}>conditions d'utilisation de Système de design GC</gcds-link>, la clientèle a pour responsabilité de veiller à ce que les <gcds-link href="https://www.canada.ca/fr/secretariat-conseil-tresor/sujets/communications-gouvernementales/exigences-image-marque/protection-juridique-symboles-officiels-gouvernement-canada.html" external>symboles officiels du gouvernement du Canada</gcds-link> ne soient utilisés que lorsque la loi l'autorise et conformément au <gcds-link href="https://www.canada.ca/fr/secretariat-conseil-tresor/services/communications-gouvernementales/norme-graphique.html" external>Programme fédéral de l'image de marque</gcds-link> du Canada.
