...
pageTitle: Ordre
description: "La classe ordre définit la propriété order. Elle détermine l'ordre visuel des éléments dans une boîte d’élément flexible. Par défaut, les éléments flexibles suivent l'ordre dans lequel ils apparaissent dans le HTML. La propriété order peut changer leur position sans modifier la structure HTML."
...
<div class="d-flex"> <p class="order-1">1</p> <p class="order-3">2</p> <p class="order-2">3</p> </div>
</CodePreview>
...
<CodePreview demoClass="example-styled-items gap-300">
<div class="d-flex"> <p>1</p> <p>2</p> <p class="order-first">3</p> </div>
</CodePreview>
...
<CodePreview demoClass="example-styled-items gap-300">
<div class="d-flex"> <p class="order-last">1</p> <p>2</p> <p>3</p> </div>
</CodePreview>
...
<CodePreview demoClass="example-styled-items gap-300">
<div class="d-flex"> <p>1</p> <p class="order-none">2</p> <p>3</p> </div>
</CodePreview>
