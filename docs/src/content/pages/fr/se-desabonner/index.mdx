...
description: Désabonnez-vous de la liste de diffusion de GC Design System pour ne plus recevoir de courriels en anglais et en français.
...
<form class="my-600 unsubscribe-form" name="unsubscribeFR" method="post" action="/api/submission">
  ...
  <gcds-button button-role="primary" type="submit">Se désabonner</gcds-button>
</form>