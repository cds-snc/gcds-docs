...
pageTitle: Accessibility testing tools
description: If you want to do your own testing, here are some tools and processes you can use to get better coverage for your website or app.
---
...
1. Use our modern web components that <gcds-link href={links.en.accessibility}>we've tested</gcds-link>.
2. Follow the accessibility guidance on our <gcds-link href={links.en.components}>component pages</gcds-link>.
...
These tools are not provided or endorsed by the Government of Canada. Reference our <gcds-link href={links.en.termsOfUse}>Terms of use</gcds-link> when interacting with websites not under the control of Government of Canada.
...
If you have any questions about or run into barriers when doing additional accessibility testing for GC Design System, <gcds-link href={links.en.contact}>contact us</gcds-link>.