...
pageTitle: Accessibility in GC Design System
description: GC Design System meets or exceeds WCAG 2.1 AA, making it fully compliant with Government of Canada accessibility standards.
---
...
GC Design System meets or exceeds WCAG 2.1 AA, making it fully compliant with <gcds-link external href={links.en.tbsStandardsOnWebA11y}> Government of Canada accessibility standards</gcds-link>.
...
<gcds-card
  ...
  href={links.en.accessibilityTesting}
  card-title-tag="h3"
...
If you have any questions or encounter any accessibility barriers while using GC Design System, <gcds-link href={links.en.contact}>contact us</gcds-link>.
