...
description: A design system is never complete. We're committed to building with the people who use our products.
---
...
<gcds-grid columns="1fr" columns-tablet="1fr 1fr" columns-desktop="1fr 1fr">
  <gcds-card
    ...
    href={ links.en.contactMailingList }
...
Submit your contributions to our next priorities directly in GitHub, with an <gcds-link href={ links.en.githubGetStarted } external>account</gcds-link>.
...
<gcds-button button-role="secondary" type="link" href={ links.en.githubCompsPriority } external>Contribute in Github</gcds-button>
<gcds-button button-role="secondary" type="link" href={ links.en.contact } external>Contact us</gcds-button>
...
Submit your feature request directly in GitHub, with an <gcds-link href={ links.en.githubGetStarted } external>account</gcds-link>.
...
More on our <gcds-link href={ links.en.roadmap }>roadmap</gcds-link>.
