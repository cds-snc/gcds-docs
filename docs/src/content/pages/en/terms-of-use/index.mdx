...
description: This document defines the terms and responsibilities that you agree to by using GC Design System.
---
...
You agree to GC Design System's <gcds-link href={links.en.privacy}>privacy notice</gcds-link> and <gcds-link href={links.en.sla}>service level agreement</gcds-link>.
...
If you have any questions about the terms and conditions for using GC Design System, <gcds-link href={links.en.contact}>contact us</gcds-link>.
