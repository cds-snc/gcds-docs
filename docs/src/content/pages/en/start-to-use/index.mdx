...
pageTitle: Start to use
description: Get started using GC Design System for design and development.
---
...
<gcds-button button-role="secondary" type="link" href={links.en.startToUseDesign}>Set up a Figma library</gcds-button>
...
- Build products that <gcds-link href={links.en.accessibility}>meet or exceed GC accessibility standards</gcds-link>.
...
- The design system uses <gcds-link href={links.en.designTokens}>design tokens</gcds-link> to capture brand and design decisions in code for style elements like colours, typography, and spacing.
...
<gcds-button button-role="secondary" type="link" href={links.en.startToUseDevelop}>Install GC Design System</gcds-button>
