...
<gcds-button button-role="secondary" type="link" href="{{ links.startToUseDesign }}">Set up a Figma library</gcds-button>
...
<gcds-button button-role="secondary" type="link" href="{{ links.startToUseDevelop }}">Install GC Design System</gcds-button>
