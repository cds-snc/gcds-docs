...
pageTitle: Install HTML
description: Use GC Design System web components directly in HTML. These components are framework-agnostic and behave similarly to native HTML elements.
---
...
If you're using React, Angular, or Vue frameworks, browse the <gcds-link href={links.en.startToUseDevelop}>installation page</gcds-link> for framework-specific options.
...
Check for <gcds-link href={links.en.releaseNotes} external>new GC Design System versions</gcds-link> regularly to update the latest pinned version.
...
We recommend using <gcds-link href={links.en.shortcuts}>GC Design System CSS Shortcuts</gcds-link> to apply predefined CSS utility classes. These classes align with our components and help you build faster while maintaining consistency.
