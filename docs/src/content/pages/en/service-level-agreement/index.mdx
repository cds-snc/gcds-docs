...
- <gcds-link href={links.en.contact} external>Contact us</gcds-link> page on the GC Design System website.
- <gcds-link href={links.en.githubCompsIssues} external>New issues</gcds-link> on the CDS Github repo. 
