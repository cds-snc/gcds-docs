...
dateModified: "2025-03-10T08:16:14-07:00"
---
...
GC Design System components meet <gcds-link external href={links.en.wcagTextSpacing} target="_blank">level AA of the Web Content Accessibility Guidelines (WCAG 2.1)</gcds-link> for text spacing and AAA for visual presentation.
