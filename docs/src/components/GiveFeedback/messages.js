export const messages = {
  en: {
    ...
    paragraph:
      'Something\'s not working? Flag the issue to our team through GitHub. If this is your first time using Github - follow these <gcds-link href="https://docs.github.com/en/get-started/start-your-journey/creating-an-account-on-github" external>instructions</gcds-link> to create your account. With an account, you\'ll have access to all past issues and get updates on progress.',
    reportAnIssue: 'Report an issue',
    reportAnIssueHref: 'https://github.com/cds-snc/gcds-components/issues/new/choose',
  },
  fr: {
