...
import {
  componentValidationErrors,
  validationErrors,
} from '@gcds-core/components/dist/collection/utils/i18n/validation-errors';
...
export const errortable = {
  ...
  fr: {
    ...
    components: {
      'gcds-checkboxes': 'Cases à cocher<br/>(<code>gcds-checkboxes</code>)',
      'gcds-date-input': 'Champ de date<br/>(<code>gcds-date-input</code>)',
      'gcds-file-uploader':
        'Téléverseur de fichiers<br/>(<code>gcds-file-uploader</code>)',
      'gcds-input': 'Champ de saisie<br/>(<code>gcds-input</code>)',
      'gcds-radios': 'Boutons radio<br/>(<code>gcds-radios</code>)',
      'gcds-select': 'Sélection<br/>(<code>gcds-select</code>)',
      'gcds-textarea': 'Zone de texte<br/>(<code>gcds-textarea</code>)',
    },
    reason: {
